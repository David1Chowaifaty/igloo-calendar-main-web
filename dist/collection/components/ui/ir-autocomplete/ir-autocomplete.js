...
export class IrAutocomplete {
    ...
    render() {
        return (h(Host, { key: '2a7d1f6e845866a4f0cc951abd8b5d112d8321c4' }, h("wa-popup", { key: 'e06677c206813c7cfc59ac61a6fd00b3132fa1ce', active: this.open, flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, placement: this.placement, exportparts: "popup, arrow, hover-bridge" }, h("ir-input", { key: 'e2a2640309b38bc239e67e2b01eaea09c1065747', slot: "anchor", ref: el => (this.inputRef = el), onKeyDown: this.handleKeydownChange, "onText-change": this.handleTextChange, onClick: this.handleClick, name: this.name, value: this.value, type: this.type, defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, inputClass: this.inputClass, autocapitalize: this.autocapitalize,
            // autocorrect={this.autocorrect}
            autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, mask: this.mask, returnMaskedValue: this.returnMaskedValue, disabled: this.disabled, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.multiple && this.selectedOptions.length > 0 && (h("div", { key: '28384bc5e394badf0d669a8a9c064e4070c5c20a', slot: "start", class: "selected-tags", part: "tags" }, this.selectedOptions.map(option => (h("wa-tag", { key: this.getOptionValue(option), size: "s", "with-remove": true, "onwa-remove": (e) => {
                e.stopPropagation();
                this.removeOption(option);
            } }, this.getOptionLabel(option)))))), this.withExpandIcon && (h("div", { key: '8cb3ea335aee0bd68219bf85b956511a30af0626', slot: "end", class: `expand-icon${this.open ? ' expand-icon--open' : ''}`, onClick: this.handleExpandIconClick }, h("wa-icon", { key: 'a20eed1d1e24d232a88452ad6db4cadf3d470a05', library: "system", variant: "solid", name: "chevron-down" }))), this.slotManager.hasSlot('label') && h("slot", { key: 'd421cf6ae18751a12e155330f2050b8100754aee', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && h("slot", { key: 'c62da954a98404e1a41b0abab55f6687e60ea4ba', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && h("slot", { key: '311ac62f2ab2de32a6d4ed08aa5d2dec21527143', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && h("slot", { key: '06802e08417f1975355ff4f5aa4de0f687e5cdc9', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && h("slot", { key: 'e2d672c3c8c1f2bbbcc380bf3e9ef2369f672c04', name: "hint", slot: "hint" })), h("div", { key: '81d3971323168441d0aea7af73510cf5c1fc6754', id: "listbox", ref: el => (this.listboxRef = el), role: "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-multiselectable": this.multiple ? 'true' : 'false', "aria-labelledby": "label", part: "listbox", class: "listbox", tabindex: "-1", hidden: !this.open, onKeyDown: this.handleKeydownChange }, h("slot", { key: 'af14a719c0623bd5379061dfb646b7cc8cd18edd', onSlotchange: this.handleOptionsSlotChange })))));
    }
