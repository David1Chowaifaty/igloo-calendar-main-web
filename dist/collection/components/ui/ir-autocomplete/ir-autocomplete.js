...
export class IrAutocomplete {
    ...
    render() {
        return (h(Host, { key: 'd4551cf7abedce7b860d7fe05d720c3a7d7fff46' }, h("wa-popup", { key: '14fa4207126632c868012639f0908fea0a11dad9', active: this.open, flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, placement: this.placement, exportparts: "popup, arrow, hover-bridge" }, h("ir-input", { key: 'c395e54d2d5d11a0630f80d7c4970f18ba75372d', slot: "anchor", ref: el => (this.inputRef = el), onKeyDown: this.handleKeydownChange, "onText-change": this.handleTextChange, onClick: this.handleClick, name: this.name, value: this.value, type: this.type, defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, inputClass: this.inputClass, autocapitalize: this.autocapitalize,
            // autocorrect={this.autocorrect}
            autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, mask: this.mask, returnMaskedValue: this.returnMaskedValue, disabled: this.disabled, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.multiple && this.selectedOptions.length > 0 && (h("div", { key: 'f50378a38b35fc68c4753b3818cb023cca2f5b46', slot: "start", class: "selected-tags", part: "tags" }, this.selectedOptions.map(option => (h("wa-tag", { key: this.getOptionValue(option), size: "s", "with-remove": true, "onwa-remove": (e) => {
                e.stopPropagation();
                this.removeOption(option);
            } }, this.getOptionLabel(option)))))), this.slotManager.hasSlot('label') && h("slot", { key: '3e943e22fc44d0d9268b2fddc952ba7dc3d16d54', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && h("slot", { key: 'cdf195928c37d42f89fb45dba463469e3460e052', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && h("slot", { key: '29106ebb7e42c6aa24160bc0985a620f8c1b6892', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && h("slot", { key: 'cef03ba2fbcd58617f160c7d46c0901fd6b16b34', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && h("slot", { key: '80557a21ff2a13772e42d64c5b6bbea4acb4e4c5', name: "hint", slot: "hint" })), h("div", { key: '0b0f1e4f0e21023900c4ca79326034ab6b5ab250', id: "listbox", ref: el => (this.listboxRef = el), role: "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-multiselectable": this.multiple ? 'true' : 'false', "aria-labelledby": "label", part: "listbox", class: "listbox", tabindex: "-1", hidden: !this.open, onKeyDown: this.handleKeydownChange }, h("slot", { key: '1984cde4136ba521a0b38e048179c089030aa05e', onSlotchange: this.handleOptionsSlotChange })))));
    }
