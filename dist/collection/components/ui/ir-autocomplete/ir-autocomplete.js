...
export class IrAutocomplete {
    ...
    render() {
        return (h(Host, { key: '8f7f50da74bacaa367528c884115848713e9e51f' }, h("wa-popup", { key: 'afd159b0a19e49e3aeb438ff6e009c87251b9ca3', active: this.open, flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, placement: this.placement, exportparts: "popup, arrow, hover-bridge" }, h("ir-input", { key: '1bcdeb63fe28f02a5262f93acbe381eec873332d', slot: "anchor", ref: el => (this.inputRef = el), onKeyDown: this.handleKeydownChange, "onText-change": this.handleTextChange, onClick: this.handleClick, name: this.name, value: this.value, type: this.type, defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, inputClass: this.inputClass, autocapitalize: this.autocapitalize,
            // autocorrect={this.autocorrect}
            autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, mask: this.mask, returnMaskedValue: this.returnMaskedValue, disabled: this.disabled, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.multiple && this.selectedOptions.length > 0 && (h("div", { key: '47f8c31623dc09d13a7e02f543dca8b8b55aa8e1', slot: "start", class: "selected-tags", part: "tags" }, this.selectedOptions.map(option => (h("wa-tag", { key: this.getOptionValue(option), size: "s", "with-remove": true, "onwa-remove": (e) => {
                e.stopPropagation();
                this.removeOption(option);
            } }, this.getOptionLabel(option)))))), this.slotManager.hasSlot('label') && h("slot", { key: '3327e2dd0fb5988ad62194bf97d8355994003bdd', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && h("slot", { key: '412fd1ba37c11d55f8c92b25824f4e6c413884db', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && h("slot", { key: 'e7e44798c8766c8337683d7b408478b96852e265', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && h("slot", { key: '6dc9783e4fb5c7da93b708d9a5de5792c3efb244', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && h("slot", { key: '5ce9dce847db6c67b8545b79a83ade385c4804a9', name: "hint", slot: "hint" })), h("div", { key: '22413d00f095a63e3298eba3c57ede9b3683c309', id: "listbox", ref: el => (this.listboxRef = el), role: "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-multiselectable": this.multiple ? 'true' : 'false', "aria-labelledby": "label", part: "listbox", class: "listbox", tabindex: "-1", hidden: !this.open, onKeyDown: this.handleKeydownChange }, h("slot", { key: '57acb2596f7198b240ae172c5443b9e750049865', onSlotchange: this.handleOptionsSlotChange })))));
    }
