...
export class IrAutocomplete {
    ...
    render() {
        return (h(Host, { key: '94384d66f60e3e7df8cac0b7adb1347d21af7ab8' }, h("wa-popup", { key: '460359e02a5ee36c2754cd3cc80a7bf965ea7f69', active: this.open, flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, placement: this.placement, exportparts: "popup, arrow, hover-bridge" }, h("ir-input", { key: '75ef18debbaa4af891397a6919c99663165ef0e6', slot: "anchor", ref: el => (this.inputRef = el), onKeyDown: this.handleKeydownChange, "onText-change": this.handleTextChange, onClick: this.handleClick, name: this.name, value: this.value, type: this.type, defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, inputClass: this.inputClass, autocapitalize: this.autocapitalize,
            // autocorrect={this.autocorrect}
            autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, mask: this.mask, returnMaskedValue: this.returnMaskedValue, disabled: this.disabled, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.multiple && this.selectedOptions.length > 0 && this.renderSelectedTags(), this.withExpandIcon && (h("div", { key: 'ef6c8060be1059e2c4abef9890e6282328af95ed', slot: "end", class: `expand-icon${this.open ? ' expand-icon--open' : ''}`, "aria-hidden": "true", onClick: this.handleExpandIconClick }, h("wa-icon", { key: '4030707e3f6f48dbdf6f9480acb78b19386d115e', library: "system", variant: "solid", name: "chevron-down" }))), this.slotManager.hasSlot('label') && h("slot", { key: '77028fef7a470357c62ae838577f6d261e5635c7', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && h("slot", { key: '820733b97b7991213bb4a2c54791cce960b7f897', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && h("slot", { key: 'e83468c90e9f39f3781aa0051c47465b49ee54c2', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && h("slot", { key: '59c3999ee173152e19b35c3602a0b72d24e275f1', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && h("slot", { key: 'c398d9026c2c3ce0fd9a85df7edbe3cae1baae80', name: "hint", slot: "hint" })), h("div", { key: 'f45507fef2eda072b5e803913c108e0f670e8a75', id: "listbox", ref: el => (this.listboxRef = el), role: "listbox", "aria-multiselectable": this.multiple ? 'true' : 'false', "aria-label": this.label || this.placeholder, part: "listbox", class: "listbox", tabindex: "-1", hidden: !this.open, onKeyDown: this.handleKeydownChange }, h("slot", { key: 'f7e62fbb9758798f0d6d97676f0f2398b2738e47', onSlotchange: this.handleOptionsSlotChange })))));
    }
