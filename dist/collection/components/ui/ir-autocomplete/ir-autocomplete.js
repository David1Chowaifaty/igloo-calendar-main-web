...
export class IrAutocomplete {
    ...
    render() {
        return (h(Host, { key: '6caa0995d4931039328a9bcde24fcae2aa8af516' }, h("wa-popup", { key: '4c5fed1f7f246025fcd46aad84dfa04d99385093', active: this.open, flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, placement: this.placement, exportparts: "popup, arrow, hover-bridge" }, h("ir-input", { key: '03ff7b00a615e3f94b86d9eb1f4884fbb80c4d78', slot: "anchor", ref: el => (this.inputRef = el), onKeyDown: this.handleKeydownChange, "onText-change": this.handleTextChange, name: this.name, value: this.value, type: this.type, defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, inputClass: this.inputClass, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, mask: this.mask, returnMaskedValue: this.returnMaskedValue, disabled: this.disabled, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.slotManager.hasSlot('label') && h("slot", { key: '312469e567bf589c8f3a8900c2de335ebc1a5e24', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && h("slot", { key: 'faa2f348c43e544601401a73782431ec1be92133', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && h("slot", { key: '9e44038f9fca41487829f0bded3aec1885ff6441', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && h("slot", { key: 'fc1d9346ede37f5498f3686d333ed385fb22042b', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && h("slot", { key: '84ee2d57ef657d1c0e2f136669af1d39cfe3f895', name: "hint", slot: "hint" })), h("div", { key: '9cca83803e48b4a95e1e2e4e89f24473789a99b7', id: "listbox", ref: el => (this.listboxRef = el), role: "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-multiselectable": 'false', "aria-labelledby": "label", part: "listbox", class: "listbox", tabindex: "-1", hidden: !this.open, onKeyDown: this.handleKeydownChange }, h("slot", { key: 'b8e4c565bf9c5a578621967795d088cdb6d69eb1', onSlotchange: this.handleOptionsSlotChange })))));
    }
