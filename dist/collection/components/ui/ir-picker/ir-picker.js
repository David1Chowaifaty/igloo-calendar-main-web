...
export class IrPicker {
    ...
    render() {
        ...
        return (h(Host, { key: 'e4c13f87d576d9257bfdbcd0e82313d63de48691' }, h("wa-popup", { key: 'ba6bcdf7460068f31338d44276c222e018a5f06d', flip: true, shift: true, placement: "bottom", sync: "width", "auto-size": "vertical", "auto-size-padding": 10, active: this.isOpen }, h("wa-input", { key: 'a2c56efed28419d427329b9a753151b04312a543', slot: "anchor", class: "search-bar", "aria-invalid": this.isValid, withClear: this.withClear, size: this.size, value: this.query, defaultValue: this.defaultValue, ref: el => (this.inputRef = el), appearance: this.appearance, label: this.label, pill: this.pill, onblur: () => this.inputPickerBlurred.emit(), autocomplete: "nope", placeholder: this.placeholder || 'Search', oninput: this.handleInput, onfocus: this.handleInputFocus, "onwa-clear": () => {
                this.applyFilter('');
                this.open();
                this.comboboxClear.emit();
            } }, this.loading && h("wa-spinner", { key: 'd7f58c41a3ba5d78b25fe41b11ec0359e8f4c632', slot: "end" }), h("wa-icon", { key: '5eae7ce122ea51718cbacf7f5ad1be6a0e18ac54', slot: "start", name: "magnifying-glass", "aria-hidden": "true" }), h("slot", { key: 'eae62145cdc29eca424bd95095ab4d4f9030912d', name: "end", slot: "end" })), h("div", { key: 'a0374fd22b88cb3e0819c76d24d3e6bb12d8b283', class: "menu", role: "presentation" }, h("p", { key: '35adf59f7c21ecacbfbe0e547bae4134224779ac', class: "sr-only", id: this.listboxLabelId }, "Available search shortcuts"), h("ul", { key: 'd00172134309e30108a75edd7434b07fa44fa9db', class: "results", id: this.listboxId, role: "listbox", "aria-labelledby": this.listboxLabelId, "aria-describedby": emptyDescriptionId, "aria-busy": this.loading ? 'true' : undefined, onClick: this.handleResultsClick, onPointerDown: this.handleResultsPointerDown }, this.loading && (h("li", { key: '5101b5efda545fdb3c2f275df1b347d3df13901e', class: "loading-state", role: "presentation" }, h("wa-spinner", { key: '22ceca26f64924d640abef5e7886b6d2a3333286' }), h("p", { key: 'b90e92863237aa352fe8ef0de7dd40a7b6c0793a' }, "Loading suggestions\u2026"))), h("slot", { key: '53e7b5b4878bbaf6d76adc5bf4ec9685ff530caa', onSlotchange: this.handleSlotChange }), showEmptyState && (h("li", { key: 'de60f0244241c1db3f6c4022af5d0899500e7987', class: "empty-state", role: "presentation", id: this.emptyStateId }, h("wa-icon", { key: '432bb8bd0a840da3803e759701e5165abfb03c57', name: "circle-info", "aria-hidden": "true" }), h("p", { key: '968de8aed91ed4c15e2959c3403fdbc33e0f049f' }, "No results found")))))), h("span", { key: '77d7e168a2e42e96d8d40035e4b4315bf31c5063', class: "sr-only", "aria-live": "polite" }, this.liveRegionMessage)));
    }
