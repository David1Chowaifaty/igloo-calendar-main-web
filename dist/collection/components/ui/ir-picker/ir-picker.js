...
export class IrPicker {
    ...
    render() {
        ...
        return (h(Host, { key: '1ab4fd18ca2e937bbb2b2cb78a727639c99bf94a' }, h("wa-popup", { key: '4dbe5fffb746fe80ce170acd3e0250cfdb182e34', flip: true, shift: true, placement: "bottom", sync: "width", "auto-size": "vertical", "auto-size-padding": 10, active: this.isOpen }, h("wa-input", { key: '26fd4fff2b62ba2df1c1508d206ee8de43cebeab', slot: "anchor", class: "search-bar", withClear: this.withClear, size: this.size, value: this.query, defaultValue: this.defaultValue, ref: el => (this.inputRef = el), appearance: this.appearance, label: this.label, pill: this.pill, autocomplete: "off", placeholder: this.placeholder || 'Search', oninput: this.handleInput, onfocus: this.handleInputFocus, "onwa-clear": () => {
                this.applyFilter('');
                this.open();
                this.comboboxClear.emit();
            } }, this.loading && h("wa-spinner", { key: '4fb86aeb13a29c5e90fa838d811d82d533e21da3', slot: "end" }), h("wa-icon", { key: '610f5e8aa131b60aab4e86a2269e51ad96f10576', slot: "start", name: "magnifying-glass", "aria-hidden": "true" })), h("div", { key: '869ed912ef091570f821d39795f8211a4df5a72d', class: "menu", role: "presentation" }, h("p", { key: '01da64af9b6eb4447cbb313f16a0c9be1ed6779c', class: "sr-only", id: this.listboxLabelId }, "Available search shortcuts"), h("ul", { key: '91984ba7d5d679a793a6f1d62b6d73933a39afba', class: "results", id: this.listboxId, role: "listbox", "aria-labelledby": this.listboxLabelId, "aria-describedby": emptyDescriptionId, "aria-busy": this.loading ? 'true' : undefined, onClick: this.handleResultsClick, onPointerDown: this.handleResultsPointerDown }, this.loading && (h("li", { key: '0ffadfa90b0d2bb29f3ffc0db0ed7daf283ff387', class: "loading-state", role: "presentation" }, h("wa-spinner", { key: 'd1059f86cc2c6fa59a4827ec626acaacbb5392db' }), h("p", { key: '9b1dae9c4727f48fcf8187f3fa2b17cf47aa1485' }, "Loading suggestions\u2026"))), h("slot", { key: '7b7917bbeac49962fd4600a0d20417984bd6641f', onSlotchange: this.handleSlotChange }), showEmptyState && (h("li", { key: '0ee43014be889602ef0e46563c7dca20b1084c68', class: "empty-state", role: "presentation", id: this.emptyStateId }, h("wa-icon", { key: '3eef23ea0caef1cf3d292f8ff207e1609f7fc98a', name: "circle-info", "aria-hidden": "true" }), h("p", { key: 'c662b56426c096907b12e2d2954ef0385b6fcb7e' }, "No results found")))))), h("span", { key: '59b63e039b5fd05d55867b790021eb0e6c93c034', class: "sr-only", "aria-live": "polite" }, this.liveRegionMessage)));
    }
