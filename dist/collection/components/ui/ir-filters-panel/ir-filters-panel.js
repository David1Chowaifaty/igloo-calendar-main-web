...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: '3581ddb588db792e6b114f756019ca1f61896300', class: panelClasses }, h("div", { key: 'e7c41d79ff0088c835face3037d78ac5e3121bfb', class: cardClass }, h("div", { key: '38c56bdab258ec043043c5be81ea2ed28a10d4c4', class: headerClasses }, h("div", { key: 'f52af0860cda04006ddeded716aa3c332659709a', class: "filters-panel__title-group" }, h("slot", { key: 'd7d3c1d8273cf5481b26aa1573abbc72cd7af129', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: '332c31e9f9892d8bae2711d34d419e6a9b0df754', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: 'cf92820a4ea6c0135f2a27100530fac9817f15b3', name: "header-title-extra" })), h("div", { key: '6e9b628dc645da7c45badffc50b76eb98b9b9349', class: "filters-panel__header-actions" }, h("slot", { key: 'cfd165a12ae55f02ff1f955ca8785cdb4f0f48ae', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: '1cc0c96efbffc26756bcfe9d8ff591c71c935279', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: '28f3dad7770682fb3068603b5cfd5bd731ae3055', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: '74f2d6696914f9980a632e4c39f5af0126c34a31' }), !this.hideDefaultActions && (h("div", { key: '7742923ec48ff049dab5e1fc74744ca3538ae7c2', class: footerClasses }, h("slot", { key: '4dddbeec4f5268c9372591387da50725a73261fa', name: "actions" }, h("ir-button", { key: '0d1ad68baeb97af9f61c485dd0aac8f4f4fa2d43', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: 'c790307b39c313244e222f43bcd518eb6adc8a86', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
