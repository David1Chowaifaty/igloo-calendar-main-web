...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: '7bf1e265c2571ca168787095789bfd70b97e6b48', class: panelClasses }, h("div", { key: '1847103efcf911f29264430f87f5ce31254bc820', class: cardClass }, h("div", { key: '4557d9d33610d4ded441b0e2ab246cdfb9738a4d', class: headerClasses }, h("div", { key: '044ba1cac52636d6cdbe7235963b04d9fc74ef12', class: "filters-panel__title-group" }, h("slot", { key: '9abed0c41fcf359cf88d5a935d2c140470f88575', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: 'f5922ff1e54ed8313436c754946e1165e6a1c31f', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: '69639961e0ffe6675a4fc23cccdf764225f60bdd', name: "header-title-extra" })), h("div", { key: '3038ea03e07b1cdbb1a59f005ac04be8aa4c5f30', class: "filters-panel__header-actions" }, h("slot", { key: 'e105389219fb5f1d9ecfa73d9590e2f69cdc9eaa', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: 'a1189304d7eb719d19d745d4a91304d97038bfc8', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: 'd0dbdd5500d40bc9f3de08e900984d48d8a5b6da', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: '0ee9f21c764958c645bd1a653d6c6493505cf218' }), !this.hideDefaultActions && (h("div", { key: '332f7ba22df6cefd1cd7e0792ba027fda5d33f40', class: footerClasses }, h("slot", { key: '2a7ca9fa3ec16eb0881ac854d827132607e1eb33', name: "actions" }, h("ir-button", { key: 'abc750f4e751dcad228024b954a144060478439d', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: 'd6fda455831f4312330024269731df8e0f725067', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
