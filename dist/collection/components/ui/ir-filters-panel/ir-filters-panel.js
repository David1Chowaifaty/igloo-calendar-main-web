...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: 'ffb6a8e6acea6cb9e5637c9c2a802bb6d242f00d', class: panelClasses }, h("div", { key: 'ba943b08f0dc1f317c42f65cfc016caf5ba41859', class: cardClass }, h("div", { key: '7529190a9103dcbdd5bb177c08823ac2822f8439', class: headerClasses }, h("div", { key: '39d448929d984cc9946b3f2dd89fa1ba4fce4ad3', class: "filters-panel__title-group" }, h("slot", { key: '3f094f5f92ecd000f01416e22c26cf134b6dffaa', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: '2211020b983ea6b3b5e9bee8463223278c253323', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: '22c7e50acd8036f1520d67ff0144e2313fda7f6b', name: "header-title-extra" })), h("div", { key: 'b43740232da277dd79db614d57d719789fd7ac45', class: "filters-panel__header-actions" }, h("slot", { key: 'b52bea953e0c0003d5b9ecd7aee445b96eaba619', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: 'baf7702a7b9158ab445703abb6520b8a563bbfbe', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: 'c1a88a3e1bebdad6dd115b6b4027dd12459b3b0d', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: 'b0dfd9068ea82069643838794db615b7b42cf9de' }), !this.hideDefaultActions && (h("div", { key: '01b41b3c4cc69f45380f03cbf104a407d449d10d', class: footerClasses }, h("slot", { key: 'bf598950249c74ff08fde567a8d73a936fca5990', name: "actions" }, h("ir-button", { key: 'a9e3e2fcd0a5311696c9cd4bfcfdc47710f0b4f0', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: 'b3290bf218b91aca8a4d7a02229fabab5d02ac19', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
