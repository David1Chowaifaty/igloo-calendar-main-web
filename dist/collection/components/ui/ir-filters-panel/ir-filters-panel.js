...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: 'feff9770654fe9fb29e3d46855f360af125c8b08', class: panelClasses }, h("div", { key: '8637cdf13e6bce502707a6107d10bd89c53a1a01', class: cardClass }, h("div", { key: '965a97928c9e986283e6eb56c64a7491ec606bf3', class: headerClasses }, h("div", { key: 'b92f41fc7c796a6681072236248b08f9aa3555f9', class: "filters-panel__title-group" }, h("slot", { key: '1296e54b7e7ea5cf75a05f539e7372dc35b19d8a', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: '1929c232077323c5d8886be2e64c940a5845da98', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: 'a39a1f4ba4673e399de354341ec0470154a5d286', name: "header-title-extra" })), h("div", { key: '2a1a2d66924028d414956325acc2f5e5c2bf178a', class: "filters-panel__header-actions" }, h("slot", { key: '4f6283fa6c50d01b133136bc81b1eaf42c54d7b4', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: 'ca1630dbcaceb003d91ec0893032125e0aba2715', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: '1ca47fa80cdc20acda6c69ecff92fee677c686c1', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: 'd9a2d03e04a49ca556d6d2786739c5048ffafed7' }), !this.hideDefaultActions && (h("div", { key: '00c0d24b4fff60e95a0ad135f7c0187ea39b2c81', class: footerClasses }, h("slot", { key: '96e60c29497cc5d22741028b43b51ef3e9966694', name: "actions" }, h("ir-button", { key: '13421a89d58e44e16fc9366479a3d00bf029c77b', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: '4132a9e9ff45f54faa58ac1a8e5f3d88d4b6bc40', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
