...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: 'be11d0459af267e7460a34564654c0195a2bb138', class: panelClasses }, h("div", { key: 'ac045434426c7196453d19234c435c8aa8e4751d', class: cardClass }, h("div", { key: 'f371a122ec7e2b34d4ba709e5884db65d8596a5b', class: headerClasses }, h("div", { key: '33149958a82b650509f388ae3858134234bc55cf', class: "filters-panel__title-group" }, h("slot", { key: '830d2ca31b6961d71d6330e20b8f8a76e5ac6970', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: 'a441b3fe0aec2f530aa2d99bdaccc474b0a76970', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: 'db817a5dedb1be4e15ed9dc49cb9a684dee67a18', name: "header-title-extra" })), h("div", { key: '969062c10c65c857a9cb420457c70e45369bfbed', class: "filters-panel__header-actions" }, h("slot", { key: 'e8f4dcacc2f0acef132c0b8b3db0623858affcff', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: '79efa5549ba45bf9c7da8efad7338fac7807ddc7', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: 'e564764aea786f75e9bdccc0790815f942c85e7e', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: '5f55c47f6cfa1db4496ededa60a82825dfabfdd7' }), !this.hideDefaultActions && (h("div", { key: 'ffdd8fd0a9f3732db8e492623792dd0c61f5caab', class: footerClasses }, h("slot", { key: '02208d845affc4d6375a0a2584dbed9ae3f75f06', name: "actions" }, h("ir-button", { key: '3a6a2960182d92c52bb90b9124aef54c46715b0c', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: '40d57824ecf60de7b45204649f92b7c3e4e69843', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
