...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: '34a2bdde52760d685657d780e2983a1f9037682a', class: panelClasses }, h("div", { key: '1046830718908438de069cde3a419204e33f6e10', class: cardClass }, h("div", { key: '89d77ee277342e80d5045d0bde014c68f533d0df', class: headerClasses }, h("div", { key: '782a2d749a6d7551448abb93736479cba4ca775f', class: "filters-panel__title-group" }, h("slot", { key: '7e32773be50a351ca594d66aed5255f4ba13ba54', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: '16be3ccf1295905c6a5164bc0d71c205e2d186df', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: '60575d25a51562e381bca8d29394185e6324f2c9', name: "header-title-extra" })), h("div", { key: '5aa33020bbf6d7b7fc60106d9ce2654e998c3855', class: "filters-panel__header-actions" }, h("slot", { key: 'b0ef4cfd7161ab039adb378af47b2bbabd0a1a37', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: '3d8619306400cac8cae2b390c4330c7cb5956ac0', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: '511f24b101c10700b3d94f016f950afbeb21b5b7', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: '114626275f77fb557fc6f434fd5fa270dd966856' }), !this.hideDefaultActions && (h("div", { key: '1c00e3aa79c74e2092545b4e4271a9a402a58be5', class: footerClasses }, h("slot", { key: 'a72a704600e7cb201e5f9137a22b1252eb2c795c', name: "actions" }, h("ir-button", { key: 'bfa9c30a30e5ca3da10e1c9e9c31facef219e3fb', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: '0ae69b5b87007532de4327072b49bc45fe7f15d4', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
