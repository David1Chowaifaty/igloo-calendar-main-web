...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: 'ccf1302af4fb4a4175563772b73a551325c30f33', class: panelClasses }, h("div", { key: '60c9a3fcd1be5e4fa651393b57c2573997b40892', class: cardClass }, h("div", { key: 'c3f5674392fd6cdffa459ae23484b1ef88440b2b', class: headerClasses }, h("div", { key: '6667f32ec0eb9aa7c45d0d95648810311af99aeb', class: "filters-panel__title-group" }, h("slot", { key: 'c2ce72537b6a95ca753fff21e80a7883e4f47ab9', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: '19e80153fa909feed11fde4e6cd892f7e8fc5bd8', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: '99e3ab807160cd0464618499288010696400ee93', name: "header-title-extra" })), h("div", { key: 'ddc7719c75fcf07d1ba11376b707b2fcfea9c671', class: "filters-panel__header-actions" }, h("slot", { key: '08ef9ea6ab88728e03c566c52babdc1c44bac482', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: '807359ec9b92899bfce1e9f752c8d98ab0e5d839', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: 'f9fd602ce570dac0f54564b318d6bff76fc27467', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: 'c0c3d35942f66dd17bde853cbda003944cc1581e' }), !this.hideDefaultActions && (h("div", { key: '65e7d0fbc183580ea741cc6d6dc30e47024d47de', class: footerClasses }, h("slot", { key: '2e4b985bda343839ee731bae5c6878772eb7e808', name: "actions" }, h("ir-button", { key: '1ccfb2940317c237169bd99caf0a2357cda2a514', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: '205a2e08fe070a1da71648d9d5de5af8570ba88d', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
