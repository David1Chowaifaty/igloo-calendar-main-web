...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: '4a85269177a925edd543b270cbafce6653a610c1', class: panelClasses }, h("div", { key: '781e40e16e38991acfc0fc70356398fb5e625f5c', class: cardClass }, h("div", { key: '5b5b8b1ccaf7bdaab1ca545c4dc33f7faf419be8', class: headerClasses }, h("div", { key: 'de4ac3b4aaba32886497bab9fc29a4a2a1d17107', class: "filters-panel__title-group" }, h("slot", { key: 'ec1c92922c7fb980d1f0b126f4a4be1c94608636', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: 'c8d9c6d19e9b5bd2b48d3b5eaf549a5d563cb086', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: 'c01614c24ae1e98f746f3f3154faaa5f5dca9efe', name: "header-title-extra" })), h("div", { key: 'b03122713d9b519ce5a433748314d778816a5bae', class: "filters-panel__header-actions" }, h("slot", { key: 'e880b21bf5bbe651880c66c8eeffcce3a0bc7218', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: '61bb9f70cca20292599255570d9e044a6b95b723', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: 'f5f9b40c312e59108142854965cdc8564b5faaed', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: '90fad3177238e09a69950d38345d02eb5c06bf16' }), !this.hideDefaultActions && (h("div", { key: '9c53532ead5fbd5ea7f8d44b1b708777c07c6538', class: footerClasses }, h("slot", { key: '41906a9b010aea03941d223c76a2c633b997662c', name: "actions" }, h("ir-button", { key: 'ba98ab9e8691740a1408f753759fcec631576ccc', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: '2d6cea00b077a668f77aebefe4c3ecab4e77329a', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
