...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: 'a5066eb8869e6a25619a899af7c23eef8cc4122e', class: panelClasses }, h("div", { key: 'e6eaaac6352558ce90a1764b92c2cf558a2f8066', class: cardClass }, h("div", { key: '8bdb393f77e82ac80ee821fc0ddbff1822e21b0f', class: headerClasses }, h("div", { key: 'e393714f43d5881964c3612a7fb5f6d99e926ec2', class: "filters-panel__title-group" }, h("slot", { key: '3f5a4724b03ac5c33f4f59fd9c78371090de4d92', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: '0712339735c3c5ec7fe34034d29e9a9fecdc3387', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: '123a455c64dafde6478f78d8c0ab4b7b288c6708', name: "header-title-extra" })), h("div", { key: 'ceb540ab2d44a80a652bdcc01b745e6743a8d834', class: "filters-panel__header-actions" }, h("slot", { key: '5d97727a0fdc3f1a2086e6d58b5fe1b530df72fa', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: 'b8a41646f98aede57e3bd2b33cfbfbd676a8e9eb', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: 'ec079b90303888e004dfab756cce457e9f685bb6', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: '21f8d43a798152aeacaaeb73d49d3d152acc3cc8' }), !this.hideDefaultActions && (h("div", { key: 'd104db6f43dc7e0f69698dbb950e2a3702db200b', class: footerClasses }, h("slot", { key: 'b22c59fae105b97b73f3ac89a2347ea3a8fbecb5', name: "actions" }, h("ir-button", { key: '5805dbf840adf34d91c7094322b3c719edd23812', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: '03943ba598b3d566db38bcbaa0d84db2c58cb01e', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
