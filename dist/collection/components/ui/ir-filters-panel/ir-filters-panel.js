...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: '8bb735ba0a95dd9b6699c851e8c57da68ed86c5b', class: panelClasses }, h("div", { key: '857757f05611cb92551794e0375b1bf59d9ec3a9', class: cardClass }, h("div", { key: '6edb8003a074a78e4045fd32ed69b24371eef538', class: headerClasses }, h("div", { key: 'add9e248efc395367e3857d03985cdb41ef9d663', class: "filters-panel__title-group" }, h("slot", { key: '35c6191920797b723af0b6d012ddb462e73afddd', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: 'f4547895fbe5752445b940703d5150724c73945b', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: '1d3a3549abea6058fd6d9140be25c74567b8a423', name: "header-title-extra" })), h("div", { key: 'f6db78f2f57ff57a414a0d340151f2141dada1e1', class: "filters-panel__header-actions" }, h("slot", { key: '2682b500074ca9dbedfd17791bdafb8b7b421f6c', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: 'fe0a26f7063c5e84f0a0c7bb6ee069fd1108c9ec', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: 'ed4ce6c4490e18b0673299be40762edd4ce2929c', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: '35fa2263d5ac73dc04821aa5bff22a13864df8a0' }), !this.hideDefaultActions && (h("div", { key: '3ec15b9e31f1e88bb27332936feb6eb7146a32a8', class: footerClasses }, h("slot", { key: '06c3fa1284d2bb8b1d7a73a89ff2f4efb8ce95db', name: "actions" }, h("ir-button", { key: 'ef518a53e1ad0edf6f9af75de34b871ee9c4d318', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: '8265c13d253b9200d227cd749614455fa156acfb', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
