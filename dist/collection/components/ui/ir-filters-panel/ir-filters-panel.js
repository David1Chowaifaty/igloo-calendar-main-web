...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: '76cf83753755d14d7814396f17d4cb127063347f', class: panelClasses }, h("div", { key: 'c3b5c3b630e0be747c0691de84747624853aacc3', class: cardClass }, h("div", { key: '3ee2438a81776d57d1ed4a2199df49c564e83ec9', class: headerClasses }, h("div", { key: 'a868bce6c62fb2136ffe35a7256b7fc98c417664', class: "filters-panel__title-group" }, h("slot", { key: 'f728ed1d1acb67edb1744369c2a1c8a53feac2ae', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: '3a11ec9ab44fc074c932e3844048c21c4b20cb84', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: 'ab62926ecc7418d39ba8ccdccb6f77672805b33f', name: "header-title-extra" })), h("div", { key: 'b6788ab263deeb533831e67bf8a8d1bad746b85a', class: "filters-panel__header-actions" }, h("slot", { key: 'd0d9596c8047d296a2b7893dac51548aa07be877', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: '5f190da38327fd90c88ef43043c6fde8ac9b2ef4', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: '2b9650c6b171155c2a3d5094b2e93aca83d6cb31', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: '87f410d6753a0fe2018df0b392ebe08a7e88b6c2' }), !this.hideDefaultActions && (h("div", { key: '2ce4d93805742f2d650c34d1f7d2d74fe7cebf0a', class: footerClasses }, h("slot", { key: 'bd33ad6897d08dc9954ef141a30bf3deb5c36eb5', name: "actions" }, h("ir-button", { key: 'e6b6061ba00b93ca533eaea4a06c5d0ae973f175', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: '0521f20e16a3e7d3e4b2c002a35d93a37fb238f6', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
