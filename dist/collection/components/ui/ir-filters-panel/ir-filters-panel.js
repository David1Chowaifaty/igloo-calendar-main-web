...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: '6e5e918cebafa86854c1a5d403708d9c669910b9', class: panelClasses }, h("div", { key: '37a220f602d3d3a31a32e53fbbe582fb6d52acda', class: cardClass }, h("div", { key: '7204451fa925385c72505a0844027bb8db939b61', class: headerClasses }, h("div", { key: '2bff40e639e758d14b97b7b17ba2124283ca6bb6', class: "filters-panel__title-group" }, h("slot", { key: '4ae76afcfccfd593be25aa10923e4cfaac72eb44', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: '00ec17e55fbefb76cb9f13d77e6b3189b52326be', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: 'b4fa490a63779589b7604e53c4ab77bc80977994', name: "header-title-extra" })), h("div", { key: '4d38e826f108e87790606d695ff9a4646035373d', class: "filters-panel__header-actions" }, h("slot", { key: 'c70e4c314923c5f35dcbf8f0dd53afba1d119d39', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: '32e3e29ea3d3b7c240666fff772b58c088afe500', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: 'fd8b83c443ccdf7d204ead7c2fd8cfddd7030b5d', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: 'b3afb8ee204503301337ae307aaefb441438fc1f' }), !this.hideDefaultActions && (h("div", { key: '4288171919eeb570616a3a14a6f22ed73fcbe5ba', class: footerClasses }, h("slot", { key: '135ac4bba3f2f596fd6937c878045d2f4753906d', name: "actions" }, h("ir-button", { key: '43bb39c6245d28d32ee93ab6ed4bd1ec4fab2a6a', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: 'bfd8e308efb3230b29387d59b411496c4a2dc66a', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
