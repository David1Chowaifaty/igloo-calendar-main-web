...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: '22f3e4bd83bd5552a9d33919a6ee15139a0865f6', class: panelClasses }, h("div", { key: '2aaceaa7bff57acb81c7a4af5852d4d3356c6fc9', class: cardClass }, h("div", { key: '1f97e2e7d4e0f6078acc4c8b76a9cac472abe6d1', class: headerClasses }, h("div", { key: 'd68a4983e0665ad16919def3e9e6a432c44c93c1', class: "filters-panel__title-group" }, h("slot", { key: 'e39038d7b85078155a87125f5b4b47e7c38f6008', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: 'dbca14d13183aa53c69c8010c44fc1799cd21eb1', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: '589bf03c5ee8f3456b8fd9c2046b70eb5ec47ef7', name: "header-title-extra" })), h("div", { key: '28cb602b98d57ab25de1a5e4c9160889f86798a6', class: "filters-panel__header-actions" }, h("slot", { key: '28deddd34a9a69539d5812675cbb25a2670a533b', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: '69181bd6bc46851c179088b198ae986b583126b6', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: 'c05cd2e1a645f9c4633cf719e950a1c9950dcc3b', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: '8e225de76776712f8a59624d68be36d75f330fab' }), !this.hideDefaultActions && (h("div", { key: 'd8fde28f26a740a2fbacd297a15d638422c71a01', class: footerClasses }, h("slot", { key: 'e216428f10c3eddf15a04f886f1e820dcc3ff542', name: "actions" }, h("ir-button", { key: '05db88b9e5a483548bdc288c9bbfce834068de7b', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: 'a083c287923c426b2dafe26a44b8d9d4ccc4d41c', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
