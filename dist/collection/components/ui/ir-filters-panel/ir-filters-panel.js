...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: 'ed779266579a8df9cc998fef7fb08fe4f89fee1d', class: panelClasses }, h("div", { key: '95f2b0da9510da906ff14e8659f87c0478262cb2', class: cardClass }, h("div", { key: 'c3ad1248aa064266847ce1fb01e60825d6a89b43', class: headerClasses }, h("div", { key: '0a514eaabfdf54e4d4e8a3a4539fd665ec624532', class: "filters-panel__title-group" }, h("slot", { key: '694c439da72d363ba07bd4f7574349492136b520', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: '6ae43174c6d1b3f918d24e0927c3ab9b3a31707e', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: '11870f0b668dbcad9943b5ed1e2256dc096a15bc', name: "header-title-extra" })), h("div", { key: '1c54762a9eebec8acef304bb92b919a8a3fd2d50', class: "filters-panel__header-actions" }, h("slot", { key: '8e4042c94bb27d0b942db8411ecef38ae046127b', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: '4450541dd6e196eef5f8028539ac30935547dbca', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: '689a598703921acbc6c7a458c6a02097fe79c82c', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: '6f5d26f158bd1a0c7543781e5344c90c5e3b1577' }), !this.hideDefaultActions && (h("div", { key: '12f3d9013e7d740a5b3a98ae3dc342e1014d92a1', class: footerClasses }, h("slot", { key: '111861c254aa858630774d98a84e546b441e04bd', name: "actions" }, h("ir-button", { key: 'e4f5172785f201f7f4fbc3bf685535e95e4c7a81', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: '37628af7aa0a54fbf1be49027313e3e030fb9e13', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
