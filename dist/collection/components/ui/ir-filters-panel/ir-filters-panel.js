...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: '87e61b477186fa0c5503bc144d48eaa227030a3a', class: panelClasses }, h("div", { key: '4e4908fc02718ec4a03a6166dce3a3f254b18547', class: cardClass }, h("div", { key: 'c5bedc8a867d1893aa68be8287420202b38e0209', class: headerClasses }, h("div", { key: '5727ce985006a686f9664511c39c19ddf96c44ee', class: "filters-panel__title-group" }, h("slot", { key: 'e41414a7b20b094d5a6b3f70fcdbb191073f66a7', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: '6625420d89dadf6f1c97e75716be76af184e779b', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: '778bfcb08d3b520a2115ea0158fab9e3f1a4e251', name: "header-title-extra" })), h("div", { key: '34fb53a0f8b350f91303847d26753326bcaf6d5f', class: "filters-panel__header-actions" }, h("slot", { key: '3753cf468c938421b3b8f827eb0f2290b6e28ee7', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: '1e49aa9e017618072504af9f7f70c4809eb88512', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: '73f29710ab7b32b08ab436fa513effa18c1ae05d', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: 'd2f104d078d26531ce59ccd370368b004b28e13c' }), !this.hideDefaultActions && (h("div", { key: 'ba9bc4cba83725f0d3544b8b56ccc8ae45755274', class: footerClasses }, h("slot", { key: '785d6be455ed725f7ce04a8551aef743826a2357', name: "actions" }, h("ir-button", { key: 'f13b0702cae8dcb68fc5e5b552ff81267f5efb7c', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: '594edd61e627d4d95edcba0a50ae62153f0521d1', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
