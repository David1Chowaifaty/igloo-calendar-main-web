...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: '4cc76861c4509060d4c84be553b954c25ec8c6e5', class: panelClasses }, h("div", { key: '2def0b499550689364227401c72aabb497dc0609', class: cardClass }, h("div", { key: '7cf9a07f81f4f5ea0544d092c41e8c2e6969450b', class: headerClasses }, h("div", { key: '6fc964fc6b3ac840cf771d783ee57105fbbf3b8d', class: "filters-panel__title-group" }, h("slot", { key: 'f0cdb6d947814c2b33cc00117b95a2d1acf88c55', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: '839a3c0842f52332a01c10184dd6be1f5a630731', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: '3969b10870b8798461b025eff405604040a1877a', name: "header-title-extra" })), h("div", { key: 'a6ca7230264db540af040a90f03190722542f516', class: "filters-panel__header-actions" }, h("slot", { key: '12a3860bfcd2aa442596b6d60d4ccc12827352bb', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: 'bca7a174142de0a75f9f07f2579f666c69b6a40b', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: 'd355abaae9c564a3a0fa9879d1e9bc89640c70b7', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: '56a5d227c20d3ea7de28c5cb76a270c0a7292b04' }), !this.hideDefaultActions && (h("div", { key: 'd3e6fd9fe53a711d69de4fa8fdfb3532c79f7558', class: footerClasses }, h("slot", { key: '3a1bdf335d43b99b5380fe21329af8a1fdc0af85', name: "actions" }, h("ir-button", { key: '22fd0ff237787f048e4b6cd7aca5b1609d8a57a9', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: '3c5c2b6a9010d74510e60262a27733751b57e77c', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
