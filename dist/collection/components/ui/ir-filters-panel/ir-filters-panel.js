...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: 'e5d42d26f8a2cf2a9d4bf9c0f2649bca0badc3b4', class: panelClasses }, h("div", { key: '0b14d758353965b0d5642ad2ede78120de56b707', class: cardClass }, h("div", { key: 'eb04c96ac87eafc7270f6affe5cef65bb4e2bd44', class: headerClasses }, h("div", { key: 'c6ec2e818da2523104477c203f511df532be7ec5', class: "filters-panel__title-group" }, h("slot", { key: '96f89b2254d74812eeb974a593063763f683c6b4', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: '84877443bc26a2e2bdf5325270c80f0b43e8386d', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: '6e3f530cde99126a122e766b11ae962834da00e9', name: "header-title-extra" })), h("div", { key: '12a7a5c78cbecdf26fc8e19d34862a326951dc3a', class: "filters-panel__header-actions" }, h("slot", { key: '8a4d2a64cf02204bea4d7d9e2423edb18faee758', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: '66ba98337caa2c0a8d33afbdff8190b599b2a12d', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: '352ddb2d2e12b5e2b4aa8c8c006fba3ea8b08c2e', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: '57fe6e399e1faeb1e8810a792187c0946edad946' }), !this.hideDefaultActions && (h("div", { key: '29c9cd1d557d653190aa1bc0a16aad711dbf7068', class: footerClasses }, h("slot", { key: '4c4a45561b9d3cb108e2fd316d4d7bc7cb84c12b', name: "actions" }, h("ir-button", { key: 'f8e15360ca9b12ffb3b56a46130e4f97cdb7fef0', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: '84fdff68e4cc923888b55798336054e518271e14', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
