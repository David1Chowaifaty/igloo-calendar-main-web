...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: '8b216d4ff06908e7e2a486621a82f1d3302136bb', class: panelClasses }, h("div", { key: '48be59cbe18b914d308770ce41848e3dfb489369', class: cardClass }, h("div", { key: 'e81199463570ab7e8002f48be78780e6ace40a40', class: headerClasses }, h("div", { key: 'c7afcf9cd57ffdab9b3fcbb98e5418585e0bce67', class: "filters-panel__title-group" }, h("slot", { key: '0038f9096ebb8dbaa401b697fad493d298b68f92', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: 'b627489fe652cd95caa973205f5968f673adcfb2', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: 'efcabe8c80e7dc01d6ee562fb66a0b24b2709951', name: "header-title-extra" })), h("div", { key: '065dba230efe9d02767fa5e38889f764cf1aefdd', class: "filters-panel__header-actions" }, h("slot", { key: 'bc1d0e60a6f0d6ad6497bc6739e5f9dc3fc86bfe', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: '71b8cdaaeb6d31cdd0aff757f14793e0dbb8b3b9', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: '495dce2156160edcb64866a5b99f0e56bc706984', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: '5413be172451579f5d1972a9879c1a52232ee510' }), !this.hideDefaultActions && (h("div", { key: '96883c6a3dec743bdf6247abe865827881f298e5', class: footerClasses }, h("slot", { key: '8c43cd5206da8ffc450940b52eeab4257321eb36', name: "actions" }, h("ir-button", { key: '41d2f09fcf1aa02b77acbf39a81e82029ea6dfca', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: 'a3eedad8358557897dd0f282c9d474c88a50029e', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
