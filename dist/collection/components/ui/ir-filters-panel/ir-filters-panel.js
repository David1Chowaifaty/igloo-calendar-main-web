...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: 'f89317dd7f529d866ce9a01f9520b95f2371994b', class: panelClasses }, h("div", { key: 'c42d623f2d6b70b36b7a880481fd2f725f1d9ee6', class: cardClass }, h("div", { key: '6227264c44dd3b392e60961e2a1d61f255f2f34c', class: headerClasses }, h("div", { key: '965b959170610d93b749d3c5511eca81cc8bb6df', class: "filters-panel__title-group" }, h("slot", { key: '5bb725b1d666936430b666277f9ec12f4515347c', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: '1020dd925d504b664aed3baad3adc94fa2541c75', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: 'd8efde38d2afd4d096f76307c3fb2208e6278c00', name: "header-title-extra" })), h("div", { key: 'a472f21d3f7c9921b4bf9b04ea175a86ad1d11c4', class: "filters-panel__header-actions" }, h("slot", { key: '12c1f7f5437b3948d99859c8825aad2d7e628c9d', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: 'b398b00305b51e88a5239bdd71f641cf9e29c51f', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: '2296c77354424e27bf9e1a45d09d805e55eeb393', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: 'bef899995a4cb4a776c3287e5c10db15e860848f' }), !this.hideDefaultActions && (h("div", { key: '43ff32d8f06b0dd90abb8d2495b599a123044ab7', class: footerClasses }, h("slot", { key: 'fe2b0b4e6d65166de5b3f03f76a72e71e2ae9cc8', name: "actions" }, h("ir-button", { key: '8dd01c392bdc8497b8782ec58e487f8add13dd3c', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: '94c58405382add0aa021be734d0a6d3c28ec0825', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
