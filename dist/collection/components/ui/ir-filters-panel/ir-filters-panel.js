...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: '1ebc1c95cdf91f6731b80fa36d24dc31a3529164', class: panelClasses }, h("div", { key: 'e16dc8105fdad94b39a1a3faaa4d395a887de1a0', class: cardClass }, h("div", { key: '4acb4ec3a66228cd10726017c78f8f8faf485207', class: headerClasses }, h("div", { key: 'f4e5f5c979c32486e1c44cd4de8040feeccabe66', class: "filters-panel__title-group" }, h("slot", { key: '0edab6679ff062f111ec7650fd6cb7647fba14cd', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: '72c6c7944c7a69c4eec0136c5065965d94bd1730', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: 'c17b9f1e3549c86fd89419fe03fae8850d3f8afc', name: "header-title-extra" })), h("div", { key: '0798d1e7355c059d3690ab7f45b0c86d00808459', class: "filters-panel__header-actions" }, h("slot", { key: 'db054665161c986dfc2c0308e8b9fc17b519330b', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: '0c2f4b2a8c7926e3079e3fa8b9f2b53ed28b71e8', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: '9f6e25e7e87921f6c420ca8478a6fbba1387105d', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: '8b47d9af9bd24959e5b7594cf3b8e0fdb0cc3a33' }), !this.hideDefaultActions && (h("div", { key: '0e0b0e650f3709a3e5e3116ad80a5e3746946982', class: footerClasses }, h("slot", { key: '845bd5ceb1188b7b5c34e06997d5397801656d0f', name: "actions" }, h("ir-button", { key: 'fe1fd5d4998961a1b5030e2707763b6ad6a93858', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: 'd4b948769ebdf2bc3ebf4e289a08d91f92b95e31', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
