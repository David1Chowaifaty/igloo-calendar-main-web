...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: 'f0e7bbe0164d1ddb32ca95684033574eafbc64f3', class: panelClasses }, h("div", { key: 'df10abcdbf66835058cd9fda8dc2613288f73af4', class: cardClass }, h("div", { key: 'a6e143679ad298bc976fd0e1baf3a15ca2448960', class: headerClasses }, h("div", { key: '22b8abdab4af93fc4614fa2f5f4341bde319d451', class: "filters-panel__title-group" }, h("slot", { key: 'd25f4d9efe7988e3b3fec9346805ead1e58aa0e4', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: '5eee669c845df8a4cd6733ec9a50372ca4789b73', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: 'eead4988ae2099086a43b893644c6a1175551fea', name: "header-title-extra" })), h("div", { key: '7c9e4feeb6c4ffa8cd9b77e60b6d9d5cc9f6ecf0', class: "filters-panel__header-actions" }, h("slot", { key: '9db9ea9aee5916249649cb6e936213792fa67435', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: '8401d8906eb8cbe58ddf460d8e386eb3a77bef03', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: '0aef08a3e7d687c2522cc3007608275ba6a091d5', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: 'ec6f868216b46d0eb1ecce9f954faeabcd4ae7f0' }), !this.hideDefaultActions && (h("div", { key: '8928a54f4de9767f481d416a5572318d8f2d9681', class: footerClasses }, h("slot", { key: '3b5d1c4957abc889c5848dcb4320c8c79fd1e3ee', name: "actions" }, h("ir-button", { key: '4c635f6388dce2b2ed89fb828060aa23fa158480', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: 'f547759828de0c8a64a94c72994e91b7a78ea2a9', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
