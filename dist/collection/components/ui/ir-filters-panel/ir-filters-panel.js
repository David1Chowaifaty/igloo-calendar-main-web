...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: 'bb90037198f74fb460760fcab2793ecd8f0f6950', class: panelClasses }, h("div", { key: 'a44327dc7b7ab649eb4c57e01ad83ccbf9762185', class: cardClass }, h("div", { key: 'd9689beeb865e42d87f3fad9345f74335215f7aa', class: headerClasses }, h("div", { key: '258a153d612c9e8746c2fa97320fa78387454d22', class: "filters-panel__title-group" }, h("slot", { key: '6dec95460e83888c774a6e348a674eef9309bc1f', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: '7b3c3caf2cf2aae44b5605a785d6e63a499c488f', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: 'daf66a79d6cf3fa4fac66b02cff08a807e65c57d', name: "header-title-extra" })), h("div", { key: '4a84b513995a8aeea91baf2b0ef3cc998cb41cd0', class: "filters-panel__header-actions" }, h("slot", { key: '5e1e3a4de03d19920fcdd46cc707abc112826896', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: '278c7caa20cb21da8f3ff1cb827c209a26a2132e', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: 'b11b998c37dc12f599c3e5a167dd4d8b57382842', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: '6fcb1abca027d139dd98c30e13cfa4834f9646cf' }), !this.hideDefaultActions && (h("div", { key: '178a8511f35cba1b9f8c5a0db5316bc9b026d366', class: footerClasses }, h("slot", { key: '753a0af14d0e517e9b7cfe2747a31963544dd9e4', name: "actions" }, h("ir-button", { key: 'b48f33321ff2100d2dc567a1b25c1361c6028b9f', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: '104cbebe3d53c4b8d5d98ace210c992412fa4d8f', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
