...
export class IrFiltersPanel {
    ...
    render() {
        ...
        return (h("div", { key: 'f0a401f5de1bb07958e66136b57fd8c449a81a32', class: panelClasses }, h("div", { key: '6b366694f8acb08f0f505a79db59c765f91a28b9', class: cardClass }, h("div", { key: 'b9a9386dbb306eea96ec340c2d73c1552d330588', class: headerClasses }, h("div", { key: '07b9d0beb9b1b4b7fa497736e11301fc16309e18', class: "filters-panel__title-group" }, h("slot", { key: 'dd8ea932baece8a1a2dd98e514fbff4050db07f2', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && h("h4", { key: '663904d72f723b4e46ee4f9ed18cb6d1cf2af4c3', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), h("slot", { key: '3f5cdfa3127ed32f024c2d9765d9afe2f7f594d6', name: "header-title-extra" })), h("div", { key: '43eb539c608f2abf49ffe4fc4c58a8cf23d24ed9', class: "filters-panel__header-actions" }, h("slot", { key: '766fc00b5f2aa7b177b560caf0ee5c1528fde313', name: "header-actions" }), this.renderCollapseButton(collapsed))), h("div", { key: 'cdb306e07b0af57b308578bcfe6a6a6fb3559c1c', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, h("div", { key: '6e87bdbc117a6682cc383978f23b40e439ae6007', class: contentWrapperClasses, style: { gap: this.contentGap } }, h("slot", { key: '42d7c6e416619de4a47969ea27f5ac15a1b7e7a3' }), !this.hideDefaultActions && (h("div", { key: '94b0a7e393b88c302b9cfb629962bd68b4695bb4', class: footerClasses }, h("slot", { key: 'b709428498289cc2fd4655133792f686025c0f2b', name: "actions" }, h("ir-button", { key: 'cb9649e1f5f40600926901538c951de913c98f00', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), h("ir-button", { key: 'b025e86aac36988880e2d7db553ad79c8a5c4ea7', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
