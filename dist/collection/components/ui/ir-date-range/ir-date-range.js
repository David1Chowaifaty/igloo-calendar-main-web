...
export class IrDateRange {
    ...
    render() {
        return (h(Host, { key: 'dedabccb8457615766d948c16e36c0606d53da4f' }, h("input", { key: '018fd6dd6d1ed607793f9d8041f557293997747d', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
