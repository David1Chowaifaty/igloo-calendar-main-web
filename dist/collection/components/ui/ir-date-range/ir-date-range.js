...
export class IrDateRange {
    ...
    render() {
        return (h(Host, { key: '03eea7553d8e954587ac67189fb46104b86fc7d2' }, h("input", { key: '0b5dfec51924b959435dccfeae873a36b2d00d25', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
