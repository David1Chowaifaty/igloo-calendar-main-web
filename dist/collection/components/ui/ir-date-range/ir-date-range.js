...
export class IrDateRange {
    ...
    render() {
        return (h(Host, { key: '74dec7a7be501dcda60e65676689faa74fde8824' }, h("input", { key: '74af4fcbacb973a56e54bc2965cd41b47c13bfd3', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
