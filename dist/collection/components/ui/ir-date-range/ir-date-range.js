...
export class IrDateRange {
    ...
    render() {
        return (h(Host, { key: 'e000ec90b9a59b7d393549a6a9e26dc33177547a' }, h("input", { key: '52c69da42be04a934ebe2e7e4207361b6baa3058', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
