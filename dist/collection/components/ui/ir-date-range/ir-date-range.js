...
export class IrDateRange {
    ...
    render() {
        return (h(Host, { key: '87654ac49dfb9c93262a0990c5d3b6a864044895' }, h("input", { key: '258fee39088565f7aac00f7b84d79a3b0e414a0e', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
