...
export class IrDateRange {
    ...
    render() {
        return (h(Host, { key: 'ffd220be522c8f552da2a6672ba7fdb22c459a4d' }, h("input", { key: 'fb6805df9d6469fa4d9ab858d38164db76258576', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
