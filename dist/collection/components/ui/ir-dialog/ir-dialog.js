...
export class IrDialog {
    ...
    render() {
        return (h("wa-dialog", { key: '1198e0545b08134aaaf5d56850194b2e31647590', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'e1d6f5045e542a16a513ea5bef169db0c0d2c456', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '33431056049b790e2d9648008d9e59bdec2bf93a', name: "label", slot: "label" }), h("slot", { key: '76dcd0935372373ef01df3462c663d33c897a7b0' }), this.slotState.get('footer') && h("slot", { key: 'bd472d02ab9b007ca67d4b506958a22a83384019', name: "footer", slot: "footer" })));
    }
