...
export class IrDialog {
    ...
    render() {
        return (h("wa-dialog", { key: '3c933c289958e8a46db9f3957284e7b4f675e075', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '2163f4b873a49c50d5696720126a4c8ba73ea851', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'c7ce4beac7e9847e3b3ae9636938f59c25df83b8', name: "label", slot: "label" }), h("slot", { key: 'cdf11d15165c668c34828bb59dec0f123aed26af' }), this.slotState.get('footer') && h("slot", { key: 'cdb21d17acb15a1678b09aace19c80dc2c9b7deb', name: "footer", slot: "footer" })));
    }
