...
export class IrDialog {
    ...
    render() {
        return (h("wa-dialog", { key: '4a5f8f1315fd845b4d89109c58a3408231f26dcf', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'e7e223beb407cd30600fb480005cf3990fe9630b', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '26140264ba49b28dbd91206cd6c0310a6c380c5d', name: "label", slot: "label" }), h("slot", { key: '384f443854a0d61ecfaa8d8bd81d5d786dc7191d' }), this.slotState.get('footer') && h("slot", { key: '8671a27a849d5d389375fb64caeaaa72f28a402e', name: "footer", slot: "footer" })));
    }
