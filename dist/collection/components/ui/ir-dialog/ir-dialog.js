...
export class IrDialog {
    ...
    render() {
        return (h("wa-dialog", { key: '1c18d739c3b376688a8b502c1f7707d02cbef534', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'e5e15b0968ff45eb73d255d6e49cc47234ebeab1', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '2b643875ce5cd984ced3d7ce8610625810834d42', name: "label", slot: "label" }), h("slot", { key: '735490e8ce357b353d952a2ce7abfef72936552b' }), this.slotState.get('footer') && h("slot", { key: '46685dddd2fc8c41740caab31c11374fbdbb2b8e', name: "footer", slot: "footer" })));
    }
