...
export class IrDialog {
    ...
    render() {
        return (h("wa-dialog", { key: 'da4edf8135c21a2e41ab5766bdcaad98d0645f3e', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'c9ace44e239d4c7a8df2df36484fd2df9fa359b8', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '42ef816337f28b005e8df0e1002078b416c99c48', name: "label", slot: "label" }), h("slot", { key: '3468bbad4c6e7afcfc8b8cd79e5f74cb504b0daf' }), this.slotState.get('footer') && h("slot", { key: '2fc54214a996d17e886b85ba13a81f408beab42d', name: "footer", slot: "footer" })));
    }
