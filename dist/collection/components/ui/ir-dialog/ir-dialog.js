...
export class IrDialog {
    ...
    render() {
        return (h("wa-dialog", { key: 'cacd8ee94914703f1a5fa7ada6bfc7f499b660f4', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '93e90ff2181b07455d970d9b695517da608f8c0d', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '7ad1d5ecc963b5f6d50ed13373dfbbd84c86f6a0', name: "label", slot: "label" }), h("slot", { key: 'cba7b1ce0927c6b66f1be920e3afa356b7ee10bb' }), this.slotState.get('footer') && h("slot", { key: '88755a75efd633b936bad8fbaedd10035141c47a', name: "footer", slot: "footer" })));
    }
