...
export class IrDialog {
    ...
    render() {
        return (h("wa-dialog", { key: 'f65daa90d99a5a58d6400aaa87a3cb861cb7c594', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '16582ca224f4eee03c2074da0ec109a672344484', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'd25705e6512e67852842bf50ab78d63325ecc120', name: "label", slot: "label" }), h("slot", { key: 'dc3e61ae746d68800a4e48d0191ecd389fbeb52d' }), this.slotState.get('footer') && h("slot", { key: '957752fe2631db3e15db2d9d4877fcf0eaf94499', name: "footer", slot: "footer" })));
    }
