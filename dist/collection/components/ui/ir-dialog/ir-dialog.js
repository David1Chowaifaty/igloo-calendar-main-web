...
export class IrDialog {
    ...
    render() {
        return (h("wa-dialog", { key: 'bd26762edc77e84db974e56f3116b510cce5ed90', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '716eb2cecd7c176740c1314ec1d722f97b9fd4c7', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '7f655a4108aa0160dd774fb1d6f73520d939b81b', name: "label", slot: "label" }), h("slot", { key: '5790e4e896040a7863d8dfcae44e341c17b70f92' }), this.slotState.get('footer') && h("slot", { key: 'e3d7b7b6f68c02efba3f65ae8c4085894b7919dc', name: "footer", slot: "footer" })));
    }
