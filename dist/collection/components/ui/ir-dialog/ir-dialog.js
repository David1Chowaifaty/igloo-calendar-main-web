...
export class IrDialog {
    ...
    render() {
        return (h("wa-dialog", { key: '84dee817feb6d1c4de1cc2d3109cd53c36a19a75', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'a41956ebdc07d87bd5ed6dc41b5ff6737bd30801', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '19cf5c540bf2e2754f6706db113debd0c7f88795', name: "label", slot: "label" }), h("slot", { key: 'c62044c1a828768daf387539c06d00c07db2e58f' }), this.slotState.get('footer') && h("slot", { key: '4f579391c4e5f82d92829a6c010f6f5707e1cec7', name: "footer", slot: "footer" })));
    }
