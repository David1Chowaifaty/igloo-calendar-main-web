...
export class IrDialog {
    ...
    render() {
        return (h("wa-dialog", { key: 'd51cb34c103215af0e6f85eccad9497e6a7a90cf', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '60ebaf8f1ddb3f82d899a7089cfeb2c7bfe64997', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '981f1e95de00af47304448dfe700db9fdd1a248d', name: "label", slot: "label" }), h("slot", { key: '11bdd95fd18af9b829b36fbffc5b82bd03e461c5' }), this.slotState.get('footer') && h("slot", { key: '948f23d9f5f8f6fec53ca017eb15f930feb4e196', name: "footer", slot: "footer" })));
    }
