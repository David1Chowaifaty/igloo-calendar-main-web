...
export class IrDialog {
    ...
    render() {
        return (h("wa-dialog", { key: '702a34a4f9807265aee2b3f3a22da50031dc0784', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'df7a1e04da790ef0559cbad6c17409a5170efb66', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '60928e3e19521834a27358d58e9fbdc62eb43bea', name: "label", slot: "label" }), h("slot", { key: 'f853ef51fb662d068fcd0cab1cfb9674df1db0a1' }), this.slotState.get('footer') && h("slot", { key: '8506640d2caae21dd67dd132c7a3ff9d3a1364b2', name: "footer", slot: "footer" })));
    }
