...
export class IrDialog {
    ...
    render() {
        return (h("wa-dialog", { key: '08b171e50694f7fef34db3cc299abae5d859517b', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'fc2e1e43ed007b22ef61e7a8ab92e3dcafda1407', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '06a8b19b9960fb30a37e2f1c3f933a63629d6f02', name: "label", slot: "label" }), h("slot", { key: 'b3de193369da0fbc22c00dbe3f4f01e10f848937' }), this.slotState.get('footer') && h("slot", { key: '9db199775ee17d38de16c666b004f5f2462546a0', name: "footer", slot: "footer" })));
    }
