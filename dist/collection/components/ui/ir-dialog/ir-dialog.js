...
export class IrDialog {
    ...
    render() {
        return (h("wa-dialog", { key: 'af79efa5d19071c6f66d1fa8831ecce6fec0d8ef', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '2ce1f4527710ecd6450e63e31fd2d0ba03e25e77', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'd26e6f752391e462a56d0213bb32827f388b6535', name: "label", slot: "label" }), h("slot", { key: '0013f5faef6cc11eba29478673fd4466c89ab507' }), this.slotState.get('footer') && h("slot", { key: '23248b6240668207b8d106b4e091ddea4612fbc6', name: "footer", slot: "footer" })));
    }
