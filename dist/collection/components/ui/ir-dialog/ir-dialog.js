...
export class IrDialog {
    ...
    render() {
        return (h("wa-dialog", { key: '947517522c8240ee48e9130bb1bc9544c0506f7f', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '01afd34d591b309f1800d356c1e3d8b5076f3525', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'e3e4b2349cb6a39b1bc767d8c754cd27a4c4b32a', name: "label", slot: "label" }), h("slot", { key: '29ba61005f3fa9260463132a6eec5958fd83686a' }), this.slotState.get('footer') && h("slot", { key: 'ef1beca77bdecfe3a50a206d89bc0a7c8c90c9ca', name: "footer", slot: "footer" })));
    }
