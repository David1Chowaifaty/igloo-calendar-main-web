...
export class IrDialog {
    ...
    render() {
        return (h("wa-dialog", { key: 'e070a1619f0b3ccab47e4478381306d825c1c4bb', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '84549f03588fba7ef980e3fde35f41d49b4c6d2c', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '5915d826c38bb8b08afb2cd7bd3157b5b2a03bf4', name: "label", slot: "label" }), h("slot", { key: 'e82a4f1655a16c6d9c3b42249922945df9d00656' }), this.slotState.get('footer') && h("slot", { key: 'a11dd38775ba5aab434107e95f814dd01cff9bd4', name: "footer", slot: "footer" })));
    }
