...
export class IrDialog {
    ...
    render() {
        return (h("wa-dialog", { key: 'fc941cca24d2bf89c30def5facb4e4d9cac7394d', "onwa-hide": (e) => this.isOwnEvent(e) && this.handleWaHide(e), "onwa-show": (e) => this.isOwnEvent(e) && this.handleWaShow(e), "onwa-after-hide": (e) => this.isOwnEvent(e) && this.handleWaAfterHide(e), "onwa-after-show": (e) => this.isOwnEvent(e) && this.handleWaAfterShow(e), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '279018adb22056e151f5ba9b9291cf350e315004', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '8956b8bc5c84406905bbdeb4922af71089c8b5a7', name: "label", slot: "label" }), h("slot", { key: '4b22d76cd2de66778222c79d6b8c5d84ad712b7f' }), this.slotState.get('footer') && h("slot", { key: 'a75dcd132aa78aaf3b60590fc95cc6365076ccf9', name: "footer", slot: "footer" })));
    }
