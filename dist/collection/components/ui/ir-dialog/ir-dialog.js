...
export class IrDialog {
    ...
    render() {
        return (h("wa-dialog", { key: '9f39c0ef50c747ed9225ec878829be2e9fe58279', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '0a32c426a137015426b501ef3ecf28ea98527564', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'bfc15c9b6a41f665ab298403e2c7d1bdd6f90a34', name: "label", slot: "label" }), h("slot", { key: '1c23e0deb7c7d7bf8d7ed29da4f7a7a7401fc57a' }), this.slotState.get('footer') && h("slot", { key: '2171240db76b803d62f22742b5103dd6cf0dc4c1', name: "footer", slot: "footer" })));
    }
