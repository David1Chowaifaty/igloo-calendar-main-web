...
export class IrDateSelect {
    ...
    render() {
        return (h(Host, { key: '092ea77b485a13301a03061bcbe7cb549abf177e', class: {
                'ir-date-select': true,
                'ir-date-select--active': this.isActive,
                'ir-date-select--inline': this.inline,
                'ir-date-select--disabled': this.disabled,
            } }, h("wa-popup", { key: 'a83010f9eedfa0e255cb09a4347e77e0b0e441c8', style: { '--max-width': 'auto' }, arrow: true, part: "base", placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "ir-date-select__popup" }, h("div", { key: 'f965f79d79d0220459711c3dd92b4e8208ccf373', slot: "anchor", part: "anchor", class: "ir-date-select__trigger" }, h("div", { key: '074e7e69ae2f4de947ed76ae3299be84604b0b1e', part: "combobox", class: "ir-date-select__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": "Select date", onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, h("slot", { key: '1138df56a7e2e8c5213aef07a455d665f8cbe533', name: "trigger" }, h("ir-input", { key: '08737db8aae7148054eebd2f69b58ffc94bbeec6', disabled: this.disabled, class: "ir-date-select__input", placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, "aria-invalid": this.isValid, readonly: true, defaultValue: this._label, label: this.label, value: this._label }, this.slotManager.hasSlot('label') && h("slot", { key: 'c5b4b2bd3488a0016840b3fb40487b99e1b3eb21', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && h("slot", { key: '5812c45f772b41b4b48835aa61cee3c83e77e12d', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && h("slot", { key: 'ca67595b00c2806389ee987165454031eff2c92b', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && h("slot", { key: '849cc4421c2ab64da4571941d9ec8a0244622bd8', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && h("slot", { key: '2654b9d03ee4cdb34c7f2f4c41a4009457804bf5', name: "hint", slot: "hint" }))))), h("div", { key: 'f62345a0d19d61557c620e5216e8c3ede5fcca06', part: "body", id: this.popupId, class: "ir-date-select__calendar", role: "dialog", "aria-modal": "false", "aria-label": "Date selection dialog" }, h("ir-custom-date-range", { key: '2727952d626658cba11e09be3daf6784ff127ee9', style: { '--cal-button-size': '35px' }, fromDate: this.selectedStart, toDate: this.selectedEnd, minDate: this.minDate ? moment(this.minDate) : undefined, maxDate: this.maxDate ? moment(this.maxDate) : undefined, onDateChange: e => {
            ...
            } }), h("slot", { key: 'f5891953a5fae6f7829953a5eb8abeeb750755ec' })))));
    }
