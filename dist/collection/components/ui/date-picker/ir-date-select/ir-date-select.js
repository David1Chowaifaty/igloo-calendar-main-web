...
export class IrDateSelect {
    ...
    render() {
        return (h(Host, { key: '7ade385b78957ee74873daa9c879f0b7f3b5325b', class: {
                'ir-date-select': true,
                'ir-date-select--active': this.isActive,
                'ir-date-select--inline': this.inline,
                'ir-date-select--disabled': this.disabled,
            } }, h("wa-popup", { key: '60a6253f1a307601af2fc0528b875691e5cf7d3e', arrow: true, part: "base", placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "ir-date-select__popup" }, h("div", { key: 'a2e0682501988d4e3203ef8528ce7fe6e0b0a164', slot: "anchor", part: "anchor", class: "ir-date-select__trigger" }, h("div", { key: '69434bae9a80906c7f62086d8c74ada2e1621e0f', part: "combobox", class: "ir-date-select__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": "Select date", onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, h("slot", { key: '6a53d83d54baa35017feaad457df02ff196323e2', name: "trigger" }, h("ir-input", { key: '832e1cf00ebc1986a82b1697a4356c3e7d7f2af9', disabled: this.disabled, class: "ir-date-select__input", placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, "aria-invalid": this.isValid, readonly: true, defaultValue: this._label, label: this.label, value: this._label }, this.slotManager.hasSlot('label') && h("slot", { key: '915071d92dfc6c7630ad15354e874994c9b21690', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && h("slot", { key: '0bbfe2a3c7eb6bc30d3d79b16f87d873a0fe353e', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && h("slot", { key: '5797f3e2dd73bbb6de8938b49e851510802cc747', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && h("slot", { key: '27c847754389757cdfae7fc4d0c27a3d59bf0d3f', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && h("slot", { key: '0907f86403fe155d11741338ccb7e4cf2cfcf064', name: "hint", slot: "hint" }))))), h("div", { key: 'fd01f3cd71574e0c85a5e5f0367828854b89fc6e', part: "body", id: this.popupId, class: "ir-date-select__calendar", role: "dialog", "aria-modal": "false", "aria-label": "Date selection dialog" }, h("ir-air-date-picker", { key: '78cf727854e1ae5a4f0619cf376169cacf3e8535', ref: el => (this.airDatePickerRef = el), withClear: this.withClear, placeholder: this.placeholder, label: this.label, dates: this.dates, inline: this.inline, date: this.date, multipleDates: this.multipleDates, range: this.range, dateFormat: this.dateFormat, timepicker: this.timepicker, minDate: this.minDate, maxDate: this.maxDate, disabled: this.disabled, autoClose: this.autoClose, showOtherMonths: this.showOtherMonths, selectOtherMonths: this.selectOtherMonths, customPicker: this.customPicker, container: this.container, forceDestroyOnUpdate: this.forceDestroyOnUpdate, emitEmptyDate: this.emitEmptyDate, onDateChanged: e => {
            ...
            } }), h("slot", { key: 'd7cb27850a6bde3d6a35ff26cfa0c25a3f06170b' })))));
    }
