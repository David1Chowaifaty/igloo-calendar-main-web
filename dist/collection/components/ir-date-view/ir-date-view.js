...
export class IrDateView {
    ...
    render() {
        ...
        return (h(Host, { key: 'd3986c158472c3a6a9b94ef517761e3e75fb3d92' }, h("span", { key: 'cace66ed3778a6dc52bf1e1f7dc0aeebd153890f', part: "base" }, h("span", { key: 'ee520f45840751cd06aa950cbdd2a710e465e536', part: "from-date" }, fromStr), h("span", { key: '2d9e6a9dcd784948f7c603782b65f95cb6d167e4', part: "separator", "aria-hidden": "true" }, h("svg", { key: '0a43f8bbb95965669c583725d03647476eacb862', xmlns: "http://www.w3.org/2000/svg", part: "separator-icon", viewBox: "0 0 512 512", "aria-hidden": "true", focusable: "false" }, h("path", { key: '929eb1dfd5384183362cc0726b84f715b45d85c0', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" }))), h("span", { key: 'b3aa260650e07d611ad0604ffcdfa1af3f397a9b', part: "to-date" }, toStr), this.showDateDifference && diff > 0 && (h("span", { key: '11ea71ff9ed457ed093089a4c594f161a98a933b', part: "night-count" }, diff, "\u00A0", nightLabel)))));
    }
