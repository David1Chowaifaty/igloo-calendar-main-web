...
export class IrDateView {
    ...
    render() {
        ...
        return (h(Host, { key: '18ad12ddc542204629e09ba9598a70d331dfe908' }, h("span", { key: 'aa872f4d9e09b2b168bb077bd9be6df6210465f1', part: "base" }, h("span", { key: '24659d3b6d718121ae7d6b6b3bbffb071d8313f5', part: "from-date" }, fromStr), h("span", { key: 'a510586e76d6305f26675241314c7c7f2c13ce31', part: "separator", "aria-hidden": "true" }, h("svg", { key: 'bc3e805a996e8175b194cb908d7a115820c933b9', xmlns: "http://www.w3.org/2000/svg", part: "separator-icon", viewBox: "0 0 512 512", "aria-hidden": "true", focusable: "false" }, h("path", { key: '31294f7e770cc0d24e9bc7702464f9f3e275c546', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" }))), h("span", { key: '67df4f74ff35de12373ad2881a2a65ec53c7d189', part: "to-date" }, toStr), this.showDateDifference && diff > 0 && (h("span", { key: '4e59e623a4a5601183926f26c44689da00170cfb', part: "night-count" }, diff, "\u00A0", nightLabel)))));
    }
