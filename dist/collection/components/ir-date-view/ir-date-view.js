...
export class IrDateView {
    ...
    render() {
        ...
        return (h(Host, { key: '4086d726a391e7670f15bdfc20d16f245d245f8b' }, h("span", { key: 'ac68893c77e2c4df70cc3ca14594a6989eda19ae', part: "base" }, h("span", { key: 'a7a8aedde1265c2f0950df150e6aabdc44bd162b', part: "from-date" }, fromStr), h("span", { key: '89c2d31b985cb2a2a618aa709836e6f7143c36f3', part: "separator", "aria-hidden": "true" }, h("svg", { key: 'e97d425abf35fdfb9e4e547abd0f7de9cfe4aee0', xmlns: "http://www.w3.org/2000/svg", part: "separator-icon", viewBox: "0 0 512 512", "aria-hidden": "true", focusable: "false" }, h("path", { key: '3197efb697911e047797db4294bd2bdf4635c0b9', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" }))), h("span", { key: '39dedc050fc0268edb64f0aee90690b11b5ab89f', part: "to-date" }, toStr), this.showDateDifference && diff > 0 && (h("span", { key: 'e9b08828e5b2c62e7a7513e16a48d88f0baf8c25', part: "night-count" }, diff, "\u00A0", nightLabel)))));
    }
