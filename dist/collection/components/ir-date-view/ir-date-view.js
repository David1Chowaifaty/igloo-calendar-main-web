...
export class IrDateView {
    ...
    render() {
        ...
        return (h(Host, { key: '74c92460ef87ed308d648be6606ee9468676197d' }, h("span", { key: '333f83eb49b6a37208df157746530ea0d670d163', part: "base" }, h("span", { key: '5ba963571d7f010fea3c1328e9e57915dfb60cde', part: "from-date" }, fromStr), h("span", { key: 'f9b5b992357e97419b9b0e053855a6e9763b65f8', part: "separator", "aria-hidden": "true" }, h("svg", { key: 'fb1b922658b0fa9c9184e77c4f0839ae83f4f1a8', xmlns: "http://www.w3.org/2000/svg", part: "separator-icon", viewBox: "0 0 512 512", "aria-hidden": "true", focusable: "false" }, h("path", { key: '80c274b14173fbdce7bbe65ed58693b247e381a5', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" }))), h("span", { key: '0ad1746de0b60f5cd0716a76ce6adce0b1cc55a6', part: "to-date" }, toStr), this.showDateDifference && diff > 0 && (h("span", { key: '8014a6c5e30ae544e7a6148347cbade35d3b18b7', part: "night-count" }, diff, "\u00A0", nightLabel)))));
    }
