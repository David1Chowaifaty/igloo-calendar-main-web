...
export class IrPdfViewer {
    ...
    render() {
        ...
        return (h(Host, { key: '0a8527f48b943ebe006e98019f7b4813a870bc39' }, h("canvas", { key: '5191054cd01dd6bbfa4c91336924ac91eebe9d59', ref: this.setCanvasRef, class: { hidden: !!error } }), isLoading && (h("div", { key: '311da8c29c6e6d04993561c99ad9617c2fff57c4', class: "overlay" }, h("wa-spinner", { key: '7cfe9a3b6b98f318f6abcafc22ebd412b13a65b8' }))), error && !isLoading && (h("div", { key: '976fd251b3a254deff5fca9c7f6c9104123570ca', class: "error-state", role: "alert" }, h("wa-icon", { key: '7db693adf90955b6a393eb60448d54c2d0e7115c', name: "triangle-exclamation" }), h("span", { key: 'f2deb492b807696e56a67b59ff2825c7e120f3c2' }, error))), totalPages > 1 && (h("div", { key: '03a576e4e97610dc0e5de775d23399eb68b31828', class: "pagination" }, h("button", { key: '0725f737fa963586df7e4b07742bbf75ec07d0ef', type: "button", class: "page-btn", "aria-label": "Previous page", disabled: atFirstPage, onClick: this.goToPrev }, h("wa-icon", { key: '03dbe47ed33f27d09300e4b08fb8f035b1676793', name: "chevron-left" })), h("span", { key: 'e24a9525e13a439e0a3dcf90e86fc859924ae391', class: "page-label", "aria-live": "polite" }, currentPage, " / ", totalPages), h("button", { key: '43923d8a2b5c33e512c004576696110bdcde33c1', type: "button", class: "page-btn", "aria-label": "Next page", disabled: atLastPage, onClick: this.goToNext }, h("wa-icon", { key: '9baf727e710cff7b28af492a8a156557328df474', name: "chevron-right" }))))));
    }
