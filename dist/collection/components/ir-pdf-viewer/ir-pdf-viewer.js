...
export class IrPdfViewer {
    ...
    render() {
        ...
        return (h(Host, { key: 'c8e90cbf2b7b2ea3c6498bf06840d4fa0438dc67' }, h("canvas", { key: '35404132d19fbdccab474f0b3dedbb0f6bd9cdae', ref: this.setCanvasRef, class: { hidden: !!error } }), isLoading && (h("div", { key: 'dc25220012c7750ac312817cde73d84b5f5117d8', class: "overlay" }, h("wa-spinner", { key: '2baf79c98dc49286863718d1fb4dc795ce57039e' }))), error && !isLoading && (h("div", { key: '9bc3b9e2b97b0db17979bcc6ea3103a9dfc97189', class: "error-state", role: "alert" }, h("wa-icon", { key: '6cfca3251e0c513396e8e3984cda7c028fe797d6', name: "triangle-exclamation" }), h("span", { key: '49468a90bceff2cb551272a466c791ca5bb2d88c' }, error))), totalPages > 1 && (h("div", { key: '54426e2c3688330eeb95b59ccab8009a8fb5c070', class: "pagination" }, h("button", { key: '6139838a5dab2a5afc6a23fd3efe5190baf6014f', type: "button", class: "page-btn", "aria-label": "Previous page", disabled: atFirstPage, onClick: this.goToPrev }, h("wa-icon", { key: '4d9d34295e6b4c584e66c3322b7022e9bd9ead6c', name: "chevron-left" })), h("span", { key: '08233181b1eda589f84636c3557f99a7cc25f32d', class: "page-label", "aria-live": "polite" }, currentPage, " / ", totalPages), h("button", { key: '5725fa4913197b6f31b7b4ec7aab3fb3eddf9181', type: "button", class: "page-btn", "aria-label": "Next page", disabled: atLastPage, onClick: this.goToNext }, h("wa-icon", { key: 'ba1508b94d8ab064cb90d6c806c558f2ac790f98', name: "chevron-right" }))))));
    }
