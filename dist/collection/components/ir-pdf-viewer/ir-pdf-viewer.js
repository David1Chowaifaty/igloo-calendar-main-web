...
export class IrPdfViewer {
    ...
    render() {
        ...
        return (h(Host, { key: '90517961f2e6b801932111b8587fb63e9bc380c7' }, h("canvas", { key: '1678d6e2e0496a79b838028fd350a45834c42f72', ref: this.setCanvasRef, class: { hidden: !!error } }), isLoading && (h("div", { key: 'f99e78d5916c2899b1ab26c6bfd86f420b3fff29', class: "overlay" }, h("wa-spinner", { key: 'b186d27f02a4e296065c1ce197c4622fb575abdb' }))), error && !isLoading && (h("div", { key: '222e46501a62a7b409c1aeb82dc1a9ea0dc4b2bd', class: "error-state", role: "alert" }, h("wa-icon", { key: 'e385e36f6d93b6f8d104baeb20700451eea1a81c', name: "triangle-exclamation" }), h("span", { key: 'b3d475d19b96a0ec12ce282cf1dc855f856cd91a' }, error))), totalPages > 1 && (h("div", { key: 'c0540c8d423d67a506112700b6b42302d20cd2a7', class: "pagination" }, h("button", { key: '5d01e2f7893adba73998902911875492595f6079', type: "button", class: "page-btn", "aria-label": "Previous page", disabled: atFirstPage, onClick: this.goToPrev }, h("wa-icon", { key: '909635cac84139e5505ed5b7eef25205def97aac', name: "chevron-left" })), h("span", { key: '645cdba1746a376bbcd1624e1f5bcbd2e80f6b8b', class: "page-label", "aria-live": "polite" }, currentPage, " / ", totalPages), h("button", { key: 'd1882070eb22bc0ca60c0afe8341ceaaccead822', type: "button", class: "page-btn", "aria-label": "Next page", disabled: atLastPage, onClick: this.goToNext }, h("wa-icon", { key: '805181656084cc005fd1c7e470ce98af0112bc56', name: "chevron-right" }))))));
    }
