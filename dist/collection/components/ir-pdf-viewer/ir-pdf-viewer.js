...
export class IrPdfViewer {
    ...
    render() {
        ...
        return (h(Host, { key: 'd92ab66c915c65bf35c6dfa5abd807453e054e78' }, h("canvas", { key: '3232e3316857140b7af7473a7d21a96d34b030d9', ref: this.setCanvasRef, class: { hidden: !!error } }), isLoading && (h("div", { key: '67baca71d0ad58f951824db5d4e92251d34864bb', class: "overlay" }, h("wa-spinner", { key: 'ce20b0e0a216f97a01970b69a178b5f0c511f203' }))), error && !isLoading && (h("div", { key: 'e11fc9161e1dd365c82be236f9cbe4a16f979176', class: "error-state", role: "alert" }, h("wa-icon", { key: 'c6040a4f1b081d2579ada0045719072ac4f1867b', name: "triangle-exclamation" }), h("span", { key: '96f8972069854fe3e6839558f62b2fe27a738f6d' }, error))), totalPages > 1 && (h("div", { key: 'ee52f946869130ce826b740212a8706e6a3adfa8', class: "pagination" }, h("button", { key: '4ded9c953c2818308361281289ab4df2152266a4', type: "button", class: "page-btn", "aria-label": "Previous page", disabled: atFirstPage, onClick: this.goToPrev }, h("wa-icon", { key: 'ddbdf7ff0db368eb27d27e050b31539673c8e624', name: "chevron-left" })), h("span", { key: 'c1d3c17751c568ec8a0ecfa885f8b98eb85e1ae3', class: "page-label", "aria-live": "polite" }, currentPage, " / ", totalPages), h("button", { key: '02c9fe72dc4b356f8d47417d8304c48042d7137e', type: "button", class: "page-btn", "aria-label": "Next page", disabled: atLastPage, onClick: this.goToNext }, h("wa-icon", { key: '72bd118f07f45e97f8b4113e5408557cb1ca58b5', name: "chevron-right" }))))));
    }
