...
export class IrPdfViewer {
    ...
    render() {
        ...
        return (h(Host, { key: '14366aed12a9772dc35c61bf8cbc9db2669a8c04' }, h("canvas", { key: '528159361a002c9b8f29c791747a7e20d609863a', ref: this.setCanvasRef, class: { hidden: !!error } }), isLoading && (h("div", { key: '6cb334c0ae373e34cce956619eeda0afb9c9ee94', class: "overlay" }, h("wa-spinner", { key: 'c559abeee4088f3765f2f2c2a8886088e440d894' }))), error && !isLoading && (h("div", { key: '20c297b562bbda6a3c73199c6b34cea0b65623d7', class: "error-state", role: "alert" }, h("wa-icon", { key: '044c99d959c1d182c70ca209a6264a19ab8d882c', name: "triangle-exclamation" }), h("span", { key: '8dc909a74ecab77213f99a5a992089b0f6fd8549' }, error))), totalPages > 1 && (h("div", { key: 'eb03afff7c569eb0c7ff40f16fd83f62493d4de4', class: "pagination" }, h("button", { key: '3e1132a5f4f890a61a2985695457b0b3d6893347', type: "button", class: "page-btn", "aria-label": "Previous page", disabled: atFirstPage, onClick: this.goToPrev }, h("wa-icon", { key: '820446e74f63bf46160224b05a9164cd55e5e665', name: "chevron-left" })), h("span", { key: '0cc425920ee202ebfaaf8c37b0fd32d83eb42fc7', class: "page-label", "aria-live": "polite" }, currentPage, " / ", totalPages), h("button", { key: '196a1b206ec41cdc431118a63edbe19aadcff734', type: "button", class: "page-btn", "aria-label": "Next page", disabled: atLastPage, onClick: this.goToNext }, h("wa-icon", { key: '497dcb97111c66bd09a8565e80763874ba25852d', name: "chevron-right" }))))));
    }
