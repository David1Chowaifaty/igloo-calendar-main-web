...
export class IrPdfViewer {
    ...
    render() {
        ...
        return (h(Host, { key: '2f811d48563d44b94bc3b9584829cd3cf214c2d3' }, h("canvas", { key: 'cf3953868462efd20db8ddf95ae03ef34822005c', ref: this.setCanvasRef, class: { hidden: !!error } }), isLoading && (h("div", { key: 'ba321090f5fd23fbcd50999db6f1d8dfe2d44206', class: "overlay" }, h("wa-spinner", { key: '19415b521503f95315175b03988f9d6b780a5b21' }))), error && !isLoading && (h("div", { key: '79fcfbdc7aa4585421514a2e1f4b0e4674e7dac5', class: "error-state", role: "alert" }, h("wa-icon", { key: 'a049068eca1d8c010da60fcdb3c946baafb1b56e', name: "triangle-exclamation" }), h("span", { key: 'b8a1df194e579e0660dbe38be8a6586c864890c5' }, error))), totalPages > 1 && (h("div", { key: '61ba78d667c252f7a49f8c7231f405808a817e7a', class: "pagination" }, h("button", { key: 'f729783f3c9a5e0916d1c0632a3a177f39fae16a', type: "button", class: "page-btn", "aria-label": "Previous page", disabled: atFirstPage, onClick: this.goToPrev }, h("wa-icon", { key: '338f48f9a2148ef69233d18d1b32b25828faf8b5', name: "chevron-left" })), h("span", { key: 'f745b7f0ac001bba3be9568a55556d157f466143', class: "page-label", "aria-live": "polite" }, currentPage, " / ", totalPages), h("button", { key: 'dfea8fa28f918fb3ae4612a767efb202eb6b0571', type: "button", class: "page-btn", "aria-label": "Next page", disabled: atLastPage, onClick: this.goToNext }, h("wa-icon", { key: '6e4b0c95624882b6f385742ee85b2a009f12a126', name: "chevron-right" }))))));
    }
