...
export class IrPdfViewer {
    ...
    render() {
        ...
        return (h(Host, { key: 'b60f8dc623de63d67085efbf53d1c9d54674928e' }, h("canvas", { key: '2162a0d895f0a0abfd01997f7283baf87e91b4f5', ref: this.setCanvasRef, class: { hidden: !!error } }), isLoading && (h("div", { key: '6288aa732f821514d1a92affb3560cd75b7785fb', class: "overlay" }, h("wa-spinner", { key: '3471175add62121d8dac5ce78bb9c6da5de3ae45' }))), error && !isLoading && (h("div", { key: '384c7a08fb0fcc29ff3d6786eec9388e879b256e', class: "error-state", role: "alert" }, h("wa-icon", { key: '17b8a6f8449e0be5f1b71ee2d015205b1b4ec149', name: "triangle-exclamation" }), h("span", { key: 'f987c39b1ac17604f5ff449c88fb8fd6c5db5f28' }, error))), totalPages > 1 && (h("div", { key: 'bf0e0a569c94a20640bc99a4f4f9b9cef426b876', class: "pagination" }, h("button", { key: 'e16f5a265381df90a52ae9cbc40dc2b191fd75b4', type: "button", class: "page-btn", "aria-label": "Previous page", disabled: atFirstPage, onClick: this.goToPrev }, h("wa-icon", { key: 'e70bc5b9bf9c821e979611eb4df266c605f58b23', name: "chevron-left" })), h("span", { key: 'de8684b230843cbeff23fc80e23768cfd4dcba4b', class: "page-label", "aria-live": "polite" }, currentPage, " / ", totalPages), h("button", { key: 'bfcc874d825e94a54e48901fccae819712cda0f8', type: "button", class: "page-btn", "aria-label": "Next page", disabled: atLastPage, onClick: this.goToNext }, h("wa-icon", { key: 'c11dce5158ec70c7b5de85cd2c0a68fb68b17b5b', name: "chevron-right" }))))));
    }
