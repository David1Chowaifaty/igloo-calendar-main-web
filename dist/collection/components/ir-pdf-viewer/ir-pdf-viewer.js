...
export class IrPdfViewer {
    ...
    render() {
        ...
        return (h(Host, { key: '9030f60dd6ae90a2627e70b6172c0f8af07d5aa0' }, h("canvas", { key: '4c60e02ac2d80dc0173d7d7324b8630334b08607', ref: this.setCanvasRef, class: { hidden: !!error } }), isLoading && (h("div", { key: 'be101ffe87a0302a153ee6be088fe9aaccb1ae7b', class: "overlay" }, h("wa-spinner", { key: '9c6de3942070104241c0f4356e774eb05b95246d' }))), error && !isLoading && (h("div", { key: '50b117f68f5d9b2be3d5a4f6cda7268159d4b0d5', class: "error-state", role: "alert" }, h("wa-icon", { key: 'd7607ead61ca662fdbd05d884ed1a6596a55b8b7', name: "triangle-exclamation" }), h("span", { key: 'bbe57c1a1d0320bb016f12035d5ccdd2765af59b' }, error))), totalPages > 1 && (h("div", { key: '0d4ad659090677db18e115aa0c07bda1438c5fd2', class: "pagination" }, h("button", { key: '8a9df5811be936c2df2d69add29ee933a2af8693', type: "button", class: "page-btn", "aria-label": "Previous page", disabled: atFirstPage, onClick: this.goToPrev }, h("wa-icon", { key: '981f939eb4fb09af6df175561ddd5848d537fbb4', name: "chevron-left" })), h("span", { key: 'c49e5e24fdb10e774451e4798362856ac696fbb7', class: "page-label", "aria-live": "polite" }, currentPage, " / ", totalPages), h("button", { key: '6a39db7193be9e4b322e1125c375ced6901bcb86', type: "button", class: "page-btn", "aria-label": "Next page", disabled: atLastPage, onClick: this.goToNext }, h("wa-icon", { key: 'b91ed3dcd62186ee5d5b517d6b95c6a6d2ec566f', name: "chevron-right" }))))));
    }
