...
export class IrPdfViewer {
    ...
    render() {
        ...
        return (h(Host, { key: '5c372d08e095643133c70f46c7f0bc6044b70492' }, h("canvas", { key: '97e75177771e1e3a55175bf1ca060b5e1648143c', ref: this.setCanvasRef, class: { hidden: !!error } }), isLoading && (h("div", { key: '8f8709919fa811c79ee1f755d443b96bed799477', class: "overlay" }, h("wa-spinner", { key: 'df7acff5516d62ccdae403a6f92c7dd4fdbeed8d' }))), error && !isLoading && (h("div", { key: 'e11f29c53817995f509ae43a0929aa1f837dd831', class: "error-state", role: "alert" }, h("wa-icon", { key: 'd908c742001801f9fd473a794c858a3e8261be08', name: "triangle-exclamation" }), h("span", { key: '4306f9b064257a04fd48972d5ee435959b7191ec' }, error))), totalPages > 1 && (h("div", { key: '27ee5054524e8d69d22aabe80aa4456691e3eeeb', class: "pagination" }, h("button", { key: '4ae2e6052b0fa371a47b3c2602a81e3ca7a6986b', type: "button", class: "page-btn", "aria-label": "Previous page", disabled: atFirstPage, onClick: this.goToPrev }, h("wa-icon", { key: '02bea6e51a844f99280cf4907544fc4b5523a251', name: "chevron-left" })), h("span", { key: 'b2c3f6d14fc2788c07408ca0d4023479a4717df0', class: "page-label", "aria-live": "polite" }, currentPage, " / ", totalPages), h("button", { key: 'c326de3dde01b572f07ca99faddc74b14f534f86', type: "button", class: "page-btn", "aria-label": "Next page", disabled: atLastPage, onClick: this.goToNext }, h("wa-icon", { key: '595d1b65915f23595800614b8c6683b51504c9d3', name: "chevron-right" }))))));
    }
