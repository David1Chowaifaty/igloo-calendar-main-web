...
export class IrPdfViewer {
    ...
    render() {
        ...
        return (h(Host, { key: 'a672b0fbe19e53d56687813036c45d5ef756bcd0' }, h("canvas", { key: '8411d6b3ea39fb1384c424c6f2903416c34cef58', ref: this.setCanvasRef, class: { hidden: !!error } }), isLoading && (h("div", { key: 'd560f1a6127b486f5cff17bd7e696a5a2523c781', class: "overlay" }, h("wa-spinner", { key: '5a03fddbfef2d91df814e76ccb8f82a6ec9c18da' }))), error && !isLoading && (h("div", { key: 'ccc0c35829399db435abe610ee087704a0bf0d99', class: "error-state", role: "alert" }, h("wa-icon", { key: 'e711f6cda9b7ca1d07e7e8e0bb4ba9bbd9619a1b', name: "triangle-exclamation" }), h("span", { key: 'ff4e97b28d79dddb05668cd5dc6df06ddf15ff5e' }, error))), totalPages > 1 && (h("div", { key: '89e0b104bc1465dc1f0bbc499757da79563f540f', class: "pagination" }, h("button", { key: 'e2d7fe3f24682db0983d832ec83f46756c83c04f', type: "button", class: "page-btn", "aria-label": "Previous page", disabled: atFirstPage, onClick: this.goToPrev }, h("wa-icon", { key: 'fae8a735f943b94aaea10ad07e29fc636683d372', name: "chevron-left" })), h("span", { key: 'bdceffe459ca365fc3fdf651fce0c6d4e6180c5f', class: "page-label", "aria-live": "polite" }, currentPage, " / ", totalPages), h("button", { key: 'e1a0dc895ab3d3a8f55a545642b16c928f6bc702', type: "button", class: "page-btn", "aria-label": "Next page", disabled: atLastPage, onClick: this.goToNext }, h("wa-icon", { key: 'fb370398cbbcfe48063bb3563d5bdbaa7fdeb677', name: "chevron-right" }))))));
    }
