...
export class IrTitle {
    ...
    render() {
        return (h(Host, { key: '7acfc9adbf7bedefdc57b9c2c0802d93f26b6079' }, h("h4", { key: 'e90a821cddc6b92f0067a67cad724bf12b7a4c1f', class: "ir-text-start label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (h("ir-icon", { key: '8230d6976319fb085aea0f064dabf018754aed70', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, h("svg", { key: 'a70e1ad6b7716a828b6fab08df24fd100097217a', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '570fc751352280dbce9022887b2dc29f336bd1d8', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (h("div", { key: 'f74953cb21bae4cb33b8edfdf1ede72858acc0fa', class: 'title-body' }, h("slot", { key: '04a5b6df9d76aed69cfdc14ac282c5996dce9898', name: "title-body" })))));
    }
