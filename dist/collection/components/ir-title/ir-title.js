...
export class IrTitle {
    ...
    render() {
        return (h(Host, { key: '845a3d9b47ab268dfeb0e998c5f09ae9ad6e1b3d' }, h("h4", { key: '43ddd5851dfde5eb05aef0bf844235bd2c06fde9', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (h("ir-icon", { key: '1cacf53a30c7148c6415bda9fe99a4e9f0b4bcf8', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, h("svg", { key: 'dcc4a97caca1e83e598da8e73e99b36f248f6236', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '949b4d04a387b45f37bc1bcdff2f437686a35265', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (h("div", { key: 'f1e3b48cdf5f2c35a93b213aac0e28821b8f007e', class: 'title-body' }, h("slot", { key: 'a631ba69bbfb1704547a8c44bb73fbf575b973ad', name: "title-body" })))));
    }
