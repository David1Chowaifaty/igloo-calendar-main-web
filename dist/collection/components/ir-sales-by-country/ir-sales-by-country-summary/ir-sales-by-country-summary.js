...
export class IrSalesByCountrySummary {
    ...
    render() {
        ...
        return (h("div", { key: '6b0ffa79214cbaf3185c7a1e46b8eda2259908c0', class: "sales-by-country-summary__container" }, h("ir-stats-card", { key: '6da910e424f947fe69405fe737e795a9b42bda0b', cardTitle: "Total Room Nights", icon: this.getIcon(totalRoomNights, lastYearTotalRoomNights), value: totalRoomNights.toString(), subtitle: lastYearTotalRoomNights ? `Last year ${lastYearTotalRoomNights}` : undefined }), h("ir-stats-card", { key: '7331852486c51455459a400eaa5a8c382bdd8c68', icon: this.getIcon(totalGuests, lastYearTotalGuests), cardTitle: "Total Guests", value: totalGuests.toString(), subtitle: lastYearTotalGuests ? `Last year ${lastYearTotalGuests}` : undefined }), h("ir-stats-card", { key: 'ed8cf27fe09b2cfa65939611edb57be2a384a85c', icon: this.getIcon(totalRevenue, lastYearTotalRevenue), cardTitle: "Total Revenue", value: formatAmount(calendar_data.currency.symbol, totalRevenue), subtitle: lastYearTotalRevenue ? `Last year ${formatAmount(calendar_data.currency.symbol, lastYearTotalRevenue)}` : undefined })));
    }
