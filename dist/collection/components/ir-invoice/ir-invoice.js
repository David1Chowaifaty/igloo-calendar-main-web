...
export class IrInvoice {
    ...
    render() {
        return (h(Host, { key: 'a22b1937e83d96936d18818fca3e5a7b9a641dd0' }, h("ir-drawer", { key: 'f6aec46f24a55e658d38f649d8a169323849753c', style: {
                ...
                e.stopPropagation();
                this.closeDrawer();
            } }, h("div", { key: '25099a46d18b666d15657ad598cd2e0bba50dc13', class: "d-flex align-items-center", slot: "header-actions" }, h("wa-switch", { key: 'fe2ed488173ea2dc360cdc8f7d83a96b2647d7ce', defaultChecked: this.viewMode === 'proforma', checked: this.viewMode === 'proforma', onchange: e => {
                if (e.target.checked) {
                    this.viewMode = 'proforma';
                }
                else {
            ...
            } }, "Pro-forma")), this.open && (h("ir-invoice-form", { key: 'e85bf2164cbeded6aec5da9b26f10d4cc3543f24', viewMode: this.viewMode, for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, formId: this._id, onPreviewProformaInvoice: e => (this.invoice = e.detail.invoice), invoiceInfo: this.invoiceInfo, onLoadingChange: e => (this.isLoading = e.detail) })), h("div", { key: '15f2c4e0532007dea997a4ecec7f777584a9f403', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: '86bf6d66c2178d8104f54be61869ed879c8b3b05', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), h("ir-custom-button", { key: 'ed5caa5c66e13a98523c5a1870cf147d1d2e66ac', disabled: this.invoiceInfo?.invoiceable_items?.filter(i => i.is_invoiceable)?.length === 0, loading: this.isLoading, value: "invoice", type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand", id: `confirm-btn_${this._id}` }, "Confirm")), h("ir-preview-screen-dialog", { key: '5ceb4f07eb59a3774a660a6e6b391ecc82b3ad02', onOpenChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!e.detail) {
                    this.invoice = null;
                }
            }, open: this.invoice !== null }, h("ir-proforma-invoice-preview", { key: 'a70d129e39d770dd4ec5c011a7c89c0ad132743c', invoice: this.invoice, property: calendar_data.property, booking: this.booking })))));
    }
        ...
        return {
            ...
            "invoiceInfo": {
                ...
                "complexType": {
                    ...
                    "resolved": "{ invoiceable_items?: { key?: number; type?: InvoiceableItemType; status?: any; system_id?: any; amount?: number; currency?: { symbol?: string; code?: string; id?: number; }; booking_nbr?: string; invoice_nbr?: string; reason?: { code?: InvoiceableItemReasonCode; description?: string; }; is_invoiceable?: boolean; }[]; invoices?: { user?: string; status?: { code?: string; description?: any; }; date?: string; system_id?: number; currency?: { symbol?: string; code?: string; id?: number; }; booking_nbr?: string; target?: any; nbr?: string; remark?: string; billed_to_name?: any; billed_to_tax?: any; items?: { key?: number; type?: string; status?: { code?: string; description?: any; }; description?: any; system_id?: number; amount?: number; currency?: { symbol?: string; code?: string; id?: number; }; booking_nbr?: string; invoice_nbr?: string; is_invoiceable?: boolean; }[]; credit_note?: { user?: string; date?: string; system_id?: string; reason?: string; nbr?: string; }; pdf_url?: any; total_amount?: any; }[]; }",
                    "references": {
                        "BookingInvoiceInfo": {
                            "location": "import",
                            "path": "./types",
