...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: 'e81eb9e7b77ad0e572d37127ab50322fd15a7852', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: 'ce8e714a5219567ff99bda0ebd71c575616b9d00', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: '69ac112b5aaaa7d8d5032568cb944928ab7fed0d', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: '9a8f1734fd0fd06e5b1d04e6ecb41c3c187209fc', name: "hint", slot: "hint" }), h("slot", { key: '193ba5f17677bcb43f8d9bf2372fc06ab8bd6f20', name: "start", slot: "start" }), h("slot", { key: 'b6ba75595712d21b3db091cd15cc5becf408f86d', name: "end", slot: "end" })), h("div", { key: '35f4b92bf3c21830a9ec20f33f145807ea3386fc', class: "picker-surface" }, h("div", { key: '59ea6bb9faa09f12e0479d633753f7b51c1cfed2', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: '811ad980b712c965ba32b0597cb12c7a42cd224f', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
