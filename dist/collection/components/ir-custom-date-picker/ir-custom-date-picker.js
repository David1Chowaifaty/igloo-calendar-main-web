...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: 'a6dbf6f1c762933a72d92acf69b864ce9adb8703', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '1e13de0b2442767afb7a7fad5a5a4e466be105dd', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: '4b8ae172ad2cd7d79f3fbb1cf1d1c6187b57cf7a', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: '19cc168ab6fc9ed97bf04fcb004b8ac3c3a1d858', name: "hint", slot: "hint" }), h("slot", { key: '5b2accaeb7d44df828fbd1527674331eddc1fa76', name: "start", slot: "start" }), h("slot", { key: '9d55e27f8b1e80271227497a85bd03d891f72341', name: "end", slot: "end" })), h("div", { key: '3c80e3747900f91063978a3bf18bac2fefc415c0', class: "picker-surface" }, h("div", { key: '3e411bbf38e03863aacb40f9e9113b793ae2560a', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: 'c569b80325cc898d1013684aa19884b9fe365542', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
