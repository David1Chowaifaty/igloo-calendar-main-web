...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: '82f871cc8e4d276f5e29b8d9683daa7897a7a91a', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '55b4f049f5588b9d8236f27f0cf06d445d470a26', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: '89e768886655557949a5b4214b423dd9b609653d', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: 'aa72d9c89f28288837fa1ed83371386f522e5e0b', name: "hint", slot: "hint" }), h("slot", { key: '6c4c3f1bfa1a09e842e69c3cd84e198aa0c57baa', name: "start", slot: "start" }), h("slot", { key: 'ceba0799c2f9d2ac7de1b15036c58e7d68cf0586', name: "end", slot: "end" })), h("div", { key: '8bb60a2ac25db3f515c4c81315e6cd03c1bd456a', class: "picker-surface" }, h("div", { key: 'f8854a55aa99261f9c63be131e4ef8c3195632db', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: 'db8e7dc40c3ba8431a8e1c62295b1942b83c4a32', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
