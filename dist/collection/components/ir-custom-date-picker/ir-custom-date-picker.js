...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: '7f5e9e1d040e93cae1c2e86a0a56852b490e74c5', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: 'b95314716c19e4a32c55e92be7cecbc8a5570b41', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: '76457e220a4255e418c6acfb29d664f0354adac5', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: '0a12ff3ae1eff47bf7356a8be6d3823ded1d1989', name: "hint", slot: "hint" }), h("slot", { key: 'e3ff8383ca5a6595b82eef0e0fdd299f18751eea', name: "start", slot: "start" }), h("slot", { key: 'df0070556514a02c892bbb139a0598c0a5427013', name: "end", slot: "end" })), h("div", { key: '48420a4d5e2cb3c8f37b737c81585fd2ee29dae1', class: "picker-surface" }, h("div", { key: '54a111016c9fb359ff09b47ef967cb8b72c00f2a', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: 'be23362437ad3bdf614822ca4234f62a2772929a', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
