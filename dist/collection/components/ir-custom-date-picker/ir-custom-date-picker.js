...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: '64aeee1b45258c6da4f252e1ca5744bf0bd92c5d', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '2a4c7c0de7347a67fe11550441c4a81742fba646', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: 'bdb5fa72883413e9fa9759b8ffda8f694cfbd275', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: 'e8a8823e439d034cefa9dff741ff4d762c18bbf7', name: "hint", slot: "hint" }), h("slot", { key: '5a5595b06672d203c960989ff2d8015d27f392aa', name: "start", slot: "start" }), h("slot", { key: '08552b66054fc9e7f48248828340002bcfcb8260', name: "end", slot: "end" })), h("div", { key: '7c1fc29cfeb4e99597c9e04d3bec0891d0e8f893', class: "picker-surface" }, h("div", { key: '0224541ddf242dd40c6b187de34341ffbb0c4812', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: '6c61d8133d8a1d35564783398999304870894935', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
