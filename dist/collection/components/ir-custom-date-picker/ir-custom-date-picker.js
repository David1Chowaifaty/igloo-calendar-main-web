...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: 'c42e20136385bb095f07c03bfd7b89663833064e', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: 'd5ca6995c49150d45ce0feae01ac62a74fbec732', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: 'e74f2f75594ca04826bbaa83bf3eada21d143378', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: '2fd3f7363f29c11f2ccf91eb9668014bfe0079f8', name: "hint", slot: "hint" }), h("slot", { key: '7f7a4aba49e7bd791f3394da8ccd232ee38cf1b6', name: "start", slot: "start" }), h("slot", { key: 'a471132db64fea561645971613391c714d650791', name: "end", slot: "end" })), h("div", { key: 'edf5b98166078747194f9e9d2631ad55eda2cb1a', class: "picker-surface" }, h("div", { key: '8b13cf47c45c21acdb74bd02fc5bcf21dfedd834', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: '6e3c55168e30b8c14c68c4576c0d3e894c2d60c2', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
