...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: '429ad6f4ff11928953fe59ae72d68334b1b7e7cf', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '1697cdf6eb747c259e0396ed7c9064affacf8674', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: '1aafe517cf155a2e97eeb645fb108995aa05bcb7', placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", value: this.getTriggerLabel(), label: this.label }, h("slot", { key: 'e8fc362255a94ffbef05c64f046569fdd0cb4afe', name: "start", slot: "start" }), h("slot", { key: 'add13c8e128e3586584fe648100a83479177e384', name: "end", slot: "end" })), h("div", { key: '2153aa27a245a4ebe52ddddfb0fa5fbefa2ab05a', class: "picker-surface" }, h("div", { key: '8f0395ff4286139042435761b706a7bef2367f03', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: '8fdba6f0874112184081e83a47b1afb7d1971e04', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
