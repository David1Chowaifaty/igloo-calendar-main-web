...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: '7703e4c8a77a6ea291beaa067d3fdff9354f0a50', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '26446d31fabe587c6afd49a45b78cdc2dbda7af0', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: 'cbda3619129094aa06d6666b751364c9284391f5', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: 'c608445fceb9850283c3e54fd7631aaaae6851cd', name: "hint", slot: "hint" }), h("slot", { key: '3ae28e6827c28f744bb56e6fb72e811747aba626', name: "start", slot: "start" }), h("slot", { key: 'b1caaa56f91b6ec6cf7cd8da41cb54c1f3e088e8', name: "end", slot: "end" })), h("div", { key: '63f85cf4baf0170c5ad48fce815825757523809b', class: "picker-surface" }, h("div", { key: '1c2348a1670ffd4386e67a4f02d66c1d436e6709', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: '372d84d4e88b233cfb7df70ea8e66cf22013a8a5', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
