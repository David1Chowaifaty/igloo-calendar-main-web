...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: 'a4eecdafeb8ba67cb6fc7de7b0a60ff2f6461d3a', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '9c9dce6f0799fae233a1a59e699fbda0ce8ffea1', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: '3e97d50564f65877578a437d8bfdd9d3e75a1b0c', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: 'f8c2c9c9f112b6de2d82e28d362c7534b019ed33', name: "hint", slot: "hint" }), h("slot", { key: 'e1934c9e6595881f3d57474c3fcfc5167af8a0e7', name: "start", slot: "start" }), h("slot", { key: '9d307d51c7099c5218b269228a991a7541887083', name: "end", slot: "end" })), h("div", { key: 'b9a6b64cc8333c1723f8247fc83a3d8cc627a0ec', class: "picker-surface" }, h("div", { key: '8b2ef0c3168e53a2fd2dd49c3a58d72aa04575cd', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: '907c955b1593387bed3c5c7681623d48adb2982e', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
