...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: 'a4d0c95b398c28c123f87eefdc9950b8caddc363', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: 'e40bcb3947c57b0255b085defd629888961f4cee', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: '33a126072d1304ac6ec04b3597d7952033967a39', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: '610aa0fb234223d79b46c62d18a615d4c7b2c9e1', name: "hint", slot: "hint" }), h("slot", { key: '80033e7ca3a56d57bd2dd9e974530b63750b2cb8', name: "start", slot: "start" }), h("slot", { key: 'd7b9384153f0f8866e08b92c41a4544fedf02bdb', name: "end", slot: "end" })), h("div", { key: '61bc7e95fc6f12d583f4109cfc51bfe33fe18fac', class: "picker-surface" }, h("div", { key: '7bd3f66baf4584ed30a05621a0894864a1ce245d', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: 'ea55376a3e98b602530b3fff21da1f65a92ff6b2', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
