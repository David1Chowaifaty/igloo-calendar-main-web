...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: '3845abe30cb06cb6515761c815c8d151935aefa2', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '1c996f791133343b17df7356df4c82ad3a138ac0', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: '97adcd83dd47229be92f90fdb69bca074f856b65', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: 'fcf23384306b6750cdeae2892bad44a4f5c24641', name: "hint", slot: "hint" }), h("slot", { key: '6371f688ff36aa03aeae45b5f6b7cb29456b592e', name: "start", slot: "start" }), h("slot", { key: '19b3cd32534ebbcf0a6199de7eb51cf100bd8742', name: "end", slot: "end" })), h("div", { key: '18255a75154d98f3b035036efdf8bc673d0cf3e7', class: "picker-surface" }, h("div", { key: '0235e64fa654936fac48a7d751cfe4db91907bc2', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: 'c02ca20e2d3572a0fa9348d5ddd809675c9ecd23', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
