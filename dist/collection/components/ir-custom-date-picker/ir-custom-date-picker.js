...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: 'f824832a52db131b60ebb11992cda5b289a661f3', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '7e1451fbefd6ba8c01bce5451a6afc29c6519caf', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: '1d9859e67fc87c6fefdb384b7c86057efeb40cb6', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: '28120eecec81c608c2c1dcda540c6e9120e76f1c', name: "hint", slot: "hint" }), h("slot", { key: 'bc7cc0be08f7ab639fe323d1b876be55cdb2bc1d', name: "start", slot: "start" }), h("slot", { key: 'cf42fad51f764c58e564c66ec081724df48b953d', name: "end", slot: "end" })), h("div", { key: '75adbd10d802ae3b220f4fd12af66c8c02695e1e', class: "picker-surface" }, h("div", { key: '0a9d5d0acef6c4e2c24fc702bc3c54802c04d4d0', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: '422c44f930b36a4fd866c4c89199d3a070fb714e', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
