...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: 'f7c87e89ce1b1dab382e248305a08798ec89dd7f', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '63bc5e7261c44f0dfcc04202ead82a754cb87282', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: 'c1a20d83fa033ca6a13b69a88f7bcd1d513707a6', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: 'de4a49e59525ab94612affbf9fe11e07089b97d3', name: "hint", slot: "hint" }), h("slot", { key: '751a146a8309487283b82f466655244644654228', name: "start", slot: "start" }), h("slot", { key: '9808aebcb44d9432716d7214c3aec00258f8ab48', name: "end", slot: "end" })), h("div", { key: '1f22fa4ef9a500719b3ecc89f5b15f798f39c8fb', class: "picker-surface" }, h("div", { key: 'fb253ec31abbca0164282b5ffd4f260673c57bf9', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: '56aebeac72bbcd5875658dec801bd9cfc3b04dcd', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
