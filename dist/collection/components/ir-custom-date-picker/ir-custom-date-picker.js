...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: '8ae8a3c26fecb833e3dafb0609e6e9763ce35c01', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '8c737eb22ad5f52b606e43374982bd6f855ee6fa', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: '91895c2c5e319627d03d46ad55c78e38c55af205', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: '4b677d45ba7186e0ac5524d845ac9805bbaa3f2b', name: "hint", slot: "hint" }), h("slot", { key: '1a8e5f5ea42be9f26871935ad57604739fd7457e', name: "start", slot: "start" }), h("slot", { key: 'c1b704edc4bc2703af175d69962e8eb23d0fda1e', name: "end", slot: "end" })), h("div", { key: '470297065ddb00e5c7f55f002a8abb86f1b67d74', class: "picker-surface" }, h("div", { key: 'ee935d002ca3483e37a872d586b85af68d3c9545', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: 'd724b7c759f5689795383b989abc3c347d9dd1ae', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
