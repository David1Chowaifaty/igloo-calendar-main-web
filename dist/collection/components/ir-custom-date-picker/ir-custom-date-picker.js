...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: '97464cbb644f0fc5da5371566c29d63664dc2a7d', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '2fefbb0cf781c85651287748b709b988afad251a', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: 'f6dc4307e92ff7710eddc339c03916fcf96e20c1', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: 'b790725951b4958af7653f4c194cc0908d131ddd', name: "hint", slot: "hint" }), h("slot", { key: '732724f1ea5649946a05f5534316f20870c1e078', name: "start", slot: "start" }), h("slot", { key: '147b49f8fdf71010eca6ad67b99fc83e42b34b07', name: "end", slot: "end" })), h("div", { key: '8943b72ee72f6fa734d0e5852d44fe26fc91c5d5', class: "picker-surface" }, h("div", { key: '9d7cf34c89e2460eb9e6d874ea7cbe04eb7415e6', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: '851e21e3010de30b08a9b560c4748257b7ddde50', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
