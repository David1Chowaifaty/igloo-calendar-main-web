...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: '9377c63e056f706929c2baf078f04a208bb54333', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '76e4279f7734c17bdc6f60492c4ad92298d4c08f', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-custom-input", { key: 'f63efaa70c0a960863b2d3185ed196816c1d55d4', tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", value: this.getTriggerLabel(), label: this.label }, h("slot", { key: '380a70c5297a5a9e11dc653381fd5d246deaf1a1', name: "start", slot: "start" }), h("slot", { key: 'fcd15a502fb3e7fef778720160a2ee052022a68a', name: "end", slot: "end" })), h("div", { key: 'a69d3de817b2686591ded8446da25649137b599f', class: "picker-surface" }, h("div", { key: 'ac81008309e7b3d13eba31adb409a84a60076387', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: 'f253b93c4d4ecf27cea7ee267b0f61b85773a93d', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
