...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: 'ca9c5266eed7072988665dfdc2c95c08e3f33a28', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: 'dfc5819c7e6ebec674176b385948097d7a7990c5', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: 'c49dde94aad0b92db7eb851fc9a29c38f7bf2b74', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: 'b2c7c98d3147ffb29b1707fa4185ff1459effd80', name: "hint", slot: "hint" }), h("slot", { key: 'dd2c5dc45477f9d772e6ec99d497b20c1b128b31', name: "start", slot: "start" }), h("slot", { key: 'cd0c95b1eb19e4a5ee7d3463e12b2a8851ebeb37', name: "end", slot: "end" })), h("div", { key: '7c8fb73ac597029bb05b7740d9403d0fe6ad2a20', class: "picker-surface" }, h("div", { key: 'f7deb70761145c7f616d783a367d9f83f3e3b779', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: '04c6876727d57b93aaf31d0e4ff697552eb92de2', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
