...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: '1a5ea0a25c9c6080a47cca20055e4d6aa0e23039', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '7f31fcbf53fc8cd1497cb0aec36fbb2cdf1373f4', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: '8beb5d17507d1792e0aba7c1460f58fdd1304ed2', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: '7ebe20334802cac699282d37128d6da870c9d697', name: "hint", slot: "hint" }), h("slot", { key: 'fbcb2a09a36f44cad06180308659599eaf2e1568', name: "start", slot: "start" }), h("slot", { key: '3e0122d56685a4e35647d5cfeaff21e0daf887af', name: "end", slot: "end" })), h("div", { key: '2ed70a69316235d30e25126e3663688e4ae0bbbf', class: "picker-surface" }, h("div", { key: '35a05cbf0575d186228cb84db278f218e6e9d2c7', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: '8b01ef8ddd17941143ce10a3201790382bfbf030', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
