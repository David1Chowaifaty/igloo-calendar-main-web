...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: 'f1d6cc4be0d79a722791da18038f71a1dfca717b', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '457bab86daa99ad775b818d56145e5ffd179224a', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: 'b8d3247ba2f849d9f8d081d85e4f295caf135312', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: '8fa5b1a01c75455e710049622dcbdf8b7a08de55', name: "hint", slot: "hint" }), h("slot", { key: '388d580db770af060e589995f3facb084e8e24ee', name: "start", slot: "start" }), h("slot", { key: 'ac3bbe4df9b61760b57589ed0640181a8af52250', name: "end", slot: "end" })), h("div", { key: '4711cbbb6fbb3e11c22bf5663ada29cd3d03b0f6', class: "picker-surface" }, h("div", { key: '6a03b1e3cd05d7d3e1d5e5bff39029e0d6d4c32a', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: 'c18b5c97f532ee34675bcb70f0b2f3eba2ebbbc3', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
