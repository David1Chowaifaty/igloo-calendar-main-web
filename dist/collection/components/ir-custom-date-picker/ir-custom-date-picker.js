...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: '815ae7f3da000b7c5b148b11832b9aa50eac268c', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '5e7cbd8a2a74aff6b9fa8440140ebb4799095deb', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: '4635c020b68a23f209294d27606267abe23f6ab3', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: '592823e7df33fda8a59762d818b225c1563aed13', name: "hint", slot: "hint" }), h("slot", { key: '73615492e541a9263fb7aaa6a59182349f8043f3', name: "start", slot: "start" }), h("slot", { key: '6e928dd550bf3a7cbf0d94748d4065c8c1b291eb', name: "end", slot: "end" })), h("div", { key: 'e5bfe6dfeb2ae8a7cb2bbb31579b51980f505808', class: "picker-surface" }, h("div", { key: '928e67bcbc3ea836d7d47aa48a8c582a7e588019', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: 'c5b9a78940e9dacef2b7f9a05b09b180a7f769d0', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
