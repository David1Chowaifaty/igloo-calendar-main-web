...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: '0c4e11dcc57f8ae1f5f60317c06ce6dc0af462ba', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: 'd9246086a559a138d4cb55a49143280f7f5324a0', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: '959ac0f952b8c0cee6d870667d4837be592feb54', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: '5b91fe4a301b8fe2441660ccbfc119a87d7fd6ac', name: "hint", slot: "hint" }), h("slot", { key: '85e63ba1b04101683e7551e7964f225205237e39', name: "start", slot: "start" }), h("slot", { key: '09ea8b919d94255d1a290a445d815e6e49beebff', name: "end", slot: "end" })), h("div", { key: '997329518b33a20ab8891ec3c9b5741bc79e1509', class: "picker-surface" }, h("div", { key: '61e2679bfcb8f4dde9b061fe3d1c0b3f9835d815', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: '2089a995c37addd7e14a9789ac0e16519b2d804d', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
