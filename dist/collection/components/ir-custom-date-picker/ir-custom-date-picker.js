...
export class IrCustomDatePicker {
    ...
    render() {
        ...
        return (h(Host, { key: '7d943461416134f776855e5f23ddb1952410c6c1', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '2f513160a375cc2b80e59ab07f677532ab0c1d8c', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: '1cbefd7e8f784d9d735bf69b75ac8a96641eb706', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: 'c00d1f4bc6deba6a04ff38ceca71514f30369a2f', name: "hint", slot: "hint" }), h("slot", { key: 'c425f65b0ac9f7cabb4ab769be3c6c89a92c8fae', name: "start", slot: "start" }), h("slot", { key: '1b12c37843e0db73d659d7dbbceecbeb8da87ebc', name: "end", slot: "end" })), h("div", { key: 'ffa3fdb16c71b036f9572574c16d77645d21c1d3', class: "picker-surface" }, h("div", { key: '2208a99378cc6a439011d2aa38a5b7ed42ff9c7e', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: 'da97cea0e7ff31d2c762cbc6c6978d7f1eba83bd', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
