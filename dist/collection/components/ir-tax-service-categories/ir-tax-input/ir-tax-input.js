...
export class IrTaxInput {
    ...
    render() {
        return (h(Host, { key: '7b3a44733ff43c4343c03bbad5cff1fa91dcdbf7', class: "ir-tax-input" }, h("ir-validator", { key: '420c5d7b77dd6591a39a9a18cdfdac23b2726cc9', form: "tax-service-categories__form", class: "ir-tax-input__percentage-wrapper", value: this.tax?.value ?? null, schema: this.isTaxInputDisabled ? z.number().nullable() : z.coerce.number().min(0).max(30) }, h("ir-input", { key: '0d2282bc8946051648bd8ac33a15dfba3c5eb34f', disabled: this.isTaxInputDisabled, value: this.tax?.value?.toString() ?? '', mask: {
                min: 0,
                max: 30,
                mask: Number,
            }, onChange: () => {
