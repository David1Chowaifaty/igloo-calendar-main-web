...
export class IrTaxInput {
    ...
    render() {
        return (h(Host, { key: '58eb6d94d888ed0bc82a8b8882c79e1e4e1471a3', class: "ir-tax-input" }, h("ir-validator", { key: 'a129aa5ce271056ad77fbd8e32e27e285dba7880', form: "tax-service-categories__form", class: "ir-tax-input__percentage-wrapper", value: this.tax?.value ?? null, schema: this.isTaxInputDisabled ? z.number().nullable() : z.coerce.number().min(0).max(30) }, h("ir-input", { key: 'fcc9929df826945a229e0a4160ff6e4d3c93f71e', disabled: this.isTaxInputDisabled, value: this.tax?.value?.toString() ?? '', mask: {
                min: 0,
                max: 30,
                mask: Number,
            }, onChange: () => {
