...
export class IrGeneralSettings {
    ...
    render() {
        return [
            h("div", { key: '0ac2d1391198326ea3bc730723d309fb68543ed3', class: "General Settings font-size-small" }, h("div", { key: '5871b4266b37e93ad3ddff9aed0c6159558518a8', class: "container-fluid" }, this.mode == 'edit' && h("div", { class: "text-light border-bottom-light mb-2" }, `ID ${this.data.id}`), h("div", { key: 'dfb781a1544c0c6e27764f5ef9ab5cc75e95f1e6', class: "column" }, h("ir-select", { key: '32dc032c518139099248cb09d47ce0c7b3667a69', class: "channel-select", label: "Channel", data: this.allowed_channels, "label-background": "white", "label-position": "right", "label-border": "none", size: "sm", textSize: "sm", labelWidth: 4, selectedValue: this.data !== null ? this.data.channel : null }), h("ir-input-text", { key: 'd1eca5fca354958de93398634673456d9ecc446d', id: "title-input", label: "Title", placeholder: "Title", value: this.data !== null ? this.data.title : null, "label-background": "white", "label-position": "right", "label-border": "none", size: "sm", labelWidth: 4 }), h("ir-select", { key: '97ad8fda492ed227554fbc8fa203a321f9d61531', id: "property-select", label: "Propery",
                // placeholder="Propery"
            ...
            h("ir-modal", { key: '52cf45ad586f88e83ec5a585cb0d40ce457c1d23', class: "alertFields", modalTitle: "Please fill all the fields!", modalBody: "There are fields that are not filled yet.", iconAvailable: true, icon: "ft-alert-circle warning h1", leftBtnActive: false, btnPosition: "center", rightBtnText: "Close", rightBtnColor: "primary" }),
        ];
    }
