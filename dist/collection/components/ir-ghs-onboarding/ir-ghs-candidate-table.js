...
export class IrGhsCandidateTable {
    ...
    render() {
        ...
        }), !this.isLoading && this.properties.length === 0 && (h("tr", { key: '5af0bfa3ad013e8aa5a8da2144005ef15cb1bc32' }, h("td", { key: '5b982a939931c45fc9b6a82cd10404ad745289b7', colSpan: 6, class: "ir-ghs-candidate-table__empty-state border-0 bg-white" }, h("p", { key: '8164a3230f46ff0e6f188893c45ba5968f312b28', class: "mb-0 small" }, "No candidate properties found."))))))))));
    }
