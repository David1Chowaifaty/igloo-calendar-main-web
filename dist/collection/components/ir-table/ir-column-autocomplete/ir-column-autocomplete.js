...
export class IrColumnAutocomplete {
    ...
    render() {
        ...
        return (h(Host, { key: 'a27f86b69dd79402d576b82f0c8f27493c29e231' }, h("wa-popover", { key: 'e760ed75072092d29c29bb59cd9f1bc1bfbabcc7', placement: "bottom", for: this.generatedTriggerId, class: "column-autocomplete__popover" }, h("div", { key: 'e9f43974fea1191f6db31210e3bca9a2fec5f2f4', class: "column-autocomplete__input-container" }, h("wa-input", { key: 'b5f60e2b9c4a37b8702a33f5d94f539f835e68ff', size: "small", value: this.query, placeholder: this.placeholder, oninput: this.onQueryInput })), h("div", { key: '15f84764256658a77d37427748b9f94f18794d25', class: "column-autocomplete__list" }, this.showSelectAll && (h("wa-checkbox", { key: 'ddd29195fc54e9393cdad3e2b4172e4ec62f065b', checked: this.areAllFilteredSelected, indeterminate: this.areSomeFilteredSelected, onchange: this.onToggleAll }, this.selectAllLabel)), filteredOptions.length > 0 ? (filteredOptions.map(option => (h("wa-checkbox", { checked: this.selected.includes(option), onchange: event => this.onToggleOption(event, option) }, option)))) : (h("div", { class: "column-autocomplete__empty" }, this.emptyLabel)))), h("div", { key: '6388bf252e39d69f3fa23377642affad324d0b08', id: this.generatedTriggerId }, h("slot", { key: '60b4d5501a32fb73ec4c432d9b10cd00864f5664', name: "trigger" }, h("wa-button", { key: '06c6ec446b4611b12b2ed9560eedf69e607f12b6', size: "small", variant: "neutral", appearance: "plain", class: "header-button" }, h("wa-icon", { key: '4c23d0ee5923a5cf8541759c36b5bd13b5aa46d6', name: "filter" }))))));
    }
                ...
                "complexType": {
                    ...
                    "references": {
                        "ColumnAutocompleteSelectionChange": {
                            "location": "local",
                            "path": "C:/Users/user/Code/work/modified-ir-webcmp/src/components/ir-table/ir-column-autocomplete/ir-column-autocomplete.tsx",
