...
export class IrBookingBillingRecipient {
    ...
    render() {
        return (h(Host, { key: '067fab958c7f9ff8600fca927678558e6d5a66c5' }, h("wa-radio-group", { key: 'ef9b3aa08776832e4df6ca1a8711e69ed9cf268e', defaultValue: this.initialValue, onchange: e => this.handleRecipientChange(e.target.value), label: "Bill to", orientation: "vertical", name: `${this.booking?.booking_nbr}-bill-to`, value: this.selectedRecipient, size: "s" }, h("wa-radio", { key: 'dd2ce14af0c11b4dd662c41fbce0932ce60dfe52', appearance: "button", value: 'guest' }, this.booking?.guest.first_name, " ", this.booking.guest.last_name), this.rooms.map((r, idx) => (h("wa-radio", { appearance: "button", class: "billing-recipient__room", value: `room__${r.guest.first_name} ${r.guest.last_name}`, key: r.guest?.id ?? `guest_${idx}` }, h("span", { class: "billing-recipient__guest-name" }, r.guest.first_name, " ", r.guest.last_name)))), !this.booking.agent && (h("wa-radio", { key: '8e862f82f1e2d11597f946805150930bc85e7e4b', appearance: "button", value: "company" }, this.booking.company_name ? this.booking.company_name : 'Use company name'))), h("ir-booking-company-dialog", { key: 'b6696f01b48c4360bfe4a5cbf6d0f703ed8e8e25', onCompanyFormClosed: () => {
