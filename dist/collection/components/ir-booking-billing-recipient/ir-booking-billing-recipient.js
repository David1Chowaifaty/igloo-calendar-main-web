...
export class IrBookingBillingRecipient {
    ...
    render() {
        return (h(Host, { key: '5d38eed96eee6a4bd37f25b2ffb53fd8fe6a1636' }, h("wa-radio-group", { key: '45eda845577af17d9e2a6c17948d65e6808178cc', defaultValue: this.initialValue, onchange: e => this.handleRecipientChange(e.target.value), label: "Bill to", orientation: "vertical", name: `${this.booking?.booking_nbr}-bill-to`, value: this.selectedRecipient, size: "s" }, h("wa-radio", { key: '4eb8c7198954e6338cc678c227578db50c27ca76', appearance: "button", value: 'guest' }, this.booking?.guest.first_name, " ", this.booking.guest.last_name), this.rooms.map((r, idx) => (h("wa-radio", { appearance: "button", class: "billing-recipient__room", value: `room__${r.guest.first_name} ${r.guest.last_name}`, key: r.guest?.id ?? `guest_${idx}` }, h("span", { class: "billing-recipient__guest-name" }, r.guest.first_name, " ", r.guest.last_name)))), !this.booking.agent && (h("wa-radio", { key: '5b4340c8aae2b142321c9802803459c7047eb451', appearance: "button", value: "company" }, this.booking.company_name ? this.booking.company_name : 'Use company name'))), h("ir-booking-company-dialog", { key: '39624e4cd375b2886f46ebd57400b07095c5b75a', onCompanyFormClosed: () => {
