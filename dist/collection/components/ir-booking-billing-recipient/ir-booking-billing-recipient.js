...
export class IrBookingBillingRecipient {
    ...
    render() {
        return (h(Host, { key: '53949f4ed77310d0c2555f5b2f4d9bf989e6fee1' }, h("wa-radio-group", { key: '43da03060dec6b936989867495321b03f6c9beaf', defaultValue: this.initialValue, onchange: e => this.handleRecipientChange(e.target.value), label: "Bill to", orientation: "vertical", name: `${this.booking?.booking_nbr}-bill-to`, value: this.selectedRecipient, size: "s" }, h("wa-radio", { key: '325a69f47b1d2a12825caac54b2bbf00fecfabc4', appearance: "button", value: 'guest' }, this.booking?.guest.first_name, " ", this.booking.guest.last_name), this.rooms.map((r, idx) => (h("wa-radio", { appearance: "button", class: "billing-recipient__room", value: `room__${r.guest.first_name} ${r.guest.last_name}`, key: r.guest?.id ?? `guest_${idx}` }, h("span", { class: "billing-recipient__guest-name" }, r.guest.first_name, " ", r.guest.last_name)))), !this.booking.agent && (h("wa-radio", { key: '8487fd29c44bb0296748f0d3b30495c58347601e', appearance: "button", value: "company" }, this.booking.company_name ? this.booking.company_name : 'Use company name'))), h("ir-booking-company-dialog", { key: '32ae581391d8b24486baa9d7c57eb6cf24f3e619', onCompanyFormClosed: () => {
