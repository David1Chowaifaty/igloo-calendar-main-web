...
export class IrBookingBillingRecipient {
    ...
    render() {
        return (h(Host, { key: '825a8b103eb53955cdb6cd5de724a77aa658bcfa' }, h("wa-radio-group", { key: '4e546071623d935ae15d07306ecab3d1c66b1e03', defaultValue: this.initialValue, onchange: e => this.handleRecipientChange(e.target.value), label: "Bill to", orientation: "vertical", name: `${this.booking?.booking_nbr}-bill-to`, value: this.selectedRecipient, size: "small" }, h("wa-radio", { key: 'd0b47c1e82d97067f0a69494c27acc7683082f32', appearance: "button", value: 'guest' }, this.booking?.guest.first_name, " ", this.booking.guest.last_name), this.rooms.map((r, idx) => (h("wa-radio", { appearance: "button", class: "billing-recipient__room", value: `room__${r.guest.first_name} ${r.guest.last_name}`, key: r.guest?.id ?? `guest_${idx}` }, h("span", { class: "billing-recipient__guest-name" }, r.guest.first_name, " ", r.guest.last_name)))), !this.booking.agent && (h("wa-radio", { key: '7ac610c7c542b5413ead0874221c708b71d7d625', appearance: "button", value: "company" }, this.booking.company_name ? this.booking.company_name : 'Use company name'))), h("ir-booking-company-dialog", { key: '8cdd0a2f4e2bb6e3ea2459a0db583142b3df4f6a', onCompanyFormClosed: () => {
