...
export class IrUserManagementTable {
    ...
    render() {
        return (h(Host, { key: '1894bb741aae790ef2186e3c101faeaa9b9f7b93' }, h("section", { key: 'c14695733bb4a1f1279b9714d4af8bf2ed4a48d3', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, h("table", { key: '8f70ceda07340da924dce0fa17c45f4a3af91f4e', class: "table" }, h("thead", { key: 'b75a89d9445ad2620749b19afceb6eaadcfcb5dd' }, h("tr", { key: 'a733a733496332af64d82e3f8d65e1bee08f20f0' }, h("th", { key: '46160d6966c4def477e16506ac32ef3b9fc07537', class: "text-left" }, locales.entries.Lcz_Username ?? 'Username'), h("th", { key: '58f595ddc8238f58e50c1e09291a35cf5c7146b1', class: "text-left" }, locales.entries.Lcz_Email), h("th", { key: '5e7c85629ebcec1fcccc83241fe27c8fad3bb2b0', class: "text-left" }, locales.entries.Lcz_Mobile ?? 'Mobile'), h("th", { key: 'c406651e136cbbe547ced1cdf3e3806044276e4b', class: "text-left" }, locales.entries.Lcz_Role), h("th", { key: '453393c9a6f333067138ba1cf61a1e6e9c86d660', class: "text-left small", style: { fontWeight: 'bold' } }, h("p", { key: '21b0ab164e4c6cae7794a430055bb26c85eb13b1', class: "m-0 p-0 " }, locales.entries.Lcz_CreatedAt), h("p", { key: 'd6869e56b8c4574c2588059dded6364504aaf6fa', class: "m-0 p-0" }, locales.entries.Lcz_LastSignedIn)), this.haveAdminPrivileges && h("th", { key: 'c9e572320dfd56ac256f525076a2e9a78d5c08a8' }, locales.entries.Lcz_Active), h("th", { key: '490a7bdeec4ccdc950a21b65d1856cdbfd6b112e', class: 'action-row' }, this.canCreate && (h("ir-icon", { key: '2453075bf2c5d6f3053747df919c1ab848a67143', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales.entries.Lcz_CreateUser, onIconClickHandler: () => {
                this.verifyAdminAction({
                    type: 'user',
                    mode: 'create',
                    user: null,
                });
            } }, h("svg", { key: '4b2bd5196e61f1da4bb22e7af65b79a15c19ab36', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, h("path", { key: '13f3fef77499877efe743ca12f06d413dffc27b5', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), h("tbody", { key: '8a38bbebedaf89aacabb2ff57d070c3982ca3a26' }, this.users.map(user => {
        ...
        })))), h("ir-sidebar", { key: '0f0810681b0de87961299a8264f2287c18e4d1cd', open: this.currentTrigger !== null && this.currentTrigger?.type !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
                '--sidebar-width': this.currentTrigger ? (this.currentTrigger?.type === 'unassigned_units' ? 'max-content' : '40rem') : 'max-content',
            } }, this.renderCurrentTrigger()), h("ir-modal", { key: '204453725d9e33a6a35d003265945747c8a557f5', autoClose: false, modalBody: this.modalType === 'delete'
