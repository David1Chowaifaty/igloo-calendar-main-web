...
export class IrUserManagementTable {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (h(Host, { key: '99c248bec92928b477755bccd7ae87a1fa6b5bc5' }, h("section", { key: 'de08287b5b9622ed0b959d537a581c4db9253838', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, h("table", { key: 'eada6d1ee7dbfef122521e047d1c3b84159ced21', class: "table" }, h("thead", { key: '7249129e8b97fedfb045b8d711be1a900dd433eb' }, h("tr", { key: 'abba8fbc31acd9f4e6dfc94be234fa6315832fd4' }, h("th", { key: 'e4dd0d1a4fff4e71ef58d457dcee876944b936ae', class: "text-left" }, (_a = locales.entries.Lcz_Username) !== null && _a !== void 0 ? _a : 'Username'), h("th", { key: 'a551dbd319d4a697737aa96fb722fc08fbe32861', class: "text-left" }, locales.entries.Lcz_Email), h("th", { key: 'f145ddef2624066e728433da17e7737a62adc973', class: "text-left" }, (_b = locales.entries.Lcz_Mobile) !== null && _b !== void 0 ? _b : 'Mobile'), h("th", { key: '83e6fcd57a3e584a7db2ad07f07607fda8b3f861', class: "text-left" }, "Role"), h("th", { key: '00a306cbb416ed985acf8b6bfb8e9b75fc53bdb5', class: "text-left" }, "Last signed in"), h("th", { key: '61da727f7ffe00772dd80cbc9ec9d28e9ce9bfe3', class: "text-left" }, "Created at"), this.haveAdminPrivileges && h("th", { key: 'd14da7bf7389c347092cdc00b1cba6cb0b028513' }, "Active"), h("th", { key: '9a003dee51a41c07c3e0a9331a4cb8e23abb3079', class: 'action-row' }, this.canCreate && (h("ir-icon", { key: '8bcc9afe3acc2fd74519efa618e4d2e470a28b9f', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, h("svg", { key: '194c35ff272f52a637ce1e8ff301bfccb24d058c', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, h("path", { key: 'f29a4e515953d326995b144329866f33a4c8fe4d', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), h("tbody", { key: '9c3bacbbb8cd324413c4cd2171221bf7480b3db1' }, this.users.map(user => {
            var _a;
        ...
        })))), h("ir-sidebar", { key: 'd92f234e327038d019e34b836e10fe22e67265b5', open: this.currentTrigger !== null && ((_c = this.currentTrigger) === null || _c === void 0 ? void 0 : _c.type) !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
            ...
            } }, this.renderCurrentTrigger()), h("ir-modal", { key: '6e867def4bc0694bd2f62dd5893233d239451d69', autoClose: false, modalBody: `Are you sure you want to delete ${(_e = this.user) === null || _e === void 0 ? void 0 : _e.username}?`, rightBtnColor: "danger", isLoading: isRequestPending('/Handle_Exposed_User'), rightBtnText: locales.entries.Lcz_Delete, onConfirmModal: this.removeUser.bind(this), ref: el => (this.modalRef = el) })));
    }
