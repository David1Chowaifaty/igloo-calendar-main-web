...
export class IrUserManagementTable {
    ...
    render() {
        ...
        return (h(Host, { key: 'ab70fbfec6c536e5691724571bbdf2c6a29147ab' }, h("section", { key: '2a10161a25e1b02ba922ad9bff1e67bfe668cddd', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, h("table", { key: 'e6170f478678be7ca9e76fb00d47c5d344ed5133', class: "table" }, h("thead", { key: '33ea5a9e98e1ce20f5e43c886a2795fc2652b2ff' }, h("tr", { key: '909faae69dc823400142bb5d33a2f66b374914e1' }, h("th", { key: '22f75d0708ac8f6bd84915d0516b7447fe96841f', class: "text-left" }, (_a = locales.entries.Lcz_Username) !== null && _a !== void 0 ? _a : 'Username'), h("th", { key: '2237897f53545037c07f18949e19b2f7302256c0', class: "text-left" }, locales.entries.Lcz_Email), h("th", { key: '7966f25b4950b5f8f060c14d329c8b33e2887a98', class: "text-left" }, (_b = locales.entries.Lcz_Mobile) !== null && _b !== void 0 ? _b : 'Mobile'), h("th", { key: '4b2f121282cd15d8575d637c24440d8b08d17ddb', class: "text-left" }, locales.entries.Lcz_Role), h("th", { key: 'b28b875f31aa2fc6ab514667f6c46d5e4a28999f', class: "text-left small", style: { fontWeight: 'bold' } }, h("p", { key: 'b2591a615ce836f345ec9ba32af5d819e26c455b', class: "m-0 p-0 " }, locales.entries.Lcz_CreatedAt), h("p", { key: '077b786486269042ff6585b1ef63f83b5c2273e6', class: "m-0 p-0" }, locales.entries.Lcz_LastSignedIn)), this.haveAdminPrivileges && h("th", { key: '5bc9276f9a43000424ad5418f8d13082f57618d3' }, locales.entries.Lcz_Active), h("th", { key: '95429eeb0964cf0de56c3c4a38814356a7bb91ee', class: 'action-row' }, this.canCreate && (h("ir-icon", { key: '387cb2811453b125399c24498a1b28931eba10b5', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales.entries.Lcz_CreateUser, onIconClickHandler: () => {
                this.verifyAdminAction({
                    type: 'user',
                    mode: 'create',
                    user: null,
                });
            } }, h("svg", { key: '5971fe0e3385f35c01df5c526d188020d9615ea6', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, h("path", { key: '64b907238d54b50ec490cdcfda1696da14a87722', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), h("tbody", { key: 'fcf04b76bbdf09c1b9dfbd888c0f90a110d085ad' }, this.users.map(user => {
            var _a;
        ...
        })))), h("ir-sidebar", { key: '5530017551b42c68e042955561cd97ab7721a5b6', open: this.currentTrigger !== null && ((_c = this.currentTrigger) === null || _c === void 0 ? void 0 : _c.type) !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
            ...
            } }, this.renderCurrentTrigger()), h("ir-modal", { key: 'a57752e9f23d4b420e01566a9a2ad0ef44e2fc44', autoClose: false, modalBody: this.modalType === 'delete'
