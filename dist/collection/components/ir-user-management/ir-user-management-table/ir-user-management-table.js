...
export class IrUserManagementTable {
    ...
    render() {
        return (h(Host, { key: '36e95d2fc8f1f29fc72e31efd0228eb6baff18cc' }, h("section", { key: '310e4749b03bdef9880563100296c74cbbaeb52b', class: "table-container h-100  w-100 m-0 table-responsive" }, h("table", { key: 'f638c677dc6bb7c1ab7ca7ed5f2a14ad7a7b7a80', class: "table" }, h("thead", { key: 'a0dfb4d3211aceec267cf5bf28a65fafedfd5fdd' }, h("tr", { key: '90767f1e0b390b1c91f96d6d75686edc167cc568' }, h("th", { key: '46623ca3f6079be0f4804e29057bf51dd441d876', class: "text-left" }, locales.entries.Lcz_Username ?? 'Username'), h("th", { key: '2a3f40fde037472da589e6d18a471bbb749f9987', class: "text-left" }, locales.entries.Lcz_Email), h("th", { key: '4cec6a01722c5682c3613ec5804e44ca28e0000a', class: "text-left" }, locales.entries.Lcz_Mobile ?? 'Mobile'), h("th", { key: 'eaa3919cc65165843eb12b180aa082f810242fec', class: "text-left" }, locales.entries.Lcz_Role), h("th", { key: 'e6160ac34eb4d64da203a1340393f27d780af1c4', class: "text-left small", style: { fontWeight: 'bold' } }, h("p", { key: '15500e6e0cd0d1a7f3d329200b8f0ebf6b1d58e9', class: "m-0 p-0 " }, locales.entries.Lcz_CreatedAt), h("p", { key: 'bf6820766347dcea89f8956ebb8e95b394f6afb5', class: "m-0 p-0" }, locales.entries.Lcz_LastSignedIn)), this.haveAdminPrivileges && h("th", { key: 'a0d06507572d812c40465a76443b16baf06c773a' }, locales.entries.Lcz_Active), h("th", { key: 'fdfbc7fad5ed8e39762b977a1398a9cf2ad4154f', class: 'action-row' }, this.canCreate && (h(Fragment, { key: '86cc0bcad1192a0c705ee94a3b22b842cc51119f' }, h("ir-custom-button", { key: '5bddcf61db7feaf14a3f96151e94cd9c31d0379b', appearance: "plain", variant: "neutral", id: "new-user-btn", onClickHandler: () => {
                this.verifyAdminAction({
                    type: 'user',
                    mode: 'create',
                    user: null,
                });
            } }, h("wa-icon", { key: '63076c4b2b892a0085f82bee360e79183a46f847', name: "plus", style: { fontSize: '1.2rem' } })), h("wa-tooltip", { key: 'aa485f1e50880307abf36d605782aa1640dd7c8c', for: "new-user-btn" }, locales.entries.Lcz_CreateUser)))))), h("tbody", { key: '7933160f1d5a9c529796d2ca38a3a9fb8f533ab8' }, this.users.map(user => {
        ...
        })))), h("ir-user-form-panel-drawer", { key: '3769e3ce7cbd651ca919124db01bc914dd3b183b', open: this.currentTrigger !== null && this.currentTrigger?.type !== 'delete', property_id: this.property_id, baseUserTypeCode: this.baseUserTypeCode, superAdminId: this.superAdminId, allowedUsersTypes: this.allowedUsersTypes, userTypeCode: this.userTypeCode, haveAdminPrivileges: this.haveAdminPrivileges, onCloseSideBar: () => (this.currentTrigger = null), slot: "sidebar-body", user: this.currentTrigger?.user, isEdit: this.currentTrigger?.isEdit }), h("ir-dialog", { key: 'a0763ded9554c0d150fdc2ad8d7ab48f327f0f82', label: 'Alert', onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.user = null;
                this.modalType = null;
            }, ref: el => (this.dialogRef = el) }, h("span", { key: '6bf30980638cd5f425238b0ffe67656efabd6c15' }, this.modalType === 'delete'
            ? `${locales.entries.Lcz_AreYouSureToDelete} ${this.user?.username}?`
            : `${locales.entries.Lcz_AreYouSureToUnverify} ${this.maskEmail(this.user?.email)}`), h("div", { key: '4db116e8f30b929da420e635b2b2e8b803423584', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '9f0f6c23994041e591bdbc68342667175e7df4e2', "data-dialog": "close", size: "m", appearance: "filled" }, "Cancel"), h("ir-custom-button", { key: '381f026d5597a4aa0003a5c3a7f56be88ab70f8d', size: "m", loading: isRequestPending('/Handle_Exposed_User'), appearance: "accent", variant: this.modalType === 'verify' ? 'brand' : 'danger', onClickHandler: this.executeUserAction.bind(this) }, this.modalType === 'verify' ? locales.entries.Lcz_Confirm : locales.entries.Lcz_Delete)))));
    }
