...
export class IrChannelMapping {
    ...
    render() {
        return (h(Host, { key: '19419b756e921186bec08f4f79c606ffb9ba2b89', class: "py-md-2 px-md-2" }, h("div", { key: '01b2a18b8d7b8aed942a22fc6e6f6a8acd05372c', class: "d-flex p-0 m-0 w-100 justify-content-end" }, h("button", { key: 'd0c1f5be079de4109420433bd818d26e7594b092', onClick: () => {
                setMappedChannel();
            }, class: "btn refresh-btn" }, locales.entries?.Lcz_Refresh)), h("section", { key: '9e1f5a23d6d8491579849b4d05ae7e14a18f98c5', class: "w-100" }, h("div", { key: 'f6d3ce9137091321c1ce993f66f06d48b2c6a209', class: "pt-1 mapped_row" }, h("p", { key: '0227c0d097d103ed6aae8e5dbba38e4de6a2ef7c', class: "mapped_item channel_name" }, channels_data.selectedChannel?.name), h("svg", { key: 'f28f284e67f9a0777095a0e8f2589fdb5ca31405', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: '3922c08524d988e9af6debec6e780b426c3d5b91', d: "M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" })), h("p", { key: '4b0fdf44c051cc7b3edfe24455fefb46688bd791', class: "pl-2 mapped_item channel_name" }, "igloorooms")), h("div", { key: 'c0fa8c8a87629d5fe616f763fd49e8e8f473a93c' }, channels_data.selectedChannel?.property?.room_types?.map(room_type => {
