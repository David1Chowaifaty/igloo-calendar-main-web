...
export class IrChannelMapping {
    ...
    render() {
        return (h(Host, { key: 'e9cd376a7f780af59eb0817a7aa3ab6734533804', class: "py-md-2 px-md-2" }, h("div", { key: '762da566d51b21ad08f803e2ef92cc859cecea39', class: "d-flex p-0 m-0 w-100 justify-content-end" }, h("button", { key: '7f01b5dd22f2dd5ada8ddf638fa69ae8c1def35f', onClick: () => {
                setMappedChannel();
            }, class: "btn refresh-btn" }, locales.entries?.Lcz_Refresh)), h("section", { key: '0acfe6f28f8c29159d657a88a678f3d50f0abba6', class: "w-100" }, h("div", { key: '24e55a05ad2ed28ae6531820ccef3f5eb3e30367', class: "pt-1 mapped_row" }, h("p", { key: 'd7310577d6d1146146baeff9a6d02ac484e9bb31', class: "mapped_item channel_name" }, channels_data.selectedChannel?.name), h("svg", { key: '774cdf324ad8560eba4a823968d5770a32f38a28', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: '93cddf7a98d4e991d22813c2b154634ed7c2a136', d: "M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" })), h("p", { key: 'cb3d054f14fc6fc2b3969a3f762db2418ca8a6a7', class: "pl-2 mapped_item channel_name" }, "igloorooms")), h("div", { key: '804c6bb68ae04789d79804cf1be3bab24a133d11' }, channels_data.selectedChannel?.property?.room_types?.map(room_type => {
