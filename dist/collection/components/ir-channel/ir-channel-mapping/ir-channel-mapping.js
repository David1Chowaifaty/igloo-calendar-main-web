...
export class IrChannelMapping {
    ...
    render() {
        return (h(Host, { key: '1c1d8a2db368ad22f61344d95e353dc723db31ba', class: "py-md-2 px-md-2" }, h("div", { key: 'bc427098147fe9c8a4c4661bc401ce10620e12dd', class: "d-flex p-0 m-0 w-100 justify-content-end" }, h("button", { key: '540848eef203638b04eec4bfe2aaf2ee77e8822b', onClick: () => {
                setMappedChannel();
            }, class: "btn refresh-btn" }, locales.entries?.Lcz_Refresh)), h("section", { key: '8123275e5443dd0df9e128e0b7412b8e5616c5f3', class: "w-100" }, h("div", { key: 'fdad350eb42ed15cad81a198facb12e647625014', class: "pt-1 mapped_row" }, h("p", { key: '3259fec1d619a5bc1c213901e847fcdeacab98e7', class: "mapped_item channel_name" }, channels_data.selectedChannel?.name), h("svg", { key: 'a6beb5c469b87d8250b2e73eb5be6108b4b032de', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: '6fc9b672454e93486000db5efd98882aab476652', d: "M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" })), h("p", { key: '079548d95a51232098f0f30a4ae8600c1847fe72', class: "pl-2 mapped_item channel_name" }, "igloorooms")), h("div", { key: 'de412a6ae93f086bbb2c918e15ddede4987d12f0' }, channels_data.selectedChannel?.property?.room_types?.map(room_type => {
