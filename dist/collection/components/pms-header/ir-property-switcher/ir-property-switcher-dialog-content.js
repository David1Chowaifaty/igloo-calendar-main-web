...
export class IrPropertySwitcherDialogContent {
    ...
    render() {
        return (h(Host, { key: 'd55aac3f6c97ff3acf2d47c132d7e72520636046' }, h("ir-input", { key: 'ff31ab8c629592c2b1374bd3f86eaaf8b67fac80', autofocus: true, ref: el => (this.inputRef = el), placeholder: t('Lcz_PropertyNameOrANumberPlaceholder', { fallback: 'Property name or A number' }), class: "property-switcher__search-input", value: this.searchTerm, "onText-change": this.handleSearchChange, onKeyDown: this.handleKeyDown, withClear: true }), h("div", { key: 'f14b96f7c2f2724979662a06953387407a854959', tabIndex: -1, class: "property-switcher__results" }, !this.searchTerm && this.properties?.length > 0 && (h("div", { key: '3872a05ac63a530239f5dba691008847e59d6a4e' }, h("p", { key: 'd7ffabf1fff6f169b6a33a2cf1140bf06f1cfa57', style: { padding: '1rem', margin: '0', paddingTop: '0' } }, t('Lcz_LinkedProperties', { fallback: 'Linked Properties' })), this.properties.map(property => {
