...
export class IrPropertySwitcherDialogContent {
    ...
    render() {
        return (h(Host, { key: '71536b7a3a4b3fa70c072c8fa4817c56e9877482' }, h("ir-input", { key: '03b54ebd605ca6993732e77cc5efbdf4104a4503', autoFocus: true, ref: el => (this.inputRef = el), placeholder: "Find property", class: "property-switcher__search-input", value: this.searchTerm, "onText-change": this.handleSearchChange, onKeyDown: this.handleKeyDown, withClear: true }), h("div", { key: '103a32e5486eca93610f8cdcd74c209e658bcdc9', tabIndex: -1, class: "property-switcher__results" }, this.isLoading && this.renderStatus('Loading properties...'), !this.isLoading && this.error && this.renderStatus(this.error), !this.isLoading && !this.error && this.filteredProperties.length === 0 && this.renderStatus('No properties found'), !this.isLoading &&
            !this.error &&
