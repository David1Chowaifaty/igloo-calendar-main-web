...
export class IrPropertySwitcherDialogContent {
    ...
    render() {
        return (h(Host, { key: '84e948174260432cb6c77a851c30c4196377e399' }, h("ir-input", { key: '9d7d719c68f3ea3e8d9fef6bcb2a141f7258e56f', autofocus: true, ref: el => (this.inputRef = el), placeholder: "Property name or A number", class: "property-switcher__search-input", value: this.searchTerm, "onText-change": this.handleSearchChange, onKeyDown: this.handleKeyDown, withClear: true }), h("div", { key: '9ce9378f58a8ea28f14a87793f8e45efdc4e1dad', tabIndex: -1, class: "property-switcher__results" }, !this.searchTerm && this.properties?.length > 0 && (h("div", { key: 'd2ee793f7425c4ea9b7fce1677f729235ccb2c88' }, h("p", { key: '38d83c62af84de9e10c3028fe6b54c010cf0ed00', style: { padding: '1rem', margin: '0', paddingTop: '0' } }, "Linked Properties"), this.properties.map(property => {
