...
export class IrPmsSearch {
    ...
    render() {
        return (h(Host, { key: 'a2b11f9a4acd55846a24ab088879d9fd762c124f' }, h("ir-autocomplete", { key: '39f66a2513a399637844087285edb9f3e3befdf4', class: "pms-search__autocomplete", placeholder: "Booking# or guest name", ref: el => (this.autoCompleteRef = el), "onCombobox-change": event => this.handleComboboxSelect(event), "onText-change": event => this.fetchBookings(event), pill: true, appearance: "filled" }, h("wa-icon", { key: '6abb41c21a735358c8676d610e80277251d434e2', name: "magnifying-glass", slot: "start" }), h("div", { key: 'e4c422a04a26b31728a162c5eacaf8db670bc24e', slot: "end", class: "pms-autocomplete__end-slot" }, this.isLoading && h("wa-spinner", { key: '3e94e4a88f605f2ba3ad23ced172f0909541e1a3' }), this.shortcutHint && h("span", { key: 'add135d5c6c93037f994e0e081456864071d1730' }, this.shortcutHint)), (this.bookings ?? [])?.length === 0 && !this.isLoading && (h("div", { key: '257ece2e287bb12133fe40d1716717d41aa161ac', class: "pms-search__empty", role: "status", "aria-live": "polite" }, h("wa-icon", { key: 'a2e5e8b895d58dc6823fc978e3f0f8865d7c2d9f', name: "circle-info", "aria-hidden": "true" }), h("div", { key: '6c6975ca648c450465a643800da9366e5cca1d11', class: "pms-search__empty-content" }, h("div", { key: '876a001890b50ab30657865f404eaf2f5748677d', class: "pms-search__empty-title" }, "No results found")))), (this.bookings ?? [])?.map(b => {
            if (!b) {
                return null;
            }
