...
export class IrBookingListingTable {
    ...
    render() {
        ...
        return (h(Host, { key: '1330cde2e55aaf82b30bca2da6ba9497e64981f1' }, h("div", { key: '7814ddf766386275715c53b64d8ff841600b5435', class: "table--container" }, h("table", { key: '51f684de51522d257bf078c0d492f46475eedd37', class: "table data-table" }, h("thead", { key: '70492306b0211bd569e24b5f5230ef3be011ea05' }, h("tr", { key: '08e4ddd1fba92cdfc358b66db31e3499490cb44e' }, isPrivilegedUser(booking_listing.userSelection.userTypeCode) && h("th", { key: 'dd5e2bb645e0f7d250e927565372eea939a976c4', class: "text-left" }, "Property"), h("th", { key: '1635b00b6b5e7ef9c7005e8a6745d6463d2ba921' }, h("span", { key: '4598701f99b68558b05a5e6e9ff543af4d016fa5', class: 'arrivals-table__departure__cell' }, "Booking#")), h("th", { key: '45dabcf020dc65f9bf2a20a4ddb77dba6bf224f4' }, "Booked on"), h("th", { key: '8a3866d428a610804003f66664e82858dbde1b08' }, h("div", { key: '899c47a102eb6aa67d3e50db5dea0f13b3cf63f9' }, h("p", { key: '2229f738f0f8e0650b4b4b87b5ed334cf563cb8c' }, "Booked by"))), h("th", { key: '564140ed00ce0d8755739e96f71bd513fd0eb60e' }, "Dates"), booking_listing.userSelection?.filter_type === '2' && h("th", { key: 'cedbe6ecadcfaaee845dc3602d8c92a897c357e6' }, "Arrival time"), h("th", { key: '5023d868ea812f127699e51af6e29b2d06af4043' }, "Services"), h("th", { key: 'cf05f27b9b67b19d0f9519fba2e7d75738eb6b19', class: "text-center" }, h("p", { key: 'a5166f0b14b63262b30772132ea7f0348b54ea4a' }, "Amount "), h("wa-tooltip", { key: 'cad54fee58a0df8e51c91f61f7f24ac431044cca', for: "balance-info" }, "Booking balance click to settle."), h("div", { key: 'ac75cbfe3a8e3910bdf058f108175ceabc31d229', style: { width: 'fit-content', marginLeft: 'auto', marginRight: 'auto' } }, h("ir-custom-button", { key: 'aa5fc134a9a0a55db3f2953583945f74f1658643', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "s", variant: "danger", appearance: "outlined" }, "Guest Balance"))), h("th", { key: 'a24fd48439d2a80f6853827cf1bd2e27e3d86846', class: "text-center" }, "Status"), h("th", { key: 'c2624838bc9a26b897e776a86fab57d5d215c9ed' }))), h("tbody", { key: '733f2be4b753f51b1ac34e9531a24f37f8b4775a' }, booking_listing.bookings.length === 0 && (h("tr", { key: '021c9a6a525cf8da762087011df79815de9fab70' }, h("td", { key: '022c2340123ff4e4568b0590dca5b7cc4da27849', colSpan: isPrivilegedUser(booking_listing.userSelection.userTypeCode) ? 9 : 8, class: "empty-row" }, "No bookings found"))), booking_listing.bookings?.map(booking => this.renderRow(booking))))), h("div", { key: 'c49126f9c3e6b24dc0a51d9db7a6118fa6bc56db', class: "card--container" }, booking_listing.bookings.map(booking => {
            ...
            return (h("ir-booking-listing-mobile-card", { key: rowKey, booking: booking, totalPersons: totalPersons, lastManipulation: lastManipulation, extraServicesLabel: locales.entries.Lcz_ExtraServices, onIrBookingCardAction: event => {
        ...
        })), pagination.totalRecords > 0 && (h("ir-pagination", { key: '027ef9f331c87d22a7f03493c35130c255112a29', class: "data-table--pagination", showing: pagination.showing, total: pagination.totalRecords, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales.entries?.Lcz_Bookings ?? 'bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })), canLoadMore && (h("ir-custom-button", { key: 'e90514c8acb299bd9b4889d636e50a034a068e76', class: "booking-listing__load-more", variant: "brand", appearance: "outlined", loading: this.isLoadMoreLoading, disabled: this.isLoadMoreLoading, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.loadMoreBookings();
            } }, "Load more")), h("ir-dialog", { key: 'dbc247b6627bfd9debfe342177b50b1d87914008', label: "Delete", open: !!this.booking_nbr, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.booking_nbr = null;
            }, lightDismiss: false }, h("span", { key: '041a0beaf2eabcaa3fac7533488ef15637d9389e' }, locales.entries.Lcz_SureYouWantToDeleteBookingNbr + this.booking_nbr), h("div", { key: 'b1d200f25e858490108d5d6fd3d406f096711256', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '150f588993b4f961f104db5712ac12ffb852d591', "data-dialog": "close", size: "m", variant: "neutral", appearance: "filled" }, "Cancel"), h("ir-custom-button", { key: 'cfb8f2beebfae9d4a07a0bfafbeb85d7c54c93fb', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.deleteBooking();
