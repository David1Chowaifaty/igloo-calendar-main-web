...
export class IrClFiscalDocumentPreview {
    ...
    render() {
        return (h(Host, { key: '3fa019ca832cc2f50307a451c990b3c59309faeb' }, h("ir-preview-screen-dialog", { key: '42b772b346233a0cfe17d0a8ea5454e0dd14fffe', hideDefaultAction: true, open: this.request !== null, label: this.getDialogLabel(), action: "print", onOpenChanged: e => {
                if (!e.detail)
                    this.request = null;
            } }, h("div", { key: '8cdaab7a0d87d53d7776576f5c42b28255cab05b', slot: "header-actions", class: "header-actions" }, this.request?.fdTypeCode === FdTypes.Draft && (h("ir-custom-button", { key: 'f0a0a0a74636d1f3fc7faec9fed22e578fe46a76', onClickHandler: () => (this.showConvertDialog = true), variant: "brand", appearance: "accent" }, "Convert to invoice")), this.request?.url && (h("ir-custom-button", { key: 'a97eb6b01446fe0f1dd0c3b35ae977dace1f3dce', size: "m", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleDownload() }, h("wa-icon", { key: 'c38ea5319aca6af2587327d5c84a24c23df37b9e', name: "download", style: { fontSize: '1.2rem' }, label: "Download PDF" })))), this.renderPreview()), h("ir-fd-confirm-dialog", { key: '408272815b3582bc67f2f6c20b67d901a1eb75c8', open: this.showConvertDialog, action: "convert-to-invoice", docNumber: this.request?.documentNumber ?? 'this document', isConfirming: this.isConverting, onConfirmed: () => this.handleConvertConfirm(), onCancelled: () => (this.showConvertDialog = false) })));
    }
