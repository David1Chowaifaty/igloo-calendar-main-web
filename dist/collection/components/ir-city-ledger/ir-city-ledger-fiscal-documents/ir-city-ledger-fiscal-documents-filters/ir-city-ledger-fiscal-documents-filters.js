...
export class IrCityLedgerFiscalDocumentsFilters {
    ...
    render() {
        return (h("form", { key: '8455f998fee6ca2cea6f00ecd9ec09dfb0eb077d', onSubmit: e => {
                e.preventDefault();
                this.applyFilters.emit(this.filters);
            } }, h("div", { key: 'fdf4b6f8fc386f4b2d05173f1da86682d34df323', class: "filters-bar" }, h("ir-validator", { key: '22cd195ec2bcaf3d695f7fb3bf7f09a3d0f30224', value: this.filters?.fromDate || this.filters?.toDate, schema: z.string().nonempty(), class: "filters-bar__dates" }, h("ir-date-range-filter", { key: 'dc0378eaf62fe55683ea9e3c3714880f6dd66517', maxDate: today.format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.filters.fromDate, toDate: this.filters.toDate, onDatesChanged: e => this.updateFilters({ fromDate: e.detail.from, toDate: e.detail.to }) })), h("div", { key: '90de9b60e106e1dd998bb8eb2da4557dcf920914', class: "filters-bar__search-group" }, h("div", { key: '16228932414105222b4d0716d0d50f41b5c75c57', class: "filters-bar__type-group" }, h("wa-select", { key: '8b85d3fa20e4c605ba44f451e265771f4bfec681', class: "filters-bar__status-select", value: this.filters.type, defaultValue: this.filters.type, onchange: e => this.updateFilters({ type: e.target.value }), size: "s", placeholder: "Document Type" }, this.typeOptions.map(option => (h("wa-option", { value: option.value, key: option.value }, option.label)))), h("wa-switch", { key: 'c643fe40461aad6815617f5ec0b0dae14c33b370', class: "filters-bar__tax-switch", checked: this.filters.taxableOnly, onchange: e => this.updateFilters({ taxableOnly: e.target.checked }) }, "Taxes"), h("wa-switch", { key: '03489e9c29e49022b1a1734a33aefde6fe643fbe', class: "filters-bar__proforma-switch", checked: this.filters.proformaOnly, onchange: e => {
                const updated = { ...this.filters, proformaOnly: e.target.checked };
                this.filtersChange.emit(updated);
                this.applyFilters.emit(updated);
            } }, "Proforma")), h("ir-input", { key: 'ad2402c9ed0e6b059cfb1ceeca03ff434c8a94af', class: "filters-bar__search-input", placeholder: "Search by doc number", value: this.docNumber, "onText-change": e => {
                this.docNumber = e.detail;
                this.emitSearchDebounced(e.detail);
            }, withClear: true }, h("wa-icon", { key: '367010905b5c149266f50d6c749616e2ded475f6', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), h("ir-custom-button", { key: '3148536408a852da85baf22efdd4e23e1e94a80d', variant: "neutral", appearance: "outlined", type: "submit" }, h("wa-icon", { key: '19d62db99c18f31997f5750ed144a007017ad24e', name: "magnifying-glass" }))))));
    }
