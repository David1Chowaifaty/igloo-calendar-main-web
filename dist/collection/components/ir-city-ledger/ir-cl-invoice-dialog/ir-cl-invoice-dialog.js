...
export class IrClInvoiceDialog {
    ...
    render() {
        ...
        return (h(Host, { key: '3f9a6700b4a8da1709678c9c8e4ec63eb113b9c5' }, h("ir-dialog", { key: '1f86f953ff457479dafee71ae0a14e9469bb9cab', label: "Create Invoice", ref: el => (this.dialogRef = el) }, this.booking && (h("div", { key: 'fe68568339db15314083043a1776e16bdacf1871', slot: "header-actions", class: 'cl-invoice-dialog__header-actions' }, h("wa-switch", { key: 'e65b119f6750bca201faf8ed6c842fed762a7122', checked: this.isProforma, disabled: this.mode === 'booking' && !this.allRoomsCheckedOut, onchange: e => (this.isProforma = e.target.checked) }, "Proforma"))), h("div", { key: 'a9c3eab370f73e4d8a7e017bc1818dede340472f', class: "create-invoice-dialog__body" }, this.mode === 'booking' ? (!this.allRoomsCheckedOut ? (h("wa-callout", { size: "s", variant: "warning" }, h("wa-icon", { slot: "icon", name: "triangle-exclamation" }), "Only a proforma invoice can be generated at this time because ", units?.length > 1 ? 'units' : 'unit', " ", h("b", null, units?.join(', ')), ".", ' ', units?.length > 1 ? 'are' : 'is', " still in-house.")) : (h("p", { class: "create-invoice-dialog__message" }, this.isProforma
            ? `Generate a proforma for Booking #${this.booking?.booking_nbr}?`
            : `Issue a draft invoice for Booking #${this.booking?.booking_nbr} to the agent?`))) : (h("ir-cl-invoice-form", { ref: el => (this.formRef = el) })), this.noResults && (h("wa-callout", { key: 'f44b31b5cda70ffe0a0b6d52cd99fd503b0195f3', variant: "warning", class: "create-invoice-dialog__no-results" }, h("wa-icon", { key: '1462f09989ecb42699bbee3dee52677a97671a71', slot: "icon", name: "triangle-exclamation" }), "No transactions found for the selected period and filters.")), this.error && h("p", { key: '2e5d6347748a20f192139841193fad1fa6272fdc', class: "create-invoice-dialog__error" }, this.error)), h("div", { key: '0b11925b34a1cb781f3f56134e564d618b1fef77', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '1545106a107f9fe8e1543c4f81c2447dc726faf4', size: "m", appearance: "filled", variant: "neutral", "data-dialog": "close", disabled: this.isLoading }, "Cancel"), h("ir-custom-button", { key: 'f487472f1883a1178e78bd92137cc0c317cb6e37', size: "m", appearance: "accent", variant: "brand", loading: this.isLoading, onClickHandler: () => this.handleSubmit() }, this.isProforma ? 'Confirm' : 'Show draft')))));
    }
