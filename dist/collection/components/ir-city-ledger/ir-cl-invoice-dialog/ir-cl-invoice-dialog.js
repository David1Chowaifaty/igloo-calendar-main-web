...
export class IrClInvoiceDialog {
    ...
    render() {
        ...
        return (h(Host, { key: '1da319129208d6092a535c257903892d66e0d4e2' }, h("ir-dialog", { key: 'a79237dcb42dc8718e67ecac2971742b56983aa4', label: "Create Invoice", ref: el => (this.dialogRef = el) }, this.booking && (h("div", { key: '1104eaf6e0160f28d3679cb5edb468dbe3686bc2', slot: "header-actions", class: 'cl-invoice-dialog__header-actions' }, h("wa-switch", { key: '88056bc60d250a0bb86573857029c4c5c0b88d6d', checked: this.isProforma, disabled: this.mode === 'booking' && !this.allRoomsCheckedOut, onchange: e => (this.isProforma = e.target.checked) }, "Proforma"))), h("div", { key: '3237e8fa468f335b9f1d5b47c455c02d665bc61b', class: "create-invoice-dialog__body" }, this.mode === 'booking' ? (!this.allRoomsCheckedOut ? (h("wa-callout", { size: "s", variant: "warning" }, h("wa-icon", { slot: "icon", name: "triangle-exclamation" }), "Only a proforma invoice can be generated at this time because ", units?.length > 1 ? 'units' : 'unit', " ", h("b", null, units?.join(', ')), ".", ' ', units?.length > 1 ? 'are' : 'is', " still in-house.")) : (h("p", { class: "create-invoice-dialog__message" }, this.isProforma
            ? `Generate a proforma for Booking #${this.booking?.booking_nbr}?`
            : `Issue a draft invoice for Booking #${this.booking?.booking_nbr} to the agent?`))) : (h("ir-cl-invoice-form", { ref: el => (this.formRef = el) })), this.noResults && (h("wa-callout", { key: 'f2c032e0e8502a25567d2913099d970721a08895', variant: "warning", class: "create-invoice-dialog__no-results" }, h("wa-icon", { key: '01b074dd82e5f717fcfa9620e31aa329d18c33d5', slot: "icon", name: "triangle-exclamation" }), "No transactions found for the selected period and filters.")), this.error && h("p", { key: 'cb0d536a90190d457298b5fbf7d29e0bda32f7fc', class: "create-invoice-dialog__error" }, this.error)), h("div", { key: 'c2038c0e639926def60ad2d66a72b9ca95123a9d', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: 'b294901cfcb4e0b45f3b9f114aa6f1c62b92723c', size: "m", appearance: "filled", variant: "neutral", "data-dialog": "close", disabled: this.isLoading }, "Cancel"), h("ir-custom-button", { key: '460ab2a4006413b3c4e9e890639f44eb26790ae4', size: "m", appearance: "accent", variant: "brand", loading: this.isLoading, onClickHandler: () => this.handleSubmit() }, this.isProforma ? 'Confirm' : 'Show draft')))));
    }
