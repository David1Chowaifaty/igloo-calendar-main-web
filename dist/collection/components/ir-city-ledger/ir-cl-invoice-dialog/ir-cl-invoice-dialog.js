...
export class IrClInvoiceDialog {
    ...
    render() {
        return (h(Host, { key: '04b5e8e9be2e20e90ad95804f0d6f429e8515525' }, h("ir-dialog", { key: 'c31f75f6242bde5b9bafaf60529af70138cc7e4e', label: "Create Invoice", ref: el => (this.dialogRef = el) }, this.bookingNbr && (h("div", { key: '70433d3393094499478afef6991e3f83fc5ec3ab', slot: "header-actions", class: 'cl-invoice-dialog__header-actions' }, h("wa-switch", { key: 'd48c9ae2531d1cc33c8518494d292f841928dd9f', checked: this.isProforma, disabled: this.mode === 'booking' && !this.allRoomsCheckedOut, onchange: e => (this.isProforma = e.target.checked) }, "Proforma"))), h("div", { key: 'd0b54a72cfaae8630f63322836ec573c72586234', class: "create-invoice-dialog__body" }, this.mode === 'booking' ? (h("p", { class: "create-invoice-dialog__message" }, this.isProforma ? `Generate a proforma for Booking #${this.bookingNbr}?` : `Issue a draft invoice for Booking #${this.bookingNbr} to the agent?`)) : (h("ir-cl-invoice-form", { ref: el => (this.formRef = el) })), this.noResults && (h("wa-callout", { key: '734027ec67eeca9c18fc011d329f4fd3f7f4db9b', variant: "warning", class: "create-invoice-dialog__no-results" }, h("wa-icon", { key: '8ab5487645819cabb4f9cac9ed39365d5ff74670', slot: "icon", name: "triangle-exclamation" }), "No transactions found for the selected period and filters.")), this.error && h("p", { key: '2540e036f0c034dd7a348d346ffeb0c4be26649f', class: "create-invoice-dialog__error" }, this.error)), h("div", { key: 'c77b70d86faa2aa5d815ddcae4ecfdba7a52ca22', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: 'ff5a0d46b045fe94a7ddc59a5ef7304ffea54374', size: "m", appearance: "filled", variant: "neutral", "data-dialog": "close", disabled: this.isLoading }, "Cancel"), h("ir-custom-button", { key: '6c85f053a92338d84c5cf096af0b21e8654aae29', size: "m", appearance: "accent", variant: "brand", loading: this.isLoading, onClickHandler: () => this.handleSubmit() }, this.isProforma ? 'Confirm' : 'Show draft')))));
    }
