...
export class IrClInvoiceDialog {
    ...
    render() {
        ...
        return (h(Host, { key: 'ac54aa5138d02862f539a6b822f70008c96b8254' }, h("ir-dialog", { key: '60229e357fb7d142514bf930f8746954eaa5f41d', label: "Create Invoice", ref: el => (this.dialogRef = el) }, this.booking && (h("div", { key: '77a35dfeea1c9419bfd1352aaa8bffc6846466b7', slot: "header-actions", class: 'cl-invoice-dialog__header-actions' }, h("wa-switch", { key: '9021395bc0c1b377f7095c1e66ec7b71108540ea', checked: this.isProforma, disabled: this.mode === 'booking' && !this.allRoomsCheckedOut, onchange: e => (this.isProforma = e.target.checked) }, "Proforma"))), h("div", { key: '28c7d10e604152ac4b5cc67493564b0a549d9145', class: "create-invoice-dialog__body" }, this.mode === 'booking' ? (!this.allRoomsCheckedOut ? (h("wa-callout", { size: "s", variant: "warning" }, h("wa-icon", { slot: "icon", name: "triangle-exclamation" }), "Only a proforma invoice can be generated at this time because ", units?.length > 1 ? 'units' : 'unit', " ", h("b", null, units?.join(', ')), ".", ' ', units?.length > 1 ? 'are' : 'is', " still in-house.")) : (h("p", { class: "create-invoice-dialog__message" }, this.isProforma
            ? `Generate a proforma for Booking #${this.booking?.booking_nbr}?`
            : `Issue a draft invoice for Booking #${this.booking?.booking_nbr} to the agent?`))) : (h("ir-cl-invoice-form", { ref: el => (this.formRef = el) })), this.noResults && (h("wa-callout", { key: 'd89b5e68109411e9a12fec543ebff616d1dd7d02', variant: "warning", class: "create-invoice-dialog__no-results" }, h("wa-icon", { key: 'ea2453b371a6080d972c9308fcd8a1134d4c7673', slot: "icon", name: "triangle-exclamation" }), "No transactions found for the selected period and filters.")), this.error && h("p", { key: '5be0e1d1e32eda52ac143cce8318954a04ebe58c', class: "create-invoice-dialog__error" }, this.error)), h("div", { key: '2d4499215bc799d1b8ce406e0cf2839a0cf60627', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '19c0383a621fce21c6c2db714e4f263fc0fbafa4', size: "m", appearance: "filled", variant: "neutral", "data-dialog": "close", disabled: this.isLoading }, "Cancel"), h("ir-custom-button", { key: '48e0bf0495845f6c78476f2ddd4e8bb999564391', size: "m", appearance: "accent", variant: "brand", loading: this.isLoading, onClickHandler: () => this.handleSubmit() }, this.isProforma ? 'Confirm' : 'Show draft')))));
    }
