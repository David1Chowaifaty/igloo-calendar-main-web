...
export class IrClInvoiceDialog {
    ...
    render() {
        ...
        return (h(Host, { key: 'aea9f71a666d7c712b3a91b4b8515042e61906e8' }, h("ir-dialog", { key: '5f4894455bfda11af930d585637e11c0b3336975', label: "Create Invoice", ref: el => (this.dialogRef = el) }, this.booking && (h("div", { key: '703844d031e3fec56edfda652f9fd0e7155bedc6', slot: "header-actions", class: 'cl-invoice-dialog__header-actions' }, h("wa-switch", { key: '4a18f721240400888e058c40a04a574651214bdb', checked: this.isProforma, disabled: this.mode === 'booking' && !this.allRoomsCheckedOut, onchange: e => (this.isProforma = e.target.checked) }, "Proforma"))), h("div", { key: '31c39768e7f7bc151890d46afe9fe5093130a0ad', class: "create-invoice-dialog__body" }, this.mode === 'booking' ? (!this.allRoomsCheckedOut ? (h("wa-callout", { size: "s", variant: "warning" }, h("wa-icon", { slot: "icon", name: "triangle-exclamation" }), "Only a proforma invoice can be generated at this time because ", units?.length > 1 ? 'units' : 'unit', " ", h("b", null, units?.join(', ')), ".", ' ', units?.length > 1 ? 'are' : 'is', " still in-house.")) : (h("p", { class: "create-invoice-dialog__message" }, this.isProforma
            ? `Generate a proforma for Booking #${this.booking?.booking_nbr}?`
            : `Issue a draft invoice for Booking #${this.booking?.booking_nbr} to the agent?`))) : (h("ir-cl-invoice-form", { ref: el => (this.formRef = el) })), this.noResults && (h("wa-callout", { key: '7d5245e89b3df5a7a7b9da1cce0a26e8c518cd3f', variant: "warning", class: "create-invoice-dialog__no-results" }, h("wa-icon", { key: '905552accfa8a308a6b160bfda6f438e4c9bbb50', slot: "icon", name: "triangle-exclamation" }), "No transactions found for the selected period and filters.")), this.error && h("p", { key: 'c7cce4899c1945106c1e56e9e61250fad2b284e0', class: "create-invoice-dialog__error" }, this.error)), h("div", { key: '4a2802203e0335d5710ca8d7f1aac002ae0d3364', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '2a30decf997f11326a0fab955eee718780bc811d', size: "m", appearance: "filled", variant: "neutral", "data-dialog": "close", disabled: this.isLoading }, "Cancel"), h("ir-custom-button", { key: '3f169c430032dc7513c4de4610a3b38c032c622c', size: "m", appearance: "accent", variant: "brand", loading: this.isLoading, onClickHandler: () => this.handleSubmit() }, this.isProforma ? 'Confirm' : 'Show draft')))));
    }
