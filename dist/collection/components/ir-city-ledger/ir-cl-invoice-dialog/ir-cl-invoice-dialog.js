...
export class IrClInvoiceDialog {
    ...
    render() {
        ...
        return (h(Host, { key: '91bce29fb3ca76aa37b0cc8c80c2c82795c90fd6' }, h("ir-dialog", { key: '015abbaac319d667f26c5e5cbf5e1a54ca168126', label: "Create Invoice", ref: el => (this.dialogRef = el) }, this.booking && (h("div", { key: 'cc871f6639ab02e2587bd5a923c306f1a82361b9', slot: "header-actions", class: 'cl-invoice-dialog__header-actions' }, h("wa-switch", { key: 'd93ef235a4c70b99322d2c1db8320209f4f0331b', checked: this.isProforma, disabled: this.mode === 'booking' && !this.allRoomsCheckedOut, onchange: e => (this.isProforma = e.target.checked) }, "Proforma"))), h("div", { key: '0b999d6b4418f9fc953af9e46a226832d168d9b9', class: "create-invoice-dialog__body" }, this.mode === 'booking' ? (!this.allRoomsCheckedOut ? (h("wa-callout", { size: "s", variant: "warning" }, h("wa-icon", { slot: "icon", name: "triangle-exclamation" }), "Only a proforma invoice can be generated at this time because ", units?.length > 1 ? 'units' : 'unit', " ", h("b", null, units?.join(', ')), ".", ' ', units?.length > 1 ? 'are' : 'is', " still in-house.")) : (h("p", { class: "create-invoice-dialog__message" }, this.isProforma
            ? `Generate a proforma for Booking #${this.booking?.booking_nbr}?`
            : `Issue a draft invoice for Booking #${this.booking?.booking_nbr} to the agent?`))) : (h("ir-cl-invoice-form", { ref: el => (this.formRef = el) })), this.noResults && (h("wa-callout", { key: 'dd999ed38e0fb9e40333f38138dbf7473101ef53', variant: "warning", class: "create-invoice-dialog__no-results" }, h("wa-icon", { key: '99a2f2424f9f6dcd9bc74a2b525ce96359a6d060', slot: "icon", name: "triangle-exclamation" }), "No transactions found for the selected period and filters.")), this.error && h("p", { key: 'fa2235276b6afaa91580e70bff34c13a718af7a9', class: "create-invoice-dialog__error" }, this.error)), h("div", { key: '6d27a234160f2b1cce62d109f35d8485210e8115', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '6a48c455a4a6581e45b82a8d6845d3ea64dabf6c', size: "m", appearance: "filled", variant: "neutral", "data-dialog": "close", disabled: this.isLoading }, "Cancel"), h("ir-custom-button", { key: 'ba25bcaf33859e1cd855868707ce8e67c9171785', size: "m", appearance: "accent", variant: "brand", loading: this.isLoading, onClickHandler: () => this.handleSubmit() }, this.isProforma ? 'Confirm' : 'Show draft')))));
    }
