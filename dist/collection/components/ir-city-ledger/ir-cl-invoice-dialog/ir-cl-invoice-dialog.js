...
export class IrClInvoiceDialog {
    ...
    render() {
        ...
        return (h(Host, { key: 'b59eab043847a62e24f88491b763a89f787ea30b' }, h("ir-dialog", { key: '02e17926286b51976ac831614c2294924284a156', label: "Create Invoice", ref: el => (this.dialogRef = el) }, this.booking && (h("div", { key: '5d7d3f52978eb9d499913a7daa9b2a1bc0b0c32a', slot: "header-actions", class: 'cl-invoice-dialog__header-actions' }, h("wa-switch", { key: '6c9d330875ac3ff7b368834ba65e13440b9246cc', checked: this.isProforma, disabled: this.mode === 'booking' && !this.allRoomsCheckedOut, onchange: e => (this.isProforma = e.target.checked) }, "Proforma"))), h("div", { key: 'a58377b15c79d19d8c47b215ee847ee7be3eeac8', class: "create-invoice-dialog__body" }, this.mode === 'booking' ? (!this.allRoomsCheckedOut ? (h("wa-callout", { size: "s", variant: "warning" }, h("wa-icon", { slot: "icon", name: "triangle-exclamation" }), "Only a proforma invoice can be generated at this time because ", units?.length > 1 ? 'units' : 'unit', " ", h("b", null, units?.join(', ')), ".", ' ', units?.length > 1 ? 'are' : 'is', " still in-house.")) : (h("p", { class: "create-invoice-dialog__message" }, this.isProforma
            ? `Generate a proforma for Booking #${this.booking?.booking_nbr}?`
            : `Issue a draft invoice for Booking #${this.booking?.booking_nbr} to the agent?`))) : (h("ir-cl-invoice-form", { ref: el => (this.formRef = el) })), this.noResults && (h("wa-callout", { key: '5573c1c23965fcab43d4bc307c93d60e70180579', variant: "warning", class: "create-invoice-dialog__no-results" }, h("wa-icon", { key: 'a0f90ad303124907e36ee201d51c85ecb562aac8', slot: "icon", name: "triangle-exclamation" }), "No transactions found for the selected period and filters.")), this.error && h("p", { key: 'eaddf4c68e63ad1138933b80143808258af83c4d', class: "create-invoice-dialog__error" }, this.error)), h("div", { key: '7501dd53bc340e563eebd46866748d468b67c1a6', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '1663a2c6c8b6a040f3a6b4b98e0c75908a3e692a', size: "m", appearance: "filled", variant: "neutral", "data-dialog": "close", disabled: this.isLoading }, "Cancel"), h("ir-custom-button", { key: '9333b21798873bbadc4840a9f684b6f247eeb64c', size: "m", appearance: "accent", variant: "brand", loading: this.isLoading, onClickHandler: () => this.handleSubmit() }, this.isProforma ? 'Confirm' : 'Show draft')))));
    }
