...
export class IrClInvoiceDialog {
    ...
    render() {
        return (h(Host, { key: 'e3150f52ae3137e2da3c2c5de7d3386c48387c90' }, h("ir-dialog", { key: 'e2b07cdda974af0cd5f0187c55e5b773c159560c', label: "Create Invoice", ref: el => (this.dialogRef = el) }, this.bookingNbr && (h("div", { key: '76c2c1561a15bfb35b92dd20c76e5461f49aad17', slot: "header-actions", class: 'cl-invoice-dialog__header-actions' }, h("wa-switch", { key: '8367c052914596e28a4346723d93661ca1715770', checked: this.isProforma, disabled: this.mode === 'booking' && !this.allRoomsCheckedOut, onchange: e => (this.isProforma = e.target.checked) }, "Proforma"))), h("div", { key: 'b8d18b9cbc471e2bb6334db6d14f004cbe789c94', class: "create-invoice-dialog__body" }, this.mode === 'booking' ? (h("p", { class: "create-invoice-dialog__message" }, this.isProforma ? `Generate a proforma for Booking #${this.bookingNbr}?` : `Issue a draft invoice for Booking #${this.bookingNbr} to the agent?`)) : (h("ir-cl-invoice-form", { ref: el => (this.formRef = el) })), this.noResults && (h("wa-callout", { key: 'fb70f4c9839aeb1d8d764980d16ecc115dd182b4', variant: "warning", class: "create-invoice-dialog__no-results" }, h("wa-icon", { key: 'f51fbc70a96a43ffcc1a61aa0f251fb79c651309', slot: "icon", name: "triangle-exclamation" }), "No transactions found for the selected period and filters.")), this.error && h("p", { key: '94f73721050afb29102116caefcadaddeff967ae', class: "create-invoice-dialog__error" }, this.error)), h("div", { key: '0bf3b9cd292605ea7855f09d9a568e68e2358b31', slot: "footer", class: "create-invoice-dialog__footer" }, h("ir-custom-button", { key: 'ed690602681662c60a91692af127b6753ad4296a', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close", disabled: this.isLoading }, "Cancel"), h("ir-custom-button", { key: '0412681a3eafd14c3c21f7ce270fbf4b90d9665c', size: "medium", appearance: "accent", variant: "brand", loading: this.isLoading, onClickHandler: () => this.handleSubmit() }, this.isProforma ? 'Confirm' : 'Show draft')))));
    }
