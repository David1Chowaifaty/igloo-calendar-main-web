...
export class IrClInvoiceDialog {
    ...
    render() {
        return (h(Host, { key: 'a20e18155f706914d51077bd887df695c7d5b949' }, h("ir-dialog", { key: 'c71af3138169f63c6fe97a36d9181924ade5496f', label: "Create Invoice", ref: el => (this.dialogRef = el) }, this.bookingNbr && (h("div", { key: '67ea15eca3d408d9dbdf136e4d6d73568146fb49', slot: "header-actions", class: 'cl-invoice-dialog__header-actions' }, h("wa-switch", { key: 'b0f58309661685717d05d58524c31e31c93d82c1', checked: this.isProforma, disabled: this.mode === 'booking' && !this.allRoomsCheckedOut, onchange: e => (this.isProforma = e.target.checked) }, "Proforma"))), h("div", { key: 'fa21d4917935d2730de8cf5c82c266457069c8e8', class: "create-invoice-dialog__body" }, this.mode === 'booking' ? (h("p", { class: "create-invoice-dialog__message" }, this.isProforma ? `Generate a proforma for Booking #${this.bookingNbr}?` : `Issue a draft invoice for Booking #${this.bookingNbr} to the agent?`)) : (h("ir-cl-invoice-form", { ref: el => (this.formRef = el) })), this.noResults && (h("wa-callout", { key: '626046efd0c5d17251d00d3e34edc4d1b5713094', variant: "warning", class: "create-invoice-dialog__no-results" }, h("wa-icon", { key: '062bedfcfeb9bd7da01ef82b700f12fa26cdf9b3', slot: "icon", name: "triangle-exclamation" }), "No transactions found for the selected period and filters.")), this.error && h("p", { key: '1df38ee12113d678fb91b698db4bd957dc0f4c30', class: "create-invoice-dialog__error" }, this.error)), h("div", { key: '34ea2e95b613c1ab775ad25d843045e34ddd34e9', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: 'd1445a61acb2db5e7f3c76e967d0e1cbed551979', size: "m", appearance: "filled", variant: "neutral", "data-dialog": "close", disabled: this.isLoading }, "Cancel"), h("ir-custom-button", { key: 'a4b427461af9a9f5650280968e93e09243111a70', size: "m", appearance: "accent", variant: "brand", loading: this.isLoading, onClickHandler: () => this.handleSubmit() }, this.isProforma ? 'Confirm' : 'Show draft')))));
    }
