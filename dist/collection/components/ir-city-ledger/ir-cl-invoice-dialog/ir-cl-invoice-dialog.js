...
export class IrClInvoiceDialog {
    ...
    render() {
        ...
        return (h(Host, { key: '360a0660e664dfc5cc235167897efbe50ae75b2d' }, h("ir-dialog", { key: '19e3c89eaa91f458b4f5d6745375ca93f1faeaac', label: "Create Invoice", ref: el => (this.dialogRef = el) }, this.booking && (h("div", { key: 'a9fb01d52f5eb01a39cb567968b610440bfb4022', slot: "header-actions", class: 'cl-invoice-dialog__header-actions' }, h("wa-switch", { key: 'f0fe109711efb1567ee80a745de3a5aa2314461c', checked: this.isProforma, disabled: this.mode === 'booking' && !this.allRoomsCheckedOut, onchange: e => (this.isProforma = e.target.checked) }, "Proforma"))), h("div", { key: '43fc86946214e9d8bda362d4181c3fd0f39ff77c', class: "create-invoice-dialog__body" }, this.mode === 'booking' ? (!this.allRoomsCheckedOut ? (h("wa-callout", { size: "s", variant: "warning" }, h("wa-icon", { slot: "icon", name: "triangle-exclamation" }), "Only a proforma invoice can be generated at this time because ", units?.length > 1 ? 'units' : 'unit', " ", h("b", null, units?.join(', ')), ".", ' ', units?.length > 1 ? 'are' : 'is', " still in-house.")) : (h("p", { class: "create-invoice-dialog__message" }, this.isProforma
            ? `Generate a proforma for Booking #${this.booking?.booking_nbr}?`
            : `Issue a draft invoice for Booking #${this.booking?.booking_nbr} to the agent?`))) : (h("ir-cl-invoice-form", { ref: el => (this.formRef = el) })), this.noResults && (h("wa-callout", { key: 'bf1c6b3c62e328d91ede63f29606ada5e4cbaf1c', variant: "warning", class: "create-invoice-dialog__no-results" }, h("wa-icon", { key: 'cf30744c7aa93d931ac1087cf2dfcfad6e80783f', slot: "icon", name: "triangle-exclamation" }), "No transactions found for the selected period and filters.")), this.error && h("p", { key: '263342dc7663a7a042c5f48865e989aff3538ceb', class: "create-invoice-dialog__error" }, this.error)), h("div", { key: '0ccc60ceedd92401641febecfa6d2a02d133d9fb', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '691f3446f0e89491c5dcc225dfbbb5c331e70312', size: "m", appearance: "filled", variant: "neutral", "data-dialog": "close", disabled: this.isLoading }, "Cancel"), h("ir-custom-button", { key: '0b1f1f6227b2240093c9b576fa54971ee69c1e48', size: "m", appearance: "accent", variant: "brand", loading: this.isLoading, onClickHandler: () => this.handleSubmit() }, this.isProforma ? 'Confirm' : 'Show draft')))));
    }
