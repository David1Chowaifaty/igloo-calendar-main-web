...
export class IrHoldTransactionDialog {
    ...
    render() {
        ...
        return (h(Host, { key: '7c36ed29e5f4a977bf60d1853b5d37bfec9f9f48' }, h("ir-dialog", { key: '1974251ab10f93b4c601756590b2706c20deb497', label: isHeld ? 'Revert Transaction' : 'Hold Transaction', ref: el => (this.dialogRef = el) }, h("div", { key: 'acb86c87d9cd1e85bc788b3ac36bb62bf44790f7', class: "hold-dialog__body" }, isHeld ? (h("p", null, "Revert this transaction back to ", h("strong", null, "Unbilled"), " status? It will re-enter the billing queue.")) : (h("p", null, "Place this transaction on ", h("strong", null, "Hold"), "? It will be excluded from invoicing until released."))), h("div", { key: '9933a17a7286aacae3301bd3469d883acdd3fd75', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '92ab43d4663f1931cac24b72c7b303a899784984', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), h("ir-custom-button", { key: 'cd3670e57bac86cef6b170c2f89eb958cd92045c', size: "medium", loading: this.isLoading, onClickHandler: () => this.handleConfirm(), appearance: "accent", variant: "brand" }, "Confirm")))));
    }
