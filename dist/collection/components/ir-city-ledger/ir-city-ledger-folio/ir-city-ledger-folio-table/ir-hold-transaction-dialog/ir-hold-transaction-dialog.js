...
export class IrHoldTransactionDialog {
    ...
    render() {
        ...
        return (h(Host, { key: '97682712d5b8800bae1c3ac98415bd0d3954aaed' }, h("ir-dialog", { key: 'edfd7c28761d942c89ab11b937a7b82a71f4aef4', label: isHeld ? 'Revert Transaction' : 'Hold Transaction', ref: el => (this.dialogRef = el) }, h("div", { key: '236e10d4cae32d7dd5b1a50acc3442d3675464a7', class: "hold-dialog__body" }, isHeld ? (h("p", null, "Revert this transaction back to ", h("strong", null, "Unbilled"), " status? It will re-enter the billing queue.")) : (h("p", null, "Place this transaction on ", h("strong", null, "Hold"), "? It will be excluded from invoicing until released."))), h("div", { key: 'c354e438ec3baad909cca53407186d1732d6c8c7', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '03c5a66d53fba0f4ab820d47222ef4fb4fbb5523', size: "m", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), h("ir-custom-button", { key: 'e4b4f3fe8ba1f5bab3a60cde6f0b319ac1ca53be', size: "m", loading: this.isLoading, onClickHandler: () => this.handleConfirm(), appearance: "accent", variant: "brand" }, "Confirm")))));
    }
