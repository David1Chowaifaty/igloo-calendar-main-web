...
export class IrHoldTransactionDialog {
    ...
    render() {
        ...
        return (h(Host, { key: '3d5f3fbf30282bb4cb61c0d0140a4c27b19c0fbc' }, h("ir-dialog", { key: '474e3e4e967f957d3af5bd2fcd2239573f235cd4', label: isHeld ? 'Revert Transaction' : 'Hold Transaction', ref: el => (this.dialogRef = el) }, h("div", { key: '99f9fb2de655b4d8979db184236bf104694faf94', class: "hold-dialog__body" }, isHeld ? (h("p", null, "Revert this transaction back to ", h("strong", null, "Unbilled"), " status? It will re-enter the billing queue.")) : (h("p", null, "Place this transaction on ", h("strong", null, "Hold"), "? It will be excluded from invoicing until released."))), h("div", { key: '6337606b29a2e748400ed0443c3eddd28d5b2ac0', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '856532fbda0266dd99cbd93e9753dca95b645178', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), h("ir-custom-button", { key: 'f32e6ec7d3380020fde3a48e920340fbfdf0fdb5', size: "medium", loading: this.isLoading, onClickHandler: () => this.handleConfirm(), appearance: "accent", variant: "brand" }, "Confirm")))));
    }
