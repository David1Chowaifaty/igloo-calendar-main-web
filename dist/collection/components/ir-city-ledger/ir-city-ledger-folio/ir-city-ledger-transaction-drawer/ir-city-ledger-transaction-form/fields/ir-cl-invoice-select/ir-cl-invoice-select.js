...
export class IrClInvoiceSelect {
    ...
    invoiceChange;
    render() {
        return (h("ir-validator", { key: '436fcfbe2254ab219d41cdf8e7be7cda8bf9c754', schema: invoiceIdRequiredFieldSchema, value: this.value, valueEvent: "change" }, h("wa-select", { key: '90cc282a05f9ddb5e011cd7131b78e1835005083', label: this.label, size: "s", required: true, hint: this.hint || undefined, placeholder: "Select invoice", value: this.value, onchange: event => {
