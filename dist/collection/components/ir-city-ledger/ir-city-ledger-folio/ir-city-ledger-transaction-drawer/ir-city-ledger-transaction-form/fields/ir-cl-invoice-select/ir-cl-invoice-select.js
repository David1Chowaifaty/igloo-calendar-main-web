...
export class IrClInvoiceSelect {
    ...
    invoiceChange;
    render() {
        return (h("ir-validator", { key: 'a56cb34292af2b91736cd337d3ff3950c2acf157', schema: invoiceIdRequiredFieldSchema, value: this.value, valueEvent: "change" }, h("wa-select", { key: '1e77969c8200693f7a06376e5cccbdf75b3d352c', label: this.label, size: "s", required: true, hint: this.hint || undefined, placeholder: "Select invoice", value: this.value, onchange: event => {
