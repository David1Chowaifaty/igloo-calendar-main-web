...
export class IrOtp {
    ...
    render() {
        return (h(Host, { key: '701cd8eb797c166149566477228ec6132286a881', class: "otp-input-container" }, h("div", { key: 'f308098dabc83fb458522bdf1ca86f4e8bd1e1d8', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
