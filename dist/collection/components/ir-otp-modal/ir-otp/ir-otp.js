...
export class IrOtp {
    ...
    render() {
        return (h(Host, { key: '36f93eea3f69d46bd94fa5b7a3e7b522326b0688', class: "otp-input-container" }, h("div", { key: '290beee5a87ef2a6657461f5e55e9909456381d4', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
