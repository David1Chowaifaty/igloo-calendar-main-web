...
export class IrOtp {
    ...
    render() {
        return (h(Host, { key: 'a7ddacdfb874e697a0c8a7c898319b56f46078d0', class: "otp-input-container" }, h("div", { key: 'f980674e67f92f2a16f8b3b03900d2d7a01ca103', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
