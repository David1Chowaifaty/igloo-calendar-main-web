...
export class IrOtp {
    ...
    render() {
        return (h(Host, { key: '0715962f03dfc917f55ccd902d918792ae6616a0', class: "otp-input-container" }, h("div", { key: '9f9a5b253660f4163a616a1b43303d3278c5a7e7', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
