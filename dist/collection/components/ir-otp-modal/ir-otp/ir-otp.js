...
export class IrOtp {
    ...
    render() {
        return (h(Host, { key: 'be3f7cea003aaaae535a49431842f6dedf4543df', class: "otp-input-container" }, h("div", { key: 'f2b28f78d3d11ada2a9f1d2128277197ac852d0c', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
