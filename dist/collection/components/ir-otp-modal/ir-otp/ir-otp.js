...
export class IrOtp {
    ...
    render() {
        return (h(Host, { key: '4e075981f5e9b2b00788c78ba3531a574a04fcd9', class: "otp-input-container" }, h("div", { key: '50960dafaf2a64404586d2bb84ea6613b027d9cf', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
