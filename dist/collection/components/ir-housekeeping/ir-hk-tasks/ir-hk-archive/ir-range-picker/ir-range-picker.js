...
export class IrRangePicker {
    ...
    render() {
        return (h(Host, { key: '7a2a38390ebf2f8bc0a14d08e6ed637610fabac6', size: "small" }, h("div", { key: '1e90f9a621f5fc572fbaa627e66a31bb8686a6f9', class: "range-picker__container", ref: el => (this.date_container = el) }, this.withOverlay && (h("div", { key: 'b1317503687cb0b86236d72a494b7aa3f8c58dd2', class: {
                'range-picker__overlay': true,
                'range-picker__overlay--active': !this.fromDate,
            }, onClick: () => this.fromDatePicker.openDatePicker() }, h("wa-icon", { key: 'a0bdadb4e9f0b8a66cc7298730f9633a6076783a', name: "calendar" }), h("p", { key: '3eadbeab83b94d43838e9361dcfdbc1ca170eb71', class: "m-0" }, h("slot", { key: '7d7bf8fb1085e3d831787d67b22ef22435136586', name: "message" }, "Cleaned on")))), h("svg", { key: '03383d6adf41ac07399930b89752f1ddee319b19', class: {
                'range-picker__calendar-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", style: { height: '14px', width: '14px' } }, h("path", { key: '1b3ff116941e56e4d7da366210ed8e2f54f17548', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), this.renderDatePicker('fromDate', this.fromDate, this.minDate, el => (this.fromDatePicker = el)), h("svg", { key: '8d85f5bac4e26b970c383ff8e4f103b94e9489d7', class: {
                'range-picker__arrow-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: '4e5933af7fbc87dadfde037809f8f4c9cc8987eb', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), this.renderDatePicker('toDate', this.toDate, this.fromDate?.toDate() || this.minSelectableDate, el => (this.toDatePicker = el), {
