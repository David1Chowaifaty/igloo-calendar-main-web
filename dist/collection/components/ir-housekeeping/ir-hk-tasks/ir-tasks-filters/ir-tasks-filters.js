...
export class IrTasksFilters {
    ...
    render() {
        ...
        return (h("div", { key: '94be6b109e4f9c83275853456061eff8187b7a41', class: "card mb-0 p-1 d-flex flex-column" }, h("div", { key: '9ad59412a2911f83a02cbfdf334015e1a02a4f9b', class: "d-flex align-items-center justify-content-between" }, h("div", { key: '27fc39f2b78715d5c941050b08dfe739be21d526', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("svg", { key: '8b6556d6cb9597f09eae99631e9c4d5c53e2e366', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: '45de872ab3ead7d886afb031cc1895a40ba42f03', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), h("h4", { key: 'c869fad87ec7c4dd6d8d619aee7f39921da2edb6', class: "m-0 p-0 flex-grow-1" }, locales.entries.Lcz_Filters)), h("ir-button", { key: '9c69052d107969b93cfbab509683e45843d8640a', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), h("div", { key: 'd50ef8c551d7a6b9a427e8d91bf2374b3b98bc2c', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, h("div", { key: '75616a382cf0cb35722602971e70d89e5aa4ea6c', class: "d-flex flex-column", style: { gap: '0.5rem' } }, h("fieldset", { key: 'a7cd7716e8fe86642bfe7154d5d580ba740d348f', class: "pt-1" }, h("p", { key: '671c04b3f274c5b168f9bb6b874d436e1e835d4c', class: "m-0 p-0" }, locales.entries.Lcz_Period), h("ir-select", { key: 'f8144307fdfc5acb72ac3b0772e6ddefaf9f04b9', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, data: (_c = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), ((_d = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.housekeepers.length) > 1 && (h("fieldset", { key: '051f45f51a7288a88d808c06f4d85e21322da0db' }, h("p", { key: '479c4fc3cfc99e7b28fc6b794efd15df5618341a', class: "m-0 p-0" }, locales.entries.Lcz_Housekeepers), h("ir-select", { key: 'e2970e990d971fee91e5ee25dc5b60c58c2d32e2', testId: "housekeepers", selectedValue: (_e = this.filters) === null || _e === void 0 ? void 0 : _e.housekeepers, LabelAvailable: false, showFirstOption: false, data: [
                ...
                text: v.description,
                value: v.code,
            })) })), h("div", { key: '754675fbd8a0289111ffea5e1d9e7ff35e67bb7f', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, h("ir-button", { key: '7274cf6a9b64c135fac7554a47ea9411927491a8', btn_type: "button", "data-testid": "reset", text: locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), h("ir-button", { key: '5d13b469b56d3f830eb32a1f8bf31b75dcc277b5', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
