...
export class IrTasksTablePagination {
    render() {
        ...
        return (h(Host, { key: 'd4c62865fdc5e6c72196ee6f1f692fa422a5380b' }, shouldLoadMore() && (h("ir-button", { key: 'e242e7fdf7695a6673909d0600143b33675563f1', size: "sm", class: "tasks-load-more", text: t('Lcz_LoadMore', { fallback: 'Load more' }), onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) })), h("ir-pagination", { key: '28b85efb147187e97bb642737680e05cfe79dc0f', showing: {
                from: start,
                to: end,
