...
export class IrHkUnassignedUnits {
    ...
    render() {
        return (h(Host, { key: '3690801112ed9832c4046dccbe8a3cefdd16e97d' }, h("ir-title", { key: 'ed06ae066d85237a474550d457b27cdfa1d40c49', class: "title px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), h("section", { key: 'a83b3c0f2304be16bf014b5ce9805fe77c1758cd', class: "px-1" }, h("table", { key: '8e040de2b3cce3d25bb35996d63bb3d7f08bb7e2' }, h("thead", { key: '6435de1df40fde4c92064d083774027a6b41a406' }, h("th", { key: '9aa119148d89ec4a24114362a785f204ea50243e', class: "sr-only" }, "room name"), h("th", { key: 'ac4084e2f11017f61ab0ae6abd7fdbeca0963f0f', class: "sr-only" }, "housekeeper name"), h("th", { key: 'b71a80bb10d7261fdfa092b8eb9e7a716559cc72', class: "sr-only" }, "actions")), h("tbody", { key: '864daa76e34cfd10c31d96bb37f4cb1a72402cb8' }, this.renderRooms())), h("div", { key: '8d5932e9dd28a343a47ac0fddd04c3d5909d04db', class: "d-flex flex-column flex-md-row align-items-md-center mt-2 w-100" }, h("ir-button", { key: '0fcdcd899837b28e4426be3afaf7a4624ba58a30', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: 'Cancel' }), h("ir-button", { key: '29793cd44e49565bcc6e3c12d62b41cf20417852', isLoading: isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill ml-md-1", btn_styles: "w-100  justify-content-center align-items-center mt-1 mt-md-0", text: 'Confirm' })))));
    }
