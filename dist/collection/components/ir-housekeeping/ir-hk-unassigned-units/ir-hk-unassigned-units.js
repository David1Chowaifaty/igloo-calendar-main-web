...
export class IrHkUnassignedUnits {
    ...
    render() {
        return (h("div", { key: '76bfab82e4dee2da9f69d6f3a555bb835f351941', class: "sheet-container" }, h("ir-title", { key: '3580f0a252ff093a9a1512124099b441a3d6221b', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), h("section", { key: '088c31b016a925b13c342c115a8abdb2408e0e47', class: "px-1 sheet-body" }, h("table", { key: '5d237fb5828eb2eccb28ec63192bfb7b0ee600b2' }, h("thead", { key: 'b031c6da17fb4678cc6cd5d2e91de6d9bd8f860d' }, h("th", { key: 'b427f208191ae3b887c4433bf3ae79c7e9e274ab', class: "sr-only" }, locales.entries.Lcz_RoomName), h("th", { key: '9cc8ede1d5c9ee5a9b6e8d9278fa4a7535378dc9', class: "sr-only" }, locales.entries.Lcz_HousekeeperName), h("th", { key: 'c072d281da7e57a0a1bd4e9f2cf6e08c6a22e66b', class: "sr-only" }, locales.entries.Lcz_Actions)), h("tbody", { key: 'effa29b8b6f13778211fdfc1964bccf00040e336' }, this.renderRooms()))), h("div", { key: '8f08ffa061532c2af0aca1832d0f777e5215386f', class: "sheet-footer" }, h("ir-button", { key: '9553d8b25e889ecf6e2e619a816b74ff3c3d1401', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales.entries.Lcz_Cancel }), h("ir-button", { key: '8f6b85133523f526680d24127a7c75340cdfb0d9', isLoading: isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales.entries.Lcz_Confirm }))));
    }
