...
export class IrHkUnassignedUnits {
    ...
    render() {
        return (h(Host, { key: '92f2bb8733e07f1493c2325032710bea2503ec4a' }, h("ir-title", { key: '6b6a087a3af95b94539570e863fb1faa804bb6ec', class: "title px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), h("section", { key: '9127c85034aa7d808d7393e6cbd57ad3fb9fb611', class: "px-1" }, h("table", { key: 'c50f10ec63124490b6d5e439b4c4c78b29b66773' }, h("thead", { key: 'cf00e4e5e41c72e50768a787995e8f800f900d20' }, h("th", { key: 'a021105434ac77544e94073f5745d2b4d3874081', class: "sr-only" }, "room name"), h("th", { key: 'c258da34c0541a493fce4620d70c44c06bc14a5c', class: "sr-only" }, "housekeeper name"), h("th", { key: 'a722879e0ba564db18c024ec63d520d85f97ac01', class: "sr-only" }, "actions")), h("tbody", { key: '0f6f07bd922120ef42ea432e56414220b6ce6873' }, this.renderRooms())), h("div", { key: '3ed6c70cf3215f4d44d00121dabb8a1f15dfab63', class: "d-flex flex-column flex-md-row align-items-md-center mt-2 w-100" }, h("ir-button", { key: '9418dbd5290c2eaa808d1fc44ff3d1abf27a0610', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: 'Cancel' }), h("ir-button", { key: 'e198339a8b9e88fa17d748e817de247124c5c96b', isLoading: isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill ml-md-1", btn_styles: "w-100  justify-content-center align-items-center mt-1 mt-md-0", text: 'Confirm' })))));
    }
