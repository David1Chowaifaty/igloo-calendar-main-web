...
export class IrHkUnassignedUnits {
    ...
    render() {
        return (h(Host, { key: '148414c54d131f229f1cf2b59b7d25d36bed931c' }, h("ir-title", { key: 'ac008d3407b147738a6d004cfb1cf819ae11d55d', class: "title px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), h("section", { key: '275c111c15b48de7904096ad13da95e93d241232', class: "px-1" }, h("table", { key: 'a6f1204c025fde5c2ed53cafb9f6391977f151f8' }, h("thead", { key: '301a7fbda4578c03faaf217fcfc173ef6ec4df30' }, h("th", { key: '8961e91d7da967f63da509ebf6895791349474ed', class: "sr-only" }, "room name"), h("th", { key: '0f1e32f14d644e02171f0bb6763cef86c6e6816b', class: "sr-only" }, "housekeeper name"), h("th", { key: '2fd3524602b7e99397843bf3fcce7c56d9b9ec3c', class: "sr-only" }, "actions")), h("tbody", { key: '9d9d77686c290fc5a82dce4ec8e33d2d0a0d10bb' }, this.renderRooms())), h("div", { key: 'b5c524b5efe8b60c6d5f83da943fcd4351b14470', class: "d-flex flex-column flex-md-row align-items-md-center mt-2 w-100" }, h("ir-button", { key: '1c0eb5a388440f18185320fc6082c3bd4f0f3551', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: 'Cancel' }), h("ir-button", { key: '7fe4531ba935a1ca50bc4b2797b968b5d38f3fe4', isLoading: isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill ml-md-1", btn_styles: "w-100  justify-content-center align-items-center mt-1 mt-md-0", text: 'Confirm' })))));
    }
