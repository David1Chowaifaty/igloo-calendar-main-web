...
export class IrHkUnassignedUnits {
    ...
    render() {
        return (h(Host, { key: 'b818a2232e2c647c533fd62971b2c4934404a307' }, h("ir-title", { key: '145cfb37a273e9511406595922a9b288233240b5', class: "title px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), h("section", { key: '51137d1fcb1077a8cb991954efb61ac1f7efcfc9', class: "px-1" }, h("table", { key: 'ed4fb78c4e6bff7d71d3d917cc2fa7348103ab47' }, h("thead", { key: 'aa2cce3435139439f5416747da2492d13a172c84' }, h("th", { key: '0ae53d64cd4595c6ad46f11f9776a1ec18a742b7', class: "sr-only" }, "room name"), h("th", { key: 'be42c633f592c069deee937960277acb93e3737a', class: "sr-only" }, "housekeeper name"), h("th", { key: '6ccd109cffc1d6004f902b006e1152b58fc8b0f5', class: "sr-only" }, "actions")), h("tbody", { key: '1b19f8accb1445401676bbd65b96236721a807ce' }, this.renderRooms())), h("div", { key: '395941feda51ee812e768fe36b3bad78632ecc70', class: "d-flex flex-column flex-md-row align-items-md-center mt-2 w-100" }, h("ir-button", { key: 'dea824d637e3f4b5421e6a8c8baba79dfd767993', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: 'Cancel' }), h("ir-button", { key: '75b7b29b12ec6e5a6813a6c9883d4e9c91b10e32', isLoading: isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill ml-md-1", btn_styles: "w-100  justify-content-center align-items-center mt-1 mt-md-0", text: 'Confirm' })))));
    }
