...
export class IrHkUnassignedUnits {
    ...
    render() {
        return (h("div", { key: 'f3b96256609876045df0c45379663250818aa109', class: "sheet-container" }, h("ir-title", { key: 'b3551cffb17118cb90246939d2ded872703635ad', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), h("section", { key: 'd9fe382c5140f96e40953010646337d8b808f033', class: "px-1 sheet-body" }, h("table", { key: 'f1d96f0c1f1c276a714bb99b518e88be7c655044' }, h("thead", { key: 'c05395e99e3eee4c173093fdd6391a3e4fd90290' }, h("th", { key: '95ed4fc99597ce9ff89308ef712032e31b32168f', class: "sr-only" }, locales.entries.Lcz_RoomName), h("th", { key: 'd118816f65e9c5c7a69dde4027d6667c422b7846', class: "sr-only" }, locales.entries.Lcz_HousekeeperName), h("th", { key: 'b7d2622a12820e35717e5692e2aa6a7a12f8220a', class: "sr-only" }, locales.entries.Lcz_Actions)), h("tbody", { key: 'ff4c25cf9089ed4aac7f6abbc209017548df9368' }, this.renderRooms()))), h("div", { key: '72f23625e107a32de598e6fda52339ddc0619b16', class: "sheet-footer" }, h("ir-button", { key: '9d7a4ee3cb5b35c0e057de134a0e48069cc72d56', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales.entries.Lcz_Cancel }), h("ir-button", { key: 'de9707363ef58cb3676203b3599f4503b565d763', isLoading: isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales.entries.Lcz_Confirm }))));
    }
