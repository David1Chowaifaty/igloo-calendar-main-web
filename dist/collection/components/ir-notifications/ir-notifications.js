...
export class IrNotifications {
    ...
    render() {
        ...
        }), this.notifications?.length === 0 && (h("ir-empty-state", { key: 'bfd12a84f4dca72b031bb66ce3732b9b09e491bb', message: "All caught up!", style: { width: '250px', height: '150px' } }, h("wa-icon", { key: 'd271da32112079749e5a0c3f619d4d81109bd874', slot: "icon", name: "inbox" }))))));
    }
