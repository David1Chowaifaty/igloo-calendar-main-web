 ...
 */
export const SETUP_LANGUAGE_CODES = ['en', 'fr', 'ar', 'ru', 'el', 'he', 'pl', 'de', 'ua'];
export function isSetupLanguageCode(code) {
 ...
 * CODE_VALUE_* column.
 */
export function exposedLanguagesToTranslationLanguages(exposed) {
    return exposed
...
export function setupEntryToTranslationEntry(entry) {
    const values = {};
