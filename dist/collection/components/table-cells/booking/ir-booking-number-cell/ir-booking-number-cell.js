...
export class IrBookingNumberCell {
    ...
    openBookingDetails;
    render() {
        return (h(Host, { key: '5d9a570ca9c0a2a81a27f36abaa706251fa6ae29' }, this.channelBookingNumber && h("wa-tooltip", { key: '4deee1a7742959771d1027c2afe94d43c77d6ad6', for: `source-logo__${this.bookingNumber}` }, this.origin.Label), h("img", { key: '2380ef50fa4b623559715a8a8cae36f31ccc852f', class: "booked-by-source__logo", id: `source-logo__${this.bookingNumber}`, src: this.origin.Icon, alt: this.origin.Label }), h("div", { key: '709e225615532d3825bf7c71f9a0768784006e5b', class: "booking-nbr-cell__container" }, h("div", { key: '8a7584395b6730b112efa79c9d509297fa7cefdd', style: { width: 'fit-content' } }, h("ir-custom-button", { key: 'f4fa1972326bf60654efeba466868c9c4c0a13e7', size: "medium", onClickHandler: () => this.openBookingDetails.emit(this.bookingNumber), link: true, variant: "brand", appearance: "plain" }, this.bookingNumber)), h("p", { key: 'b2309f644bf4fb3e50fd20fa2bedbdb8f3ed1ccf', class: "booking-nbr-cell__channel_nbr" }, this.channelBookingNumber ? this.channelBookingNumber : this.origin.Label))));
    }
