...
export class IrBookingNumberCell {
    ...
    openBookingDetails;
    render() {
        return (h(Host, { key: '7549a911ae40f0fc3d9a3f50ee454a24dbcfafbb' }, this.channelBookingNumber && h("wa-tooltip", { key: 'fc1c6ed248985feb97156f9a93f26a9f672a0a4b', for: `source-logo__${this.bookingNumber}` }, this.origin.Label), h("img", { key: '3ea014d36c1cc34abd5e0a80a9520575ea58a04f', class: "booked-by-source__logo", id: `source-logo__${this.bookingNumber}`, src: this.origin.Icon, alt: this.origin.Label }), h("div", { key: '70a8b3b1eaf5252d30ec99e2fbdd412977740613', class: "booking-nbr-cell__container" }, h("div", { key: 'f5d934136ec69bbbec228f1a8bfbae10075e2962', style: { width: 'fit-content' } }, h("button", { key: 'beefb2c7fd4400e82493e8ddf0b2e41370bc35e9', class: "booking-nbr-cell__button", onClick: () => this.openBookingDetails.emit(this.bookingNumber) }, this.bookingNumber)), h("p", { key: 'a272dd20e94a7e20040a56e6cac69f977c770e96', class: "booking-nbr-cell__channel_nbr" }, this.channelBookingNumber ? this.channelBookingNumber : this.origin.Label))));
    }
