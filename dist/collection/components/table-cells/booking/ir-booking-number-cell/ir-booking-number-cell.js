...
export class IrBookingNumberCell {
    ...
    openBookingDetails;
    render() {
        return (h(Host, { key: 'eb730bf156e7a4c50f49e451e4fb20264c026b51' }, this.channelBookingNumber && h("wa-tooltip", { key: 'bcb4172ca33e0b337c4b5f3e291a8bbe1d68ff56', for: `source-logo__${this.bookingNumber}` }, this.origin.Label), h("img", { key: 'ec507e423100d6fe51898309f87f7ccecacf6085', class: "booked-by-source__logo", id: `source-logo__${this.bookingNumber}`, src: this.origin.Icon, alt: this.origin.Label }), h("div", { key: '049b28b0543e7cea6d5006d20ee501a434b634a4', class: "booking-nbr-cell__container" }, h("div", { key: '9ee99bb6d41cc40fa3130403008becec92a0be51', style: { width: 'fit-content' } }, h("button", { key: 'd911ceaf0caebf86159954ae60d74e1d20a53abe', class: "booking-nbr-cell__button", onClick: () => this.openBookingDetails.emit(this.bookingNumber) }, this.bookingNumber)), h("p", { key: '5292d4d7ff357513a9c03b393c48e7dd3b6383c3', class: "booking-nbr-cell__channel_nbr" }, this.channelBookingNumber ? this.channelBookingNumber : this.origin.Label))));
    }
