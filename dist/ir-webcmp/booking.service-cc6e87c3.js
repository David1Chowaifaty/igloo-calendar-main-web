import { u as unionType, n as numberType, s as stringType, o as objectType, b as booleanType, a as arrayType, e as enumType, c as custom, d as nullType, f as anyType, z } from './index-40c31d5b.js';
import { a as axios } from './index-5ba472df.js';
import { Z as ZIEntrySchema } from './IBooking-9fbd40d1.js';
import { e as extras, c as convertDateToCustomFormat, a as convertDateToTime, d as dateToFormattedString } from './utils-7eaed9ad.js';
import { c as calculateDaysBetweenDates, g as getMyBookings } from './booking-2b94eb2b.js';
...
const UnblockUnitByPeriodPropsSchema = objectType({
    unit_id: numberType(),
    from_date: stringType().optional(),
    to_date: stringType().optional(),
});
const GetNextValuePropsSchema = objectType({
    starter: stringType().optional(),
});
const GetExposedApplicablePoliciesPropsSchema = objectType({
...
const HandleExposedRoomInOutPropsSchema = objectType({
    booking_nbr: stringType().optional(),
    room_identifier: stringType().optional(),
    status: stringType().optional(),
});
const GetPenaltyStatementPropsSchema = objectType({
    booking_nbr: stringType().optional(),
    currency_id: numberType(),
...
const SetExposedRestrictionPerRoomTypePropsSchema = objectType({
    is_closed: booleanType(),
    restrictions: arrayType(RestrictionSchema),
    operation_type: stringType().optional().optional(),
});
const ChangeExposedBookingStatusPropsSchema = objectType({
...
const GetBookingAvailabilityPropsSchema = objectType({
    from_date: stringType().optional(),
    to_date: stringType().optional(),
...
const BlockAvailabilityForBracketsPropsSchema = objectType({
    unit_id: numberType(),
...
const DoBookingExtraServicePropsSchema = objectType({
    service: custom(),
...
const ExposedGuestsSchema = arrayType(ExposedGuestSchema);
...
export { BookingService as B, VariationService as V, resetReserved as a, booking_store as b, calculateTotalRooms as c, setBookingSelectOptions as d, reserveRooms as e, setBookedByGuestManualEditState as f, getReservedRooms as g, hasAtLeastOneRoomSelected as h, getBookingTotalPrice as i, bookedByGuestBaseData as j, resetAvailability as k, getVisibleInventory as l, modifyBookingStore as m, updateRoomGuest as n, updateRoomParams as o, resetBookingStore as r, setBookingDraft as s, updateBookedByGuest as u };

//# sourceMappingURL=booking.service-cc6e87c3.js.map