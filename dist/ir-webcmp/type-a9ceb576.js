...
const AgentsSchema = z.array(AgentSchema).nullable();
const HandleExposedAgentPropsSchema = z.object({
    agent: AgentSchema,
});

export { AgentSchema as A, ExposedAgentsPropsSchema as E, HandleExposedAgentPropsSchema as H, AgentsTypes as a, AgentBaseSchema as b };

//# sourceMappingURL=type-a9ceb576.js.map