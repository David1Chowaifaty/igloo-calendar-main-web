...
const IrPrintRoom = class {
    ...
    render() {
        ...
        return (h("section", { key: '9bd08f39d0f4169f2a49d85d87142b629db96340', class: "ir-print-room" }, h("header", { key: '0957c31889f3d1cd2fd990c72d871b1cdf3bca0b', class: "ir-print-room__header" }, h("p", { key: 'cfb4f9900c8eb48bd2291845b523e16b229e4d2c', class: "ir-print-room__room-type" }, room?.roomtype?.name), haveMultipleRooms && room?.unit && h("p", { key: 'c6ba1ac9a445fdd93f326c52e6f67b179b4af27d', class: "ir-print-room__unit" }, "(unit ", room.roomtype.id, ")"), h("p", { key: '1c9957fb526108a44df546662e81fb8b63f49d29', class: "ir-print-room__rate-plan" }, room?.rateplan?.short_name || room?.rateplan?.name)), h("div", { key: '71d4434938d7675ba25bd8ddbc22f335ae360c44', class: "ir-print-room__body" }, h("div", { key: '1e8a469094fe0775945113e00bbf9530b27962b6', class: "ir-print-room__details" }, h("div", { key: '3388b634c4f86b838028eca4bc9668cbb01aea35', class: "ir-print-room__row" }, h("ir-printing-label", { key: '6150bdc0a7a082146ccb30ffbac8fd1a8908673c', label: "Guest Name:", content: this.formatGuestName(room?.sharing_persons?.find(p => p.is_main) ?? room?.guest) }), h("ir-printing-label", { key: '9877fc2a0a8779a6afaaf63478f6b953cdf628ab', "as-html": true, content: this.formatGuestAvailability(room?.occupancy) })), h("div", { key: '29c03d54bf038c401145b2bb27d4c0d293d2a935', class: "ir-print-room__row" }, h("div", { key: '5f333ee07de21c17400c6647f3a0a1ed9aa3a743', class: "ir-print-room__dates" }, this.formatBookingDates(room?.from_date), h("span", { key: '57099e81d8c8cf237e9b320eac5ff4629add9c90', class: "ir-print-room__date-separator" }, "\u2192"), this.formatBookingDates(room?.to_date)), room?.departure_time?.description && h("p", { key: '703d0fca4469e89a538e5ee1d6952f2dc56374c7', class: "ir-print-room__departure-time" }, "(Expected departure time: ", room.departure_time.description, ")")), h("ir-printing-label", { key: 'a384914a9b37b610537bf78bba7f3c6d10764190', label: "Smoking options:", display: "inline", content: this.getSmokingLabel() }), booking?.is_direct && (h("div", { key: 'b78b483297b455eff0e8f4edada5c071aa193b1c', class: "ir-print-room__policies" }, h("ir-printing-label", { key: '341dfdd5c625d56f6fb9d5b56e03f672a645ef16', label: "Cancellation:", display: "inline", asHtml: true, content: room?.rateplan?.cancelation?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') }), h("ir-printing-label", { key: '0d5f232d0a5177cf8889dbaaa8556f9a45abf9e7', label: "Guarantee:", display: "inline", asHtml: true, content: (room?.rateplan?.guarantee ?? '')?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') })))), h("aside", { key: '935d02ee38ac760dfc7c324d06f3080c04e797e0', class: "ir-print-room__totals" }, h("ir-printing-label", { key: '25b6bb90e329e75722e96898695ad00192dd1609', label: "Total:", content: formatAmount(currency, room?.total) }), this.renderTaxSection(), h("ir-printing-label", { key: '3e45a076e6b51eebcbbd5eab3d8ba89dd028edc0', label: "Grand total:", content: formatAmount(currency, room?.gross_total) }), booking?.is_direct && h("ir-printing-label", { key: 'bdbd7b0bec05d3c0aa51977f6b2f6ee77b77e711', label: "Due upon booking:", content: formatAmount(currency, Number(room?.gross_guarantee)) }))), h("div", { key: '2713b7eccea6248ec575b421ab04cfaab9e338b8', class: {
...
export { IrPrintRoom as ir_print_room };

//# sourceMappingURL=ir-print-room.entry.js.map