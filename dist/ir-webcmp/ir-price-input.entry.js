...
import { I as IMask } from './index-9345e294.js';
...
const IrPriceInput = class {
    ...
    render() {
        return (h("fieldset", { key: '3e02af2bc263caed4fa21cc7ddc29dfed369c4c5', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (h("div", { key: '8b1699973d0589da87ae86c02cf8546554c34f60', class: `input-group-prepend ${this.labelContainerClassname}` }, h("span", { key: 'a6b25409464d4d55daa6e6b79ce430e8a2ba4c87', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, h("label", { key: '28f6152b9956c6e17c93da045ffcb32debb40ec9', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), h("div", { key: 'fc350508d210c0f2b66da349bec6b29424b9323e', class: "position-relative has-icon-left rate-input-container" }, this.currency && (h("div", { key: '27020a2967b5b4185ca139e1bcbc53451f1afca5' }, h("span", { key: '13d4a6f06c7bbc4317e21b43c83053b53cc1de45', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), h("input", { key: '96d67abe8fbb47d854391d5901f1a4defb87b377', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
