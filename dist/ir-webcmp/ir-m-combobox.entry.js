...
const IrMCombobox = class {
    ...
    render() {
        return (h(Host, { key: '24612c89bc355bb320be820dfa7f95aa05865029', class: { 'has-prefix': this.hasPrefix, 'has-suffix': this.hasSuffix } }, h("div", { key: 'a0d616e04f3aa5e237e03cc04d0ff8a55bfa7ca6', class: "input-wrapper" }, h("span", { key: '14597ad7ec1707308da27d1bf1d9f928a24aac94', class: "prefix-container", "aria-hidden": !this.hasPrefix }, h("slot", { key: '10b80f59ed57332875411c7dd200c11f77845494', name: "prefix", ref: el => (this.prefixSlotRef = el) })), h("input", { key: '2a98404655a988ae2f58b50c8184a6d21d0b642b', ref: el => (this.inputRef = el), type: "text", class: "form-control", role: "combobox", id: this.id, value: this.selectedOption?.label || '', placeholder: this.placeholder, "aria-expanded": String(this.isOpen), "aria-autocomplete": "list", "aria-controls": this.dropdownId, "data-reference": "parent", "aria-haspopup": "listbox", "aria-activedescendant": this.focusedIndex >= 0 ? `${this.dropdownId}-option-${this.focusedIndex}` : null, "aria-label": "Combobox", "aria-required": true, onKeyDown: this.handleKeyDown, onInput: this.handleInput }), h("span", { key: '341751c3d8a37afcbe7cd8f0a9b23c9fc2b44af3', class: "suffix-container", "aria-hidden": !this.hasSuffix }, h("slot", { key: 'a51221d34292e39d1c2900c10db0d5746c71096b', name: "suffix", ref: el => (this.suffixSlotRef = el) }))), h("div", { key: '5ec2493225bc6fbcd4f9ebcaad596b5371a9ddd9', class: `dropdown ${this.isOpen ? 'show' : ''}` }, h("div", { key: '6e4a9be97b0c2d1a84e770244c6dde06a8aaf5ed', ref: el => (this.dropdownRef = el), class: `dropdown-menu ${this.isOpen ? 'show' : ''}`, id: this.dropdownId, role: "listbox", "aria-expanded": String(this.isOpen) }, this.isCompositionMode ? (h("slot", null)) : this.useSlot ? (h("slot", { name: "dropdown-content" })) : ([
...
export { IrMCombobox as ir_m_combobox };

//# sourceMappingURL=ir-m-combobox.entry.js.map