...
const IrSelect = class {
    ...
    render() {
        ...
        return (h("div", { key: 'edc10c943c992466f1b7fff74971c794726d1e7d', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'ce9dfca45ccbf9e9ce8729530588a1ed3e4ebc6b', class: "input-group row m-0" }, label, h("select", { key: '3090ba8f125224fa85015924765c2e77dab05d50', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '677284100db5797997e188c3f8437f522d46fe74', value: '' }, this.firstOption), this.data.map(item => {
