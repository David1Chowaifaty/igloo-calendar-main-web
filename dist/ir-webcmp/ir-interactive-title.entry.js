...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'd50829d83de3e039a8fc4c630b21c2bade37a5f8', style: { '--ir-popover-left': this.irPopoverLeft } }, h("p", { key: '8458b17e20532340d05af6c8b703e5c6a7f6bd4c', ref: el => {
                ...
                alignItems: 'center',
                gap: '4px',
            } }, h("span", { key: 'a361b2996905c2595c2359eaf69a7bbc8b4f7b61', class: "cropped-title", style: {
                flexShrink: '1',
                minWidth: '0',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, displayTitle), this.hkStatus && (h("div", { key: 'a646fb89608a49029ea07413e8c5a1729f832c20', title: this.broomTooltip, class: "hk-dot", style: { flexShrink: '0' } }, h("slot", { key: '796661cb029cbfeaa881711cd1aa88f56a9ccd95', name: "end" }))))));
    }
};
IrInteractiveTitle.style = irInteractiveTitleCss;

export { IrInteractiveTitle as ir_interactive_title };

//# sourceMappingURL=ir-interactive-title.entry.js.map