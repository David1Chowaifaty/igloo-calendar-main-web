...
const IrMComboboxItem = class {
    ...
    render() {
        ...
        return (h(Host, { key: '9c3b02849775a4535ea7052661dabb18a21eda27', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true }, onClick: this.handleClick }, this.html_content ? h("span", { innerHTML: this.html_content }) : h("slot", null)));
    }
};
