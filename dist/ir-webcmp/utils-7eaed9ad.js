...
import { z, Z as ZodIssueCode, g as ZodError } from './index-40c31d5b.js';
...
const transformBooking = (physicalRoom) => {
    const myBookings = [];
 ...
 */
function generateTimeSlotsMilitary(from, to, stepMinutes = 60) {
    const startTime = hooks(from, 'HH:mm');
    const endTime = hooks(to, 'HH:mm');
    const timeSlots = [];
...
export { validateEmail as A, getFormSubmitter as B, findCountry as C, toFloat as D, ExtraServiceSchema as E, renderTime as F, validateSharedPerson as G, ROOM_IN_OUT as R, ZSharedPerson as Z, convertDateToTime as a, dateDifference as b, convertDateToCustomFormat as c, dateToFormattedString as d, extras as e, canCheckIn as f, checkUserAuthState as g, formatAmount as h, isBlockUnit as i, canCheckout as j, isPrivilegedUser as k, downloadFile as l, manageAnchorSession as m, handleBodyOverflow as n, getReleaseHoursString as o, formatLegendColors as p, getNextDay as q, addTwoMonthToDate as r, sleep as s, convertDMYToISO as t, computeEndDate as u, isWeekend as v, checkMealPlan as w, getDaysArray as x, convertDatePrice as y, formatDate as z };

//# sourceMappingURL=utils-7eaed9ad.js.map