...
const ChannelReportSchema = ExtendedChanelReportBaseSchema;
...
/* ---------- Filters ---------- */
const ChannelSalesFilterSchema = ChannelSalesParamsSchema.extend({
    include_previous_year: z.boolean(),
});
/* ---------- Helpers (optional but handy) ---------- */
const parseChannelReport = (data) => ChannelReportSchema.parse(data);
const safeParseChannelReport = (data) => ChannelReportSchema.safeParse(data);
const parseChannelReportResult = (data) => ChannelReportResultSchema.parse(data);
const safeParseChannelReportResult = (data) => ChannelReportResultSchema.safeParse(data);
const parseChannelSalesParams = (data) => ChannelSalesParamsSchema.parse(data);
const safeParseChannelSalesParams = (data) => ChannelSalesParamsSchema.safeParse(data);
...
//# sourceMappingURL=property.service-60a05284.js.map