...
const IrNotifications = class {
    ...
    // }
    render() {
        return (h(Host, { key: '9c03bdacc4ab6b6083164ebe10e5b9af568f27c4' }, h("div", { key: 'd9e99fe756583293d23201ac813b2de95ec3a0e8', style: { position: 'relative' } }, h("wa-tooltip", { key: 'ce089a65ba52510ae7e5f825eeeaabd1d029b948', for: "notifications-button" }, "Notifications"), this.notifications?.length > 0 && (h("wa-badge", { key: 'e574355ac825d7a67d9c4df3f504b1aff6448fed', pill: true, class: "header-notification-badge" }, this.notifications.length)), h("wa-animation", { key: 'd625de962cda5b1dc4e61c0100e54037630205bd', duration: 1200, iterations: 1, keyframes: this.bellKeyframes, ref: el => (this.animationRef = el) }, h("ir-custom-button", { key: 'f62246637e5decf02769a4171fa24ed9fc847932', id: "notifications-button", size: "small", appearance: "plain", ref: el => (this.buttonRef = el) }, h("wa-icon", { key: 'ee67d0020b951738ff8d70c1ef51df1ede17b5f5', class: "notification__bell-icon", name: "bell", style: { fontSize: '1.4rem' } })))), h("wa-popover", { key: '5d0c6b428026bcfaa71d583836b221004b634d88', distance: 15, class: "notification__popover", for: "notifications-button" }, h("p", { key: 'ed982ccaab5c7a728039bbd6512ebf7178f660b3', class: "notification__popover-title" }, "Notifications"), this.notifications.map(notification => {
        ...
        }), this.notifications?.length === 0 && (h("ir-empty-state", { key: 'e0b337302b11575bc833df7bd5bc82ba08e6c476', message: "All caught up!", style: { width: '250px', height: '150px' } }, h("wa-icon", { key: '0a56ae75977c078f89e5af5dd7b9d9b6d5081094', slot: "icon", name: "inbox" }))))));
    }
