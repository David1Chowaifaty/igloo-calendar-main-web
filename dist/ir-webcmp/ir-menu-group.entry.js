...
const IrMenuGroup = class {
    ...
    render() {
        return (h("wa-details", { key: '0a41d05844631ecb7ba3ef801005a4213c7614f4', class: "menu-group__details", open: this.open, appearance: "plain", name: this.groupName, "onwa-hide": this.handleHide, "onwa-show": this.handleShow }, h("slot", { key: 'e54371950cdf3915b14266b7d2d2104415abee0e', slot: "summary", name: "summary" }), h("slot", { key: '3a945172bcb6fbcfde9d323838d4e53c4633ee0f' })));
    }
};
IrMenuGroup.style = irMenuGroupCss;

export { IrMenuGroup as ir_menu_group };

//# sourceMappingURL=ir-menu-group.entry.js.map