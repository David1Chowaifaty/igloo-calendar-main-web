...
const IrBookingBillingRecipient = class {
    ...
    render() {
        return (h(Host, { key: 'f435fc99a50c8f4a747d76835001897604d73988' }, h("wa-radio-group", { key: 'b0245cf5543d686e1ae7c8a5933310864b2db895', defaultValue: this.initialValue, onchange: e => this.handleRecipientChange(e.target.value), label: "Bill to", orientation: "vertical", name: `${this.booking?.booking_nbr}-bill-to`, value: this.selectedRecipient, size: "small" }, h("wa-radio", { key: 'c4011905e4107a960d8c34b713121a4ce80aa48f', appearance: "button", value: 'guest' }, this.booking?.guest.first_name, " ", this.booking.guest.last_name), this.rooms.map((r, idx) => (h("wa-radio", { appearance: "button", class: "billing-recipient__room", value: `room__${r.guest.first_name} ${r.guest.last_name}`, key: r.guest?.id ?? `guest_${idx}` }, h("span", { class: "billing-recipient__guest-name" }, r.guest.first_name, " ", r.guest.last_name)))), h("wa-radio", { key: 'ad0ecf7f51e34fbbe4cf4ec7177d9b7ae2f83e76', appearance: "button", value: "company" }, this.booking.company_name ? this.booking.company_name : 'Use company name')), h("ir-booking-company-dialog", { key: '21ba5b79ef3d8d908fea2e345f3fd587a70970e9', onCompanyFormClosed: () => {
...
export { IrBookingBillingRecipient as ir_booking_billing_recipient };

//# sourceMappingURL=ir-booking-billing-recipient.entry.js.map