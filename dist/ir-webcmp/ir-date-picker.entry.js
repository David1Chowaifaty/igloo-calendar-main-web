...
import { A as AirDatepicker, d as default_1 } from './en-e9659793.js';
...
const IrDatePicker = class {
    ...
    render() {
        return (h("div", { key: 'e01d71d25cdc434663632f783a9d0a53fec01bb6', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && h("slot", { key: 'f99df1008a28f43fab427b58d7bac56834bc7da5', name: "trigger" }), h("input", { key: '87a2088f406377ecb9458639c125c43d40569ccd', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
