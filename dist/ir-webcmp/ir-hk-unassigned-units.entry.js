...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (h("div", { key: '56c5a9c346b7e78b04aa6d4622c78224e987144c', class: "sheet-container" }, h("ir-title", { key: '3cadc88016489aecd3110ca0001dd789d05ed7bd', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), h("section", { key: 'cecb3732527f5aaec30e87e4ee9c575f09f53451', class: "px-1 sheet-body" }, h("table", { key: 'c971e35ecfe6c0d344c881aace33f07986dad530' }, h("thead", { key: '5ea902eccbb985514befa169958e357a4d53aeac' }, h("th", { key: '6dc35e333134848bb70110847bb1cc3176e7a8df', class: "sr-only" }, locales.entries.Lcz_RoomName), h("th", { key: 'a7b3771fa2a7f7ffb164bbd51d4c5e8b1aea04e2', class: "sr-only" }, locales.entries.Lcz_HousekeeperName), h("th", { key: '29da91afc26b72487451be76c2ed1a3c1f45c6b3', class: "sr-only" }, locales.entries.Lcz_Actions)), h("tbody", { key: '31ff8a6cef105b09a10e26053f30dafd6c5dc955' }, this.renderRooms()))), h("div", { key: '0dcf6e02963fcb913929cdd857232b7e695f4715', class: "sheet-footer" }, h("ir-button", { key: '988be70b1de931517e60d34503874e6c4ed670cb', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales.entries.Lcz_Cancel }), h("ir-button", { key: '08a7e1fd0f4b206338e7f2a11069b4ba035538e2', isLoading: isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales.entries.Lcz_Confirm }))));
    }
};
IrHkUnassignedUnits.style = irHkUnassignedUnitsCss + sheetCss;

export { IrHkUnassignedUnits as ir_hk_unassigned_units };

//# sourceMappingURL=ir-hk-unassigned-units.entry.js.map