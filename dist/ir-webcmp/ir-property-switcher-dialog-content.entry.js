...
const IrPropertySwitcherDialogContent = class {
    ...
    render() {
        return (h(Host, { key: '532dddfa3719940964a0c8a1dffbcc8339d58be5' }, h("ir-input", { key: '1a6e7b92c7f553bbbbfc73064acc02b20e620844', autofocus: true, ref: el => (this.inputRef = el), placeholder: "Property name or A number", class: "property-switcher__search-input", value: this.searchTerm, "onText-change": this.handleSearchChange, onKeyDown: this.handleKeyDown, withClear: true }), h("div", { key: '3761166c3665a309d621d075cf3ae768db8b9b5e', tabIndex: -1, class: "property-switcher__results" }, !this.searchTerm && this.properties?.length > 0 && (h("div", { key: '3b4e2982324849aabaa3bd78e83fc32aff430af7' }, h("p", { key: 'e11dae1410885c2102864ca0f8cd21bf6dcad2ff', style: { padding: '1rem', margin: '0', paddingTop: '0' } }, "Linked Properties"), this.properties.map(property => {
