...
const IrSwitch = class {
    ...
    render() {
        return (h(Host, { key: 'ee19ad049a192d25b4a85f9d244c06a79c940926' }, h("button", { key: '485ec26127d8a3ca9a72878cb89372a194e58049', disabled: this.disabled, ref: el => (this.switchRoot = el), type: "button", id: this.switchId || this._id, onClick: this.handleCheckChange.bind(this), role: "switch", "data-state": this.checked ? 'checked' : 'unchecked', value: 'on', class: "SwitchRoot" }, h("span", { key: 'e7aaa69f0102967f2d143becaf9b8840bc4de8ec', class: "SwitchThumb", "data-state": this.checked ? 'checked' : 'unchecked' })), h("input", { key: '5b7a69e0e8cd0b51e6ca5324fff65d097f62c7b3', type: "checkbox", checked: this.checked, "aria-hidden": "true", tabIndex: -1, value: 'on', class: "hidden-input" })));
    }
};
