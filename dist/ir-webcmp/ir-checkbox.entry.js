...
const IrCheckbox = class {
    ...
    render() {
        return (h(Host, { key: 'd5d2482522008134b398ff14cb1c85cfa2ae1feb' }, h("button", { key: '2f250299b066364a52c7bf19363a85f95e3dfe0e', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked || this.indeterminate ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (h("svg", { key: '27b8d22f4ff7df15fa9639d9e856d7defd200aec', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: '24234df17b30c6640e5549cae80d65e2240af2d7', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" }))), this.indeterminate && (h("svg", { key: '51c3c62e733d1b0c1792efecddc6d6cb6e644c00', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: '240059621772f8abd37e4f59c5b80f3b9fed46dc', fill: "currentColor", d: "M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" })))), h("input", { key: 'c30a07af73a56da7c860a6a4e727b67ab0b3543a', type: "checkbox", indeterminate: this.indeterminate, "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && (h("label", { key: '9495ee549432f55a884c461c226098cad7f78bc2', htmlFor: this.checkboxId, class: this.labelClass }, this.label))));
    }
