...
const IrAccordion = class {
    ...
    render() {
        ...
        return (h(Host, { key: '781791979ee43b2ca1aac5c426c24fa8eed3a51c' }, h("div", { key: '28ff650799e2cf081caf29e71b36d097a0210fa4', part: "base", class: "ir-accordion", "data-open": isOpen ? 'true' : 'false' }, h("button", { key: 'efe906898d4cbbcf46a7e782b8574bdc993a1efd', type: "button", class: "ir-accordion__trigger", "aria-expanded": isOpen ? 'true' : 'false', "aria-controls": this.contentId, "aria-busy": this.isAnimating ? 'true' : 'false', onClick: this.onTriggerClick, onKeyDown: this.onTriggerKeyDown, disabled: this.isAnimating, part: "trigger" }, this.caret && h("ir-icons", { key: '13af05e159bab21bfea83517d77fe45d700239ec', name: 'angle-down', class: `ir-accordion__caret ${isOpen ? 'is-open' : ''}`, "aria-hidden": "true" }), h("div", { key: '7c5cd43a63a8d56c3039e39904f50e0fba613f03', class: "ir-accordion__trigger-content" }, h("slot", { key: '928358ebe96cfaf62a5ab5c5d35407f575355ec1', name: "trigger" }))), h("div", { key: '2b7a338d256496429d6f780db508f8744a45e477', class: "ir-accordion__content", id: this.contentId, ref: el => (this.detailsEl = el), "data-expanded": isOpen ? 'true' : null, role: "region", "aria-hidden": isOpen ? 'false' : 'true' }, h("div", { key: '05fdb29a02a323205d535d711beb8fe7daf2bd02', class: "ir-accordion__content-inner", part: "content", ref: el => (this.contentEl = el) }, h("slot", { key: '34d02398050c0e195117fefd232628e7b22d3d6b' }))))));
    }
