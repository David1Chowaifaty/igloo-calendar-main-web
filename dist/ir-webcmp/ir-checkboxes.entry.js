...
const IrCheckBoxes = class {
    ...
    render() {
        return (h("div", { key: 'c95537be97590bfc6aec323771c0833268b5f81b' }, this.checkboxes.map((checkbox, index) => (h("ir-checkbox", { name: index.toString(), label: checkbox.text, checked: checkbox.checked || false })))));
    }
};
